 ...
 *         &lt;element ref="{http://www.ebxml.org/BusinessProcess/1.01}Performs" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "BusinessPartnerRole")
public class BusinessPartnerRole {

    @XmlElement(name = "Documentation")
    protected List<Documentation> documentation;
    @XmlElement(name = "Performs")
    protected List<Performs> performs;
    ...
    public List<Performs> getPerforms() {
        if (performs == null) {
            performs = new ArrayList<Performs>();
        }
