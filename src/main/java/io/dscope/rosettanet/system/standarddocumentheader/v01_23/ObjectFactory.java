 ...
 * generated in the io.dscope.rosettanet.system.standarddocumentheader.v01_23 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.system.standarddocumentheader.v01_23
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "BusinessProcessIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "BusinessServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "ContractInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "CorrelationInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "DocumentHeader")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "DocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "DocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "DocumentManifest")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "DocumentSecurity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "ManifestItem")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "PipIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "PipVersion")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "Receiver")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "RequestingDocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "Sender")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "StandardDocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "TpirPipIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", name = "VersionIdentifier")
