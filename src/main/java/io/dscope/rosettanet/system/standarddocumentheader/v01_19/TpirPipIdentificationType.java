 ...
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}PipIdentifier"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}PipVersion"/&gt;
 *         &lt;element name="TpirBusinessProcessIdentifier" type="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}BusinessProcessIdentifierType" minOccurs="0"/&gt;
 *         &lt;element name="TpirPipVersion" type="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}VersionIdentifierType"/&gt;
...
public class TpirPipIdentificationType {
    ...
    @XmlElementRef(name = "PipIdentifier", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", type = PipIdentifier.class)
    protected PipIdentifier pipIdentifier;
    @XmlElementRef(name = "PipVersion", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", type = PipVersion.class)
