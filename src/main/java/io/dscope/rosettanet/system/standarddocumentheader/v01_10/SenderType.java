 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.10}BusinessServiceInformation" minOccurs="0"/&gt;
...
public class SenderType {
    ...
    @XmlElementRef(name = "BusinessServiceInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.10", type = BusinessServiceInformation.class, required = false)
