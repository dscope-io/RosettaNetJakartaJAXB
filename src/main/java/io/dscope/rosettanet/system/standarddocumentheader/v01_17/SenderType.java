...
import io.dscope.rosettanet.universal.partneridentification.v01_13.PartnerIdentification;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.17}BusinessServiceInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.13}PartnerIdentification"/&gt;
 *       &lt;/sequence&gt;
...
public class SenderType {
    ...
    @XmlElementRef(name = "BusinessServiceInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.17", type = BusinessServiceInformation.class, required = false)
