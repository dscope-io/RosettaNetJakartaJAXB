 ...
 * generated in the io.dscope.rosettanet.system.standarddocumentheader.v01_11 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.system.standarddocumentheader.v01_11
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "BusinessProcessIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "BusinessServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "ContractInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "CorrelationInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "DocumentHeader")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "DocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "DocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "DocumentManifest")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "DocumentSecurity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "ManifestItem")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "PipIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "PipVersion")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "Receiver")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "RequestingDocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "Sender")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "StandardDocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "TpirPipIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11", name = "VersionIdentifier")
