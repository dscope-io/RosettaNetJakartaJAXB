 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20}CorrelationInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20}DocumentInformation"/&gt;
 *         &lt;element name="HeaderVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20}Receiver"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20}Sender"/&gt;
 *       &lt;/sequence&gt;
...
public class DocumentHeaderType {
    ...
    @XmlElementRef(name = "CorrelationInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20", type = CorrelationInformation.class, required = false)
    protected CorrelationInformation correlationInformation;
    @XmlElementRef(name = "DocumentInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20", type = DocumentInformation.class)
    protected DocumentInformation documentInformation;
    @XmlElement(name = "HeaderVersion")
    protected String headerVersion;
    @XmlElementRef(name = "Receiver", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20", type = Receiver.class)
    protected Receiver receiver;
    @XmlElementRef(name = "Sender", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.20", type = Sender.class)
