 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06}StandardDocumentIdentification"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06}TpirPipIdentification"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class DocumentIdentificationType {
    ...
    @XmlElementRef(name = "StandardDocumentIdentification", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06", type = StandardDocumentIdentification.class, required = false)
    protected StandardDocumentIdentification standardDocumentIdentification;
    @XmlElementRef(name = "TpirPipIdentification", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06", type = TpirPipIdentification.class, required = false)
