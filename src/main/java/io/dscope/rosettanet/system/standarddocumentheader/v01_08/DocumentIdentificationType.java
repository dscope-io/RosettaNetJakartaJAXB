 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.08}StandardDocumentIdentification"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.08}TpirPipIdentification"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class DocumentIdentificationType {
    ...
    @XmlElementRef(name = "StandardDocumentIdentification", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.08", type = StandardDocumentIdentification.class, required = false)
    protected StandardDocumentIdentification standardDocumentIdentification;
    @XmlElementRef(name = "TpirPipIdentification", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.08", type = TpirPipIdentification.class, required = false)
