 ...
 * generated in the io.dscope.rosettanet.system.standarddocumentheader.v01_19 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.system.standarddocumentheader.v01_19
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "BusinessProcessIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "BusinessServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "ContractInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "CorrelationInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "DocumentHeader")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "DocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "DocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "DocumentManifest")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "DocumentSecurity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "ManifestItem")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "PipIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "PipVersion")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "Receiver")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "RequestingDocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "Sender")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "StandardDocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "TpirPipIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", name = "VersionIdentifier")
