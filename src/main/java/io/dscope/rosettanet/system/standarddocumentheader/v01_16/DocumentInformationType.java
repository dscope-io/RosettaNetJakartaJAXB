 ...
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16}DocumentIdentification"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16}DocumentManifest" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16}DocumentSecurity" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class DocumentInformationType {
    ...
    @XmlElementRef(name = "DocumentIdentification", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16", type = DocumentIdentification.class)
    protected DocumentIdentification documentIdentification;
    @XmlElementRef(name = "DocumentManifest", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16", type = DocumentManifest.class, required = false)
    protected DocumentManifest documentManifest;
    @XmlElementRef(name = "DocumentSecurity", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.16", type = DocumentSecurity.class, required = false)
