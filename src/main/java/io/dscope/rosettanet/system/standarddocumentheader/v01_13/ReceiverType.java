...
import io.dscope.rosettanet.universal.partneridentification.v01_09.PartnerIdentification;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}BusinessServiceInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.09}PartnerIdentification"/&gt;
 *       &lt;/sequence&gt;
...
public class ReceiverType {
    ...
    @XmlElementRef(name = "BusinessServiceInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13", type = BusinessServiceInformation.class, required = false)
