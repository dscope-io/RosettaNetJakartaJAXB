 ...
 * generated in the io.dscope.rosettanet.system.standarddocumentheader.v01_18 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.system.standarddocumentheader.v01_18
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "BusinessProcessIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "BusinessServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "ContractInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "CorrelationInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "DocumentHeader")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "DocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "DocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "DocumentManifest")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "DocumentSecurity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "ManifestItem")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "PipIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "PipVersion")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "Receiver")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "RequestingDocumentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "Sender")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "StandardDocumentIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "TpirPipIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", name = "VersionIdentifier")
