 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18}ManifestItem" maxOccurs="unbounded"/&gt;
...
public class DocumentManifestType {
    ...
    @XmlElementRef(name = "ManifestItem", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18", type = ManifestItem.class)
