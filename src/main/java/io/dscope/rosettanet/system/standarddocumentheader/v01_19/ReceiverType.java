 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}BusinessServiceInformation" minOccurs="0"/&gt;
...
public class ReceiverType {
    ...
    @XmlElementRef(name = "BusinessServiceInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", type = BusinessServiceInformation.class, required = false)
