 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}ContractInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19}RequestingDocumentInformation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class CorrelationInformationType {
    ...
    @XmlElementRef(name = "ContractInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", type = ContractInformation.class, required = false)
    protected ContractInformation contractInformation;
    @XmlElementRef(name = "RequestingDocumentInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.19", type = RequestingDocumentInformation.class, required = false)
