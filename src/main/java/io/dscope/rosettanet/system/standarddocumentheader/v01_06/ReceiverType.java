...
import io.dscope.rosettanet.universal.partneridentification.v01_04.PartnerIdentification;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06}BusinessServiceInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04}PartnerIdentification"/&gt;
 *       &lt;/sequence&gt;
...
public class ReceiverType {
    ...
    @XmlElementRef(name = "BusinessServiceInformation", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06", type = BusinessServiceInformation.class, required = false)
    ...
    @XmlElementRef(name = "PartnerIdentification", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04", type = PartnerIdentification.class)
