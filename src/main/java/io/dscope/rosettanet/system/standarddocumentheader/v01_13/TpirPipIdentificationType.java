 ...
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}PipIdentifier"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}PipVersion"/&gt;
 *         &lt;element name="TpirBusinessProcessIdentifier" type="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}BusinessProcessIdentifierType" minOccurs="0"/&gt;
 *         &lt;element name="TpirPipVersion" type="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}VersionIdentifierType"/&gt;
...
public class TpirPipIdentificationType {
    ...
    @XmlElementRef(name = "PipIdentifier", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13", type = PipIdentifier.class)
    protected PipIdentifier pipIdentifier;
    @XmlElementRef(name = "PipVersion", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13", type = PipVersion.class)
