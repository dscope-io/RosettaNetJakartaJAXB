 ...
 *         &lt;element name="ProductForecastInformation" type="{urn:rosettanet:specification:interchange:PlanningReleaseForecastNotification:xsd:schema:02.01}ProductForecastInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="SoldTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14}SpecifiedPartnerDescriptionType"/&gt;
 *       &lt;/sequence&gt;
