...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.LotReference;
 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;urss:Constraint xmlns:urss="urn:rosettanet:specification:system:xml:1.0" xmlns:dl="urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23" xmlns:dp="urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29" xmlns:drd="urn:rosettanet:specification:domain:Logistics:ReceivingDiscrepancy:xsd:codelist:01.03" xmlns:drdr="urn:rosettanet:specification:domain:Logistics:ReceivingDiscrepancyReason:xsd:codelist:01.03" xmlns:p21639_="http://annox.dev.java.net" xmlns:p57035_="http://java.sun.com/xml/ns/jaxb" xmlns:sha="urn:rosettanet:specification:domain:Shared:xsd:schema:01.17" xmlns:ssdh="urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23" xmlns:st="http://www.ascc.net/xml/schematron" xmlns:tns="urn:rosettanet:specification:interchange:ShipmentReceiptNotification:xsd:schema:02.02" xmlns:udc="urn:rosettanet:specification:universal:Document:xsd:schema:01.12" xmlns:ume="urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.06" xmlns:updi="urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.04" xmlns:upi="urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.16" xmlns:uuom="urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.04" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;In ShipmentReceiptLineItem, at least one occurrence of ManufacturerProfile/CountryOfOrigin, ManufacturerProfile/ManufactureDate or ManufacturerProfile/ProductSerialIdentifier.&lt;/urss:Constraint&gt;
 * </pre>
 * 
 * 
 ...
 *         &lt;element name="DiscrepancyInformation" type="{urn:rosettanet:specification:interchange:ShipmentReceiptNotification:xsd:schema:02.02}DiscrepancyInformationType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}LotReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="QuantityInformation" type="{urn:rosettanet:specification:interchange:ShipmentReceiptNotification:xsd:schema:02.02}QuantityInformationType"/&gt;
...
public class ShipmentReceiptLineItemType {
    ...
    @XmlElementRef(name = "LotReference", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = LotReference.class, required = false)
