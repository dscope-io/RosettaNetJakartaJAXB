 ...
 *         &lt;element name="WorkOrderReplyLineItem" type="{urn:rosettanet:specification:interchange:ManufacturingWorkOrderReplyNotification:xsd:schema:02.01}WorkOrderReplyLineItemType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
