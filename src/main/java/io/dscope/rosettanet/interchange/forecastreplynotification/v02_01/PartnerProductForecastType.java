 ...
 *         &lt;element name="ProductForecastInventoryFamily" type="{urn:rosettanet:specification:interchange:ForecastReplyNotification:xsd:schema:02.01}ProductForecastInventoryFamilyType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "PartnerProductForecastType", propOrder = {
    "partnerDescription",
    "productForecastInventoryFamily"
})
public class PartnerProductForecastType {
    ...
    @XmlElement(name = "ProductForecastInventoryFamily", required = true)
    protected List<ProductForecastInventoryFamilyType> productForecastInventoryFamily;
    ...
    /**
     * Gets the value of the productForecastInventoryFamily property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the productForecastInventoryFamily property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProductForecastInventoryFamily().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProductForecastInventoryFamilyType }
     * 
     * 
     */
    public List<ProductForecastInventoryFamilyType> getProductForecastInventoryFamily() {
        if (productForecastInventoryFamily == null) {
            productForecastInventoryFamily = new ArrayList<ProductForecastInventoryFamilyType>();
        }
        return this.productForecastInventoryFamily;
    }
