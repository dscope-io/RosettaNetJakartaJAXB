 ...
 *         &lt;element name="ProductInformation" type="{urn:rosettanet:specification:interchange:ShipFromStockAndDebitAuthorizationConfirmation:xsd:schema:01.01}ProductInformationType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
