...
/**
 * <p>Java class for ServiceEntitlementStatusResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ServiceEntitlementStatusResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="UnitInformation" type="{urn:rosettanet:specification:interchange:ServiceEntitlementStatusResponseNotification:xsd:schema:01.00}UnitInformationType"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ServiceEntitlementStatusResponseType", propOrder = {
    "documentHeader",
    "unitInformation"
})
public class ServiceEntitlementStatusResponseType {
    ...
    protected UnitInformationType unitInformation;
     ...
     *     
     */
    public UnitInformationType getUnitInformation() {
        return unitInformation;
    }

    /**
     * Sets the value of the unitInformation property.
     * 
     * @param value
     *     allowed object is
     *     {@link UnitInformationType }
     *     
     */
    public void setUnitInformation(UnitInformationType value) {
        this.unitInformation = value;
    }
