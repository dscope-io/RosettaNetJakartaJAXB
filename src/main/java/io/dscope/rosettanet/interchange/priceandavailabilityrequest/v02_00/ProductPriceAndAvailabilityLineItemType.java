 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:PricingTypeCode:xsd:codelist:01.03}PricingTypeCode" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}ProductPricingDetail" minOccurs="0"/&gt;
...
public class ProductPriceAndAvailabilityLineItemType {
    ...
    @XmlElementRef(name = "ProductPricingDetail", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = ProductPricingDetail.class, required = false)
