 ...
 * generated in the io.dscope.rosettanet.interchange.returnproductrequest.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.returnproductrequest.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:ReturnProductRequest:xsd:schema:01.02", name = "ReturnProductRequest")
