 ...
 *         &lt;element name="InventoryReportLineItem" type="{urn:rosettanet:specification:interchange:InventoryReportDistribution:xsd:schema:02.02}InventoryReportLineItemType" maxOccurs="unbounded"/&gt;
