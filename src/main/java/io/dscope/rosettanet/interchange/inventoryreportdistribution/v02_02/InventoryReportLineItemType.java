 ...
 *         &lt;element name="IntraCompanyTransfer" type="{urn:rosettanet:specification:interchange:InventoryReportDistribution:xsd:schema:02.02}IntraCompanyTransferType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="InventoryOwner" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.16}SpecifiedKnownPartnerType" minOccurs="0"/&gt;
 *         &lt;element name="InventoryProductQuantity" type="{urn:rosettanet:specification:interchange:InventoryReportDistribution:xsd:schema:02.02}InventoryProductQuantityType" maxOccurs="unbounded"/&gt;
