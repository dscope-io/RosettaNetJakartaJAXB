...
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.InventoryItemIdentification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}InventoryItemIdentification" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="InventoryMovement" type="{urn:rosettanet:specification:interchange:InventoryReportDistribution:xsd:schema:02.02}InventoryMovementType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class InventoryProductQuantityType {
    ...
    @XmlElementRef(name = "InventoryItemIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = InventoryItemIdentification.class, required = false)
