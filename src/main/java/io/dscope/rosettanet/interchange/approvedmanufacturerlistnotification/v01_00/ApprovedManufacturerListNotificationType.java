...
/**
 * <p>Java class for ApprovedManufacturerListNotificationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ApprovedManufacturerListNotificationType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="ApprovedManufacturerList" type="{urn:rosettanet:specification:interchange:ApprovedManufacturerListNotification:xsd:schema:01.00}ApprovedManufacturerListType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23}DocumentHeader"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ApprovedManufacturerListNotificationType", propOrder = {
    "approvedManufacturerList",
    "documentHeader"
})
public class ApprovedManufacturerListNotificationType {

    @XmlElement(name = "ApprovedManufacturerList", required = true)
    protected ApprovedManufacturerListType approvedManufacturerList;
    @XmlElementRef(name = "DocumentHeader", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.23", type = DocumentHeader.class)
