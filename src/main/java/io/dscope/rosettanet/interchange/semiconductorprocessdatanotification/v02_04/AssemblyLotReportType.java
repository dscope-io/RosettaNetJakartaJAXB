...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_23.QuantityDetail;
 ...
 *         &lt;element name="IncomingWaferLotReport" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}IncomingWaferLotReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OperationInformationReport" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}OperationInformationReportType" minOccurs="0"/&gt;
 *         &lt;element name="OpticalInspectionReport" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}OpticalInspectionReportType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Package" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}PackageType"/&gt;
 *         &lt;element name="PackageReport" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}PackageReportType" minOccurs="0"/&gt;
 *         &lt;element name="ProductCategory" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}QuantityDetail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class AssemblyLotReportType {
    ...
    @XmlElementRef(name = "QuantityDetail", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = QuantityDetail.class, required = false)
