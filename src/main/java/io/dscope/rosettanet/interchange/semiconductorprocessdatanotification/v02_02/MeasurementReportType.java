...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_13.FloatCoordinate;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_13.IntCoordinate;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_13.MeasurementUnit;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}Dimension" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}FloatCoordinate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}IntCoordinate" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="MeasurementFeatureReport" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.02}MeasurementFeatureReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}MeasurementUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TestParameterInformation" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.02}TestParameterInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MeasurementReportType {
    ...
    @XmlElementRef(name = "FloatCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = FloatCoordinate.class, required = false)
    protected List<FloatCoordinate> floatCoordinate;
    @XmlElementRef(name = "IntCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = IntCoordinate.class, required = false)
    ...
    @XmlElementRef(name = "MeasurementUnit", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = MeasurementUnit.class, required = false)
