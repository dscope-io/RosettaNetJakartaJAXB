 ...
 *         &lt;element name="Chip" type="{urn:rosettanet:specification:interchange:SemiconductorProcessDataNotification:xsd:schema:02.04}ChipType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OtherLocation" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}FacilityLocationType" minOccurs="0"/&gt;
