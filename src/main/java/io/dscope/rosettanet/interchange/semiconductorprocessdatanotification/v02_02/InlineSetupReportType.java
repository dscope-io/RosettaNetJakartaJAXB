...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_13.TestTemperature;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}TestTemperature" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class InlineSetupReportType {
    ...
    @XmlElementRef(name = "TestTemperature", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = TestTemperature.class, required = false)
