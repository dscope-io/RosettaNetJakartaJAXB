 ...
 * generated in the io.dscope.rosettanet.interchange.purchaseorderchangeconfirmation.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.purchaseorderchangeconfirmation.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:PurchaseOrderChangeConfirmationNotification:xsd:schema:01.00", name = "PurchaseOrderChangeConfirmation")
