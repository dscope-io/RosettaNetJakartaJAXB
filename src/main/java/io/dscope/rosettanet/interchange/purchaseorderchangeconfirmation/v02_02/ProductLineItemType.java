 ...
 *         &lt;element name="ProductSubLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderChangeConfirmation:xsd:schema:02.02}ProductSubLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ShippedQuantityInformation" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08}DeliveryInformationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalLineItemAmount" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.03}FinancialAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.03}UnitOfMeasure"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.03}FinancialAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductLineItemType {
    ...
    protected DeliveryInformationType shippedQuantityInformation;
     ...
     *     
     */
    public DeliveryInformationType getShippedQuantityInformation() {
        return shippedQuantityInformation;
    }

    /**
     * Sets the value of the shippedQuantityInformation property.
     * 
     * @param value
     *     allowed object is
     *     {@link DeliveryInformationType }
     *     
     */
    public void setShippedQuantityInformation(DeliveryInformationType value) {
        this.shippedQuantityInformation = value;
    }
