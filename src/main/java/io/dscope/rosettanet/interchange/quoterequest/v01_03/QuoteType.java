 ...
 *         &lt;element name="QuoteLineItem" type="{urn:rosettanet:specification:interchange:QuoteRequest:xsd:schema:01.03}QuoteLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}MonetaryAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
