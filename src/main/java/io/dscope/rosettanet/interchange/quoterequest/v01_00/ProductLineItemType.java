 ...
 *         &lt;element name="CompetitorReference" type="{urn:rosettanet:specification:interchange:QuoteRequestNotification:xsd:schema:01.00}CompetitorReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="QuoteCustomerInformation" type="{urn:rosettanet:specification:interchange:QuoteRequestNotification:xsd:schema:01.00}QuoteCustomerInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:interchange:QuoteRequestNotification:xsd:schema:01.00}QuoteQuantityType"/&gt;
