...
/**
 * <p>Java class for CompetitorReferenceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompetitorReferenceType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04}PartnerDescription"/&gt;
 ...
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}ProductPricingType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "CompetitorReferenceType", propOrder = {
    "partnerDescription",
...
public class CompetitorReferenceType {
    ...
    @XmlElementRef(name = "PartnerDescription", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04", type = PartnerDescription.class)
