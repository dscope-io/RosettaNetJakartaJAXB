 ...
 *       &lt;sequence&gt;
 *         &lt;choice&gt;
 *           &lt;element name="ProductLineItem" type="{urn:rosettanet:specification:interchange:QuoteRequest:xsd:schema:02.00}ProductLineItemType"/&gt;
 *           &lt;element name="ServiceLineItem" type="{urn:rosettanet:specification:interchange:QuoteRequest:xsd:schema:02.00}ServiceLineItemType"/&gt;
 *           &lt;element name="ServiceLineItemByOption" type="{urn:rosettanet:specification:interchange:QuoteRequest:xsd:schema:02.00}ServiceLineItemByOptionType"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
