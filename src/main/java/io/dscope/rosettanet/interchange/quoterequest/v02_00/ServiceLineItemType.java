 ...
 *         &lt;element name="InstallAt" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.07}SpecifiedPartnerDescriptionType"/&gt;
 ...
 *         &lt;element name="RequestedServiceQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType"/&gt;
 ...
 *         &lt;element name="RequoteLineStatus" type="{urn:rosettanet:specification:interchange:QuoteRequest:xsd:schema:02.00}RequoteLineStatusType" minOccurs="0"/&gt;
