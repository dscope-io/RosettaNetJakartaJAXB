 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.15}QuantityInformation" minOccurs="0"/&gt;
...
public class ShippingContainerItemType {
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.15", type = QuantityInformation.class, required = false)
