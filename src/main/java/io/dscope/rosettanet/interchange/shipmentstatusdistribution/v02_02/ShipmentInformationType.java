...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ShipmentChangeReason;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ShipmentServiceLevel;
...
import io.dscope.rosettanet.universal.physicaldimension.v01_05.WeightType;
 ...
 *         &lt;element name="RoutingInformation" type="{urn:rosettanet:specification:interchange:ShipmentStatusDistribution:xsd:schema:02.02}RoutingInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ShipmentChangeReason" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ShipmentServiceLevel" minOccurs="0"/&gt;
 *         &lt;element name="TotalContainer" type="{http://www.w3.org/2001/XMLSchema}positiveInteger" minOccurs="0"/&gt;
 *         &lt;element name="TotalWeight" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.05}WeightType"/&gt;
 *       &lt;/sequence&gt;
...
public class ShipmentInformationType {
    ...
    @XmlElementRef(name = "ShipmentChangeReason", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = ShipmentChangeReason.class, required = false)
    protected ShipmentChangeReason shipmentChangeReason;
    @XmlElementRef(name = "ShipmentServiceLevel", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = ShipmentServiceLevel.class, required = false)
