...
import io.dscope.rosettanet.domain.procurement.procurement.v02_22.TransportationEventType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConfirmedEvent" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}TransportationEventType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RevisedScheduledEvent" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}TransportationEventType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ScheduledEvent" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}TransportationEventType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
