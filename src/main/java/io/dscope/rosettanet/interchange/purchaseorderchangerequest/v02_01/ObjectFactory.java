 ...
 * generated in the io.dscope.rosettanet.interchange.purchaseorderchangerequest.v02_01 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.purchaseorderchangerequest.v02_01
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:PurchaseOrderChangeRequest:xsd:schema:02.01", name = "PurchaseOrderChangeRequest")
