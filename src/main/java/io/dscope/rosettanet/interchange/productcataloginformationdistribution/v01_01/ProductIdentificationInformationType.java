...
import io.dscope.rosettanet.domain.marketing.marketing.v02_19.IsDesignWin;
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.IsSoleSource;
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.ProductClassification;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}IsDesignWin"/&gt;
 *         &lt;element name="IsGeneric" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}IsSoleSource"/&gt;
 *         &lt;element name="ProductClassCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}ProductClassification" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.04}ProductDescription"/&gt;
 *         &lt;element name="ProductIdentificationInformation" type="{urn:rosettanet:specification:interchange:ProductCatalogInformationDistribution:xsd:schema:01.01}ProductIdentificationInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductIdentificationInformationType {
    ...
    @XmlElementRef(name = "IsDesignWin", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19", type = IsDesignWin.class)
    protected IsDesignWin isDesignWin;
    @XmlElement(name = "IsGeneric")
    protected boolean isGeneric;
    @XmlElementRef(name = "IsSoleSource", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = IsSoleSource.class)
    protected IsSoleSource isSoleSource;
    @XmlElement(name = "ProductClassCode")
    protected String productClassCode;
    @XmlElementRef(name = "ProductClassification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = ProductClassification.class, required = false)
