...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ProductLicenseRequired;
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.ProductQuantityRange;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ExportLicense" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ProductLicenseRequired" minOccurs="0"/&gt;
 ...
 *         &lt;element name="SampleOrder" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}ProductQuantityType" minOccurs="0"/&gt;
...
public class ProductProcurementType {
    ...
    @XmlElementRef(name = "ProductLicenseRequired", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = ProductLicenseRequired.class, required = false)
