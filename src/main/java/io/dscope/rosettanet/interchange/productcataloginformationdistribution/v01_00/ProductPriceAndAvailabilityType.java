...
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.OrderProvision;
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.ProductPricing;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AvailableQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.10}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}OrderProvision" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}ProductPricing" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductPriceAndAvailabilityType {
    ...
    @XmlElementRef(name = "OrderProvision", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = OrderProvision.class, required = false)
    protected List<OrderProvision> orderProvision;
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = ProductPricing.class, required = false)
