...
import io.dscope.rosettanet.domain.procurement.procurement.v02_19.ForecastProductSchedule;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}ForecastProductSchedule" maxOccurs="unbounded"/&gt;
...
public class ProductScheduleType {
    ...
    @XmlElementRef(name = "ForecastProductSchedule", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = ForecastProductSchedule.class)
