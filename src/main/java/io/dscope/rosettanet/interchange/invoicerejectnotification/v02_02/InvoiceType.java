...
import io.dscope.rosettanet.domain.procurement.codelist.invoicerejection.v01_05.InvoiceRejection;
 ...
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:InvoiceRejectNotification:xsd:schema:02.02}InvoiceLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:InvoiceRejection:xsd:codelist:01.05}InvoiceRejection"/&gt;
 ...
 *         &lt;element name="SalesOrder" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.12}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class InvoiceType {
    ...
    @XmlElementRef(name = "InvoiceRejection", namespace = "urn:rosettanet:specification:domain:Procurement:InvoiceRejection:xsd:codelist:01.05", type = InvoiceRejection.class)
