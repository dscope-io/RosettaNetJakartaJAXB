 ...
 * generated in the io.dscope.rosettanet.interchange.invoicerejectnotification.v02_03 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.invoicerejectnotification.v02_03
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:InvoiceRejectNotification:xsd:schema:02.03", name = "InvoiceRejectNotification")
