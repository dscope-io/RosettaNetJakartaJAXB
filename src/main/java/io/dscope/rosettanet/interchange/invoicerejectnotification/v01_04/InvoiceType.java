...
import io.dscope.rosettanet.domain.procurement.codelist.invoicerejection.v01_02.InvoiceRejection;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.Financing;
import io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountTypeType;
 ...
 *         &lt;element name="FinancialAmount" type="{urn:rosettanet:specification:domain:Shared:MonetaryAmountType:xsd:codelist:01.00}MonetaryAmountTypeType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}Financing" minOccurs="0"/&gt;
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:InvoiceRejectNotification:xsd:schema:01.04}InvoiceLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:InvoiceRejection:xsd:codelist:01.02}InvoiceRejection"/&gt;
 *         &lt;element name="PurchaseOrder" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReferenceType"/&gt;
 *         &lt;element name="SalesOrder" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class InvoiceType {
    ...
    @XmlElementRef(name = "InvoiceRejection", namespace = "urn:rosettanet:specification:domain:Procurement:InvoiceRejection:xsd:codelist:01.02", type = InvoiceRejection.class)
