...
import io.dscope.rosettanet.domain.design.design.v02_21.ToleranceType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="LowerTolerance" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.21}ToleranceType" minOccurs="0"/&gt;
 *         &lt;element name="NegativeTolerance" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.21}ToleranceType" minOccurs="0"/&gt;
 *         &lt;element name="PositiveTolerance" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.21}ToleranceType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="UpperTolerance" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.21}ToleranceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
