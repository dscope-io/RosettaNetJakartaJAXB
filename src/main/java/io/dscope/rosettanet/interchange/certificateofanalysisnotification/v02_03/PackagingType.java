...
import io.dscope.rosettanet.universal.physicaldimension.v01_08.MeasureType;
import io.dscope.rosettanet.universal.physicaldimension.v01_08.Volume;
import io.dscope.rosettanet.universal.physicaldimension.v01_08.Weight;
 ...
 *         &lt;element name="Container" type="{urn:rosettanet:specification:interchange:CertificateOfAnalysisNotification:xsd:schema:02.03}ContainerType" minOccurs="0"/&gt;
 *         &lt;element name="Pressure" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.08}MeasureType" minOccurs="0"/&gt;
 *         &lt;element name="Valve" type="{urn:rosettanet:specification:interchange:CertificateOfAnalysisNotification:xsd:schema:02.03}ValveType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.08}Volume" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.08}Weight" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PackagingType {
    ...
    @XmlElementRef(name = "Volume", namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.08", type = Volume.class, required = false)
    protected Volume volume;
    @XmlElementRef(name = "Weight", namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.08", type = Weight.class, required = false)
