 ...
 *         &lt;element name="LotIdentification" type="{urn:rosettanet:specification:interchange:CertificateOfAnalysisNotification:xsd:schema:02.05}LotIdentificationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="Material" type="{urn:rosettanet:specification:interchange:CertificateOfAnalysisNotification:xsd:schema:02.05}MaterialType"/&gt;
 *       &lt;/sequence&gt;
