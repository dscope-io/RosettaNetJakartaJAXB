...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_26.LotQuantity;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26}LotQuantity" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class LotIdentificationType {
    ...
    @XmlElementRef(name = "LotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26", type = LotQuantity.class, required = false)
