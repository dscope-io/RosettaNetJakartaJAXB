 ...
 *         &lt;element name="InvoiceInformation" type="{urn:rosettanet:specification:interchange:ShipFromStockAndDebitClaimRequest:xsd:schema:01.00}InvoiceInformationType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
