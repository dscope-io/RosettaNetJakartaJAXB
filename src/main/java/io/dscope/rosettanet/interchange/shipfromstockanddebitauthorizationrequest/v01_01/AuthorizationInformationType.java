 ...
 *         &lt;element name="ProductInformation" type="{urn:rosettanet:specification:interchange:ShipFromStockAndDebitAuthorizationRequest:xsd:schema:01.01}ProductInformationType" maxOccurs="unbounded"/&gt;
