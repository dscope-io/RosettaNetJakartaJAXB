...
@XmlRootElement(name = "ServiceContractReplyNotification", namespace = "urn:rosettanet:specification:interchange:ServiceContractReplyNotification:xsd:schema:02.01")
public class ServiceContractReplyNotification
    extends JAXBElement<ServiceContractReplyNotificationType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:ServiceContractReplyNotification:xsd:schema:02.01", "ServiceContractReplyNotification");
