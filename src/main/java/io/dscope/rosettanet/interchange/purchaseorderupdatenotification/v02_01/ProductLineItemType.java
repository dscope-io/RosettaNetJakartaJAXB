...
import io.dscope.rosettanet.domain.procurement.codelist.actiontype.v01_03.ActionType;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_06.CustomerInformation;
import io.dscope.rosettanet.domain.procurement.procurement.v02_06.OrderQuantity;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_06.SubstituteProductReference;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ActionType:xsd:codelist:01.03}ActionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}CustomerInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}OrderQuantity"/&gt;
 ...
 *         &lt;element name="ProductSubLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderUpdateNotification:xsd:schema:02.01}ProductSubLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RequestedEvent" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}TransportationEventType"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}SubstituteProductReference" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductLineItemType {
    ...
    @XmlElementRef(name = "ActionType", namespace = "urn:rosettanet:specification:domain:Procurement:ActionType:xsd:codelist:01.03", type = ActionType.class, required = false)
    ...
    @XmlElementRef(name = "CustomerInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = CustomerInformation.class, required = false)
    ...
    @XmlElementRef(name = "OrderQuantity", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = OrderQuantity.class)
    ...
    @XmlElementRef(name = "SubstituteProductReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = SubstituteProductReference.class, required = false)
