...
import io.dscope.rosettanet.domain.marketing.marketing.v02_19.RegistrationRenewableStatus;
import io.dscope.rosettanet.domain.marketing.marketing.v02_19.RegistrationSubmissionDate;
 ...
 *         &lt;element name="DesignProjectInformation" type="{urn:rosettanet:specification:interchange:DesignRegistrationConfirmationNotification:xsd:schema:01.00}DesignProjectInformationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}RegistrationDisposition"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}RegistrationRenewableStatus" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}RegistrationSubmissionDate" minOccurs="0"/&gt;
...
public class DesignRegistrationInformationType {
    ...
    @XmlElementRef(name = "RegistrationRenewableStatus", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19", type = RegistrationRenewableStatus.class, required = false)
    protected RegistrationRenewableStatus registrationRenewableStatus;
    @XmlElementRef(name = "RegistrationSubmissionDate", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19", type = RegistrationSubmissionDate.class, required = false)
