...
import io.dscope.rosettanet.domain.marketing.marketing.v02_12.ProductProviderComments;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}ProductProviderComments" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}RegistrationDisposition" minOccurs="0"/&gt;
...
public class DesignPartInformationType {
    ...
    @XmlElementRef(name = "ProductProviderComments", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = ProductProviderComments.class, required = false)
    ...
    @XmlElementRef(name = "RegistrationDisposition", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = RegistrationDisposition.class, required = false)
