 ...
 *         &lt;element name="DesignPartInformation" type="{urn:rosettanet:specification:interchange:DesignRegistrationConfirmation:xsd:schema:02.01}DesignPartInformationType" maxOccurs="unbounded"/&gt;
