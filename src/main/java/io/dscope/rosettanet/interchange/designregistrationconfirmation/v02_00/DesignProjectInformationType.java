 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DesignAssemblyInformation" type="{urn:rosettanet:specification:interchange:DesignRegistrationConfirmation:xsd:schema:02.00}DesignAssemblyInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}DesignProjectDescription"/&gt;
...
public class DesignProjectInformationType {
    ...
    @XmlElementRef(name = "DesignProjectDescription", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = DesignProjectDescription.class)
