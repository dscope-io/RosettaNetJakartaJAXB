 ...
 *         &lt;element name="ServiceEntitlement" type="{urn:rosettanet:specification:interchange:ServiceEntitlementQueryNotification:xsd:schema:01.00}ServiceEntitlementType"/&gt;
 *       &lt;/sequence&gt;
...
public class ServiceEntitlementQueryType {
