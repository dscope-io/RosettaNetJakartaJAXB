 ...
 *         &lt;element name="OrderLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderRequest:xsd:schema:02.00}OrderLineItemType" maxOccurs="unbounded"/&gt;
