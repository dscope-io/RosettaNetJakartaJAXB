 ...
 *         &lt;element name="DeviceActivationInformation" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.05}DeviceActivationInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DocumentSubLineLotShipReference" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.05}DocumentSubLineLotShipReferenceType" maxOccurs="unbounded"/&gt;
