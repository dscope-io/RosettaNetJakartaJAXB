 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}LotIdentification"/&gt;
...
public class LotShipReferenceType {
    ...
    @XmlElementRef(name = "LotIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = LotIdentification.class)
