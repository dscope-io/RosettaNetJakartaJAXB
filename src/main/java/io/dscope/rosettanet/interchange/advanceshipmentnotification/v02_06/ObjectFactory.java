 ...
 * generated in the io.dscope.rosettanet.interchange.advanceshipmentnotification.v02_06 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.advanceshipmentnotification.v02_06
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.06", name = "AdvanceShipmentNotification")
