...
import io.dscope.rosettanet.domain.procurement.procurement.v02_30.LotIdentification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}LotIdentification"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.28}LotQuantity" maxOccurs="unbounded"/&gt;
...
public class LotShipReferenceType {
    ...
    @XmlElementRef(name = "LotIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30", type = LotIdentification.class)
    protected LotIdentification lotIdentification;
    @XmlElementRef(name = "LotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.28", type = LotQuantity.class)
