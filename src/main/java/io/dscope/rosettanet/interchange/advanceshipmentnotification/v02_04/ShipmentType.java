...
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.ShipmentDate;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CarrierCode" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}SCACType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}ShipmentDate" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:ShipmentMode:xsd:codelist:01.05}ShipmentMode" minOccurs="0"/&gt;
 *         &lt;element name="ShippingContainer" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.04}ShippingContainerType" maxOccurs="unbounded"/&gt;
...
public class ShipmentType {
    ...
    @XmlElementRef(name = "ShipmentDate", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = ShipmentDate.class)
