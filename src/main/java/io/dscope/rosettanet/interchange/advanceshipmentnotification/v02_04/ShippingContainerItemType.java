 ...
 *         &lt;element name="DeviceActivationInformation" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.04}DeviceActivationInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DocumentSubLineLotShipReference" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.04}DocumentSubLineLotShipReferenceType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="FreightAmount" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.06}FinancialAmountType" minOccurs="0"/&gt;
