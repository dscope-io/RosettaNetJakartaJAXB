...
import io.dscope.rosettanet.domain.logistics.logistics.v02_08.MassPhysicalDimension;
...
import io.dscope.rosettanet.universal.physicaldimension.v01_04.Linear;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04}Linear" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08}MassPhysicalDimension" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ShippingContainerItem" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.01}ShippingContainerItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.07}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *         &lt;element name="SubContainer" type="{urn:rosettanet:specification:interchange:AdvanceShipmentNotification:xsd:schema:02.01}SubContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ShippingContainerType {
    ...
    @XmlElementRef(name = "Linear", namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04", type = Linear.class, required = false)
    protected Linear linear;
    @XmlElementRef(name = "MassPhysicalDimension", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08", type = MassPhysicalDimension.class, required = false)
