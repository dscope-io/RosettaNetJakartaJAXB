...
/**
 * <p>Java class for ProductListDistributionType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductListDistributionType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="EligibleProductList" type="{urn:rosettanet:specification:interchange:ProductListDistribution:xsd:schema:02.00}EligibleProductListType"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ProductListDistributionType", propOrder = {
    "documentHeader",
    "eligibleProductList"
})
public class ProductListDistributionType {
    ...
    @XmlElement(name = "EligibleProductList", required = true)
    protected EligibleProductListType eligibleProductList;
     ...
     * @return
     *     possible object is
     *     {@link EligibleProductListType }
     *     
     */
    public EligibleProductListType getEligibleProductList() {
     ...
     *     
     */
    public void setEligibleProductList(EligibleProductListType value) {
        this.eligibleProductList = value;
    }
