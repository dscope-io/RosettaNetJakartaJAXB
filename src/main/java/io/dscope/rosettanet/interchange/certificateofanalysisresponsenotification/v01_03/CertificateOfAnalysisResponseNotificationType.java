 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CertificateOfAnalysisResponse" type="{urn:rosettanet:specification:interchange:CertificateOfAnalysisResponseNotification:xsd:schema:01.03}CertificateOfAnalysisResponseType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class CertificateOfAnalysisResponseNotificationType {
    ...
    protected List<CertificateOfAnalysisResponseType> certificateOfAnalysisResponse;
     ...
     * This is why there is not a <CODE>set</CODE> method for the certificateOfAnalysisResponse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCertificateOfAnalysisResponse().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CertificateOfAnalysisResponseType> getCertificateOfAnalysisResponse() {
        if (certificateOfAnalysisResponse == null) {
            certificateOfAnalysisResponse = new ArrayList<CertificateOfAnalysisResponseType>();
        }
        return this.certificateOfAnalysisResponse;
    }
