 ...
 * generated in the io.dscope.rosettanet.interchange.shippingorderrequest.v02_04 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.shippingorderrequest.v02_04
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:ShippingOrderRequest:xsd:schema:02.04", name = "ShippingOrderRequest")
