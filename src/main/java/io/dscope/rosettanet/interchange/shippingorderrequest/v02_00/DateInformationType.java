...
import io.dscope.rosettanet.domain.logistics.logistics.v02_09.ShipmentDate;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09}ShipmentDate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class DateInformationType {
    ...
    @XmlElementRef(name = "ShipmentDate", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09", type = ShipmentDate.class, required = false)
