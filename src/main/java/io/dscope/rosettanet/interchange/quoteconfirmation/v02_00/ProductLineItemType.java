...
import io.dscope.rosettanet.domain.procurement.procurement.v02_05.StepPricing;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_05.TaxSummary;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Document:xsd:schema:01.03}BusinessDocumentReference" minOccurs="0"/&gt;
 *         &lt;element name="Comments" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="CompetitorReference" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}CompetitorReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="EstimatedAvailableQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}QuoteQuantityType"/&gt;
 ...
 *         &lt;element name="OrderLeadTime" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}OrderLeadTimeType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="QuoteReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.03}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}QuoteQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="RequestedShipFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.07}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 *         &lt;element name="RequestedUnitPrice" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductPricingType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RequoteLineStatus" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}RequoteLineStatusType" minOccurs="0"/&gt;
 *         &lt;element name="ResponseDescription" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="ScheduledQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:02.00}QuoteQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="ShipFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.07}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05}StepPricing" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05}TaxSummary" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.02}UnitOfMeasure"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductPricingType"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductLineItemType {
    ...
    @XmlElementRef(name = "StepPricing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05", type = StepPricing.class, required = false)
    ...
    @XmlElementRef(name = "TaxSummary", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05", type = TaxSummary.class, required = false)
