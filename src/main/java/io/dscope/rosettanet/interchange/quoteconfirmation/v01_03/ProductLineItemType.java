...
import io.dscope.rosettanet.domain.procurement.procurement.v01_15.StepPricing;
import io.dscope.rosettanet.domain.procurement.procurement.v01_15.SubstituteProductReference;
import io.dscope.rosettanet.domain.procurement.procurement.v01_15.TaxExemptStatus;
import io.dscope.rosettanet.domain.procurement.procurement.v01_15.TaxSummary;
import io.dscope.rosettanet.interchange.codelist.productterms.v01_00.ProductTerms;
import io.dscope.rosettanet.interchange.codelist.quotelineitemstatus.v01_00.QuoteLineItemStatus;
 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;urss:Constraint xmlns:urss="urn:rosettanet:specification:system:xml:1.0" xmlns:dgpr="urn:rosettanet:specification:domain:Procurement:GovernmentPriorityRating:xsd:codelist:01.02" xmlns:dl="urn:rosettanet:specification:domain:Logistics:xsd:schema:01.09" xmlns:dltcc="urn:rosettanet:specification:domain:Procurement:LeadTimeClassificationCode:xsd:codelist:01.02" xmlns:dp="urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15" xmlns:dpos="urn:rosettanet:specification:domain:Procurement:PurchaseOrderStatus:xsd:codelist:01.02" xmlns:dqar="urn:rosettanet:specification:domain:Procurement:QuoteAcknowledgmentReason:xsd:codelist:01.00" xmlns:dqs="urn:rosettanet:specification:domain:Procurement:QuoteStatus:xsd:codelist:01.01" xmlns:dqt="urn:rosettanet:specification:domain:Procurement:QuoteType:xsd:codelist:01.03" xmlns:dra="urn:rosettanet:specification:domain:Procurement:RequoteAction:xsd:codelist:01.02" xmlns:dro="urn:rosettanet:specification:domain:Procurement:RequestOption:xsd:codelist:01.00" xmlns:dte="urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02" xmlns:iltc="urn:rosettanet:specification:interchange:LeadTimeCommencement:xsd:codelist:01.00" xmlns:ipts="urn:rosettanet:specification:interchange:ProductTerms:xsd:codelist:01.00" xmlns:iqlis="urn:rosettanet:specification:interchange:QuoteLineItemStatus:xsd:codelist:01.00" xmlns:isi="urn:rosettanet:specification:interchange:StockIndicator:xsd:codelist:01.00" xmlns:p214879_="http://java.sun.com/xml/ns/jaxb" xmlns:p943895_="http://annox.dev.java.net" xmlns:ssdh="urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.06" xmlns:st="http://www.ascc.net/xml/schematron" xmlns:tns="urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03" xmlns:uc="urn:rosettanet:specification:universal:Country:xsd:codelist:01.01" xmlns:ud="urn:rosettanet:specification:universal:Dates:xsd:schema:01.01" xmlns:udc="urn:rosettanet:specification:universal:Document:xsd:schema:01.01" xmlns:updi="urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02" xmlns:upi="urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04" xmlns:uuom="urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.01" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;In ProductLineItem, if the value of QuoteStatus is equal to REJ then the occurence of QuoteAcknowledgmentReason MUST be 1.&lt;/urss:Constraint&gt;
 * </pre>
 * 
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Document:xsd:schema:01.01}BusinessDocumentReference" minOccurs="0"/&gt;
 *         &lt;element name="Comments" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="CompetitorReference" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}CompetitorReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="EstimatedAvailableQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}QuoteQuantityType"/&gt;
 ...
 *         &lt;element name="OrderLeadTime" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}OrderLeadTimeType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02}ProductIdentification"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:interchange:ProductTerms:xsd:codelist:01.00}ProductTerms" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="QuoteReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.01}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:interchange:QuoteLineItemStatus:xsd:codelist:01.00}QuoteLineItemStatus"/&gt;
 ...
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}QuoteQuantityType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ScheduledQuantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}QuoteQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="ShipFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}StepPricing" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:interchange:StockIndicator:xsd:codelist:01.00}StockIndicator" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}SubstituteProductReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}TaxExemptStatus" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}TaxSummary" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.01}UnitOfMeasure"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}ProductPricingType"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductLineItemType {
    ...
    @XmlElementRef(name = "ProductTerms", namespace = "urn:rosettanet:specification:interchange:ProductTerms:xsd:codelist:01.00", type = ProductTerms.class, required = false)
    ...
    @XmlElementRef(name = "QuoteLineItemStatus", namespace = "urn:rosettanet:specification:interchange:QuoteLineItemStatus:xsd:codelist:01.00", type = QuoteLineItemStatus.class)
    ...
    @XmlElementRef(name = "StepPricing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15", type = StepPricing.class, required = false)
    ...
    @XmlElementRef(name = "SubstituteProductReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15", type = SubstituteProductReference.class, required = false)
    ...
    @XmlElementRef(name = "TaxSummary", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15", type = TaxSummary.class, required = false)
