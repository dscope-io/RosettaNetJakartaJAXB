 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Quantity" type="{urn:rosettanet:specification:interchange:QuoteConfirmation:xsd:schema:01.03}QuantityType" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02}TransportEvent" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TransportationScheduleType {
    ...
    @XmlElementRef(name = "TransportEvent", namespace = "urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02", type = TransportEvent.class, required = false)
