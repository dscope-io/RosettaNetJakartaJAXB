 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}DatePeriodAndDuration"/&gt;
...
public class OrderLeadTimeType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.12", type = DatePeriodAndDuration.class)
