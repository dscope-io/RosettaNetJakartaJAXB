...
import io.dscope.rosettanet.domain.shared.shared.v01_04.DatePeriodAndDuration;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}DatePeriodAndDuration"/&gt;
...
public class OrderLeadTimeType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.04", type = DatePeriodAndDuration.class)
