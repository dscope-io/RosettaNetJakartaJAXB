 ...
 *         &lt;element name="EstimatedAvailableProductQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="EstimatedAvailableServiceQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType"/&gt;
 *         &lt;element name="ExpiringBy" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}DatePeriodAndDurationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="QuoteReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.03}BusinessDocumentReferenceType"/&gt;
 ...
 *         &lt;element name="RequestedProductQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="RequestedServiceQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="RequestedUnitPrice" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductPricingType"/&gt;
 ...
 *         &lt;element name="ServicePeriod" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}DatePeriodAndDurationType"/&gt;
