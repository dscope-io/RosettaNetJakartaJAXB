...
import io.dscope.rosettanet.domain.procurement.procurement.v02_19.LotIdentification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}LotIdentification" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ProductMovement" type="{urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.07}ProductMovementType" maxOccurs="unbounded"/&gt;
...
public class ProductDescriptionType {
    ...
    @XmlElementRef(name = "LotIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = LotIdentification.class, required = false)
