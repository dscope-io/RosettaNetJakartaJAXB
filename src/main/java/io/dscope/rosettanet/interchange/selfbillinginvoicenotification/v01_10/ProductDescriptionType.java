 ...
 *         &lt;element name="ProductMovement" type="{urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10}ProductMovementType" maxOccurs="unbounded"/&gt;
