 ...
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10}InvoiceLineItemType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="PaymentTerms" type="{urn:rosettanet:specification:domain:Procurement:PaymentTerms:xsd:codelist:01.04}PaymentTermsType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}PaymentTerms" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class InvoiceType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "AncillaryAmount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "BillToAccount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "InvoiceLineItem", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "IsLockBoxUsed", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "IsRebill", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "PartnerDescription", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.16", type = PartnerDescription.class, required = false),
        @XmlElementRef(name = "PaymentTerms", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "RemitTo", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RemitToAccount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RemitToTax", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "SelfBillingFrom", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SelfBillingTo", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SoldToAccount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SoldToTax", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TotalInvoiceAmount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TransferToAccount", namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.10", type = JAXBElement.class, required = false)
    })
     ...
     * line 82 of file:/Users/roman/Projects/DScope/RosettaNetJAXBBuilder/src/xsd/PIP3C7_V11.04.00_NotifyOfSelfBillingInvoice/XML/Interchange/SelfBillingInvoiceNotification_01_10.xsd
     * line 75 of file:/Users/roman/Projects/DScope/RosettaNetJAXBBuilder/src/xsd/PIP3C7_V11.04.00_NotifyOfSelfBillingInvoice/XML/Interchange/SelfBillingInvoiceNotification_01_10.xsd
     * <p>
