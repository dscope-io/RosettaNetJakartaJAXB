...
import io.dscope.rosettanet.universal.productidentification.v01_03.ProductSerialIdentification;
 ...
 *         &lt;element name="ProductMovement" type="{urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.06}ProductMovementType" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03}ProductSerialIdentification" minOccurs="0"/&gt;
...
public class ProductDescriptionType {
    ...
    @XmlElementRef(name = "ProductSerialIdentification", namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", type = ProductSerialIdentification.class, required = false)
