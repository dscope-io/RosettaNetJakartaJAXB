 ...
 * generated in the io.dscope.rosettanet.interchange.selfbillinginvoicenotification.v01_08 package. 
...
public class ObjectFactory {
    ...
    private final static QName _InvoiceTypeAncillaryAmount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "AncillaryAmount");
    private final static QName _InvoiceTypeBillToAccount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "BillToAccount");
    private final static QName _InvoiceTypeInvoiceLineItem_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "InvoiceLineItem");
    private final static QName _InvoiceTypeIsLockBoxUsed_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "IsLockBoxUsed");
    private final static QName _InvoiceTypeIsRebill_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "IsRebill");
    private final static QName _InvoiceTypePaymentTerms_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "PaymentTerms");
    private final static QName _InvoiceTypeRemitTo_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "RemitTo");
    private final static QName _InvoiceTypeRemitToAccount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "RemitToAccount");
    private final static QName _InvoiceTypeRemitToTax_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "RemitToTax");
    private final static QName _InvoiceTypeSelfBillingFrom_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "SelfBillingFrom");
    private final static QName _InvoiceTypeSelfBillingTo_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "SelfBillingTo");
    private final static QName _InvoiceTypeSoldToAccount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "SoldToAccount");
    private final static QName _InvoiceTypeSoldToTax_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "SoldToTax");
    private final static QName _InvoiceTypeTotalInvoiceAmount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "TotalInvoiceAmount");
    private final static QName _InvoiceTypeTransferToAccount_QNAME = new QName("urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", "TransferToAccount");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.selfbillinginvoicenotification.v01_08
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "SelfBillingInvoiceNotification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "AncillaryAmount", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "BillToAccount", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "InvoiceLineItem", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "IsLockBoxUsed", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "IsRebill", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "PaymentTerms", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "RemitTo", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "RemitToAccount", scope = InvoiceType.class)
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "RemitToTax", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link SpecifiedPartnerDescriptionType }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "SelfBillingFrom", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link SpecifiedPartnerDescriptionType }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "SelfBillingTo", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "SoldToAccount", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link TaxSummaryType }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "SoldToTax", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link MonetaryAmountType }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "TotalInvoiceAmount", scope = InvoiceType.class)
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08", name = "TransferToAccount", scope = InvoiceType.class)
