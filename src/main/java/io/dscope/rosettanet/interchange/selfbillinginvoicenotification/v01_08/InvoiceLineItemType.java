...
import io.dscope.rosettanet.domain.procurement.procurement.v02_27.FeeInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27}FeeInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ProductDescription" type="{urn:rosettanet:specification:interchange:SelfBillingInvoiceNotification:xsd:schema:01.08}ProductDescriptionType"/&gt;
...
public class InvoiceLineItemType {
    ...
    @XmlElementRef(name = "FeeInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27", type = FeeInformation.class, required = false)
