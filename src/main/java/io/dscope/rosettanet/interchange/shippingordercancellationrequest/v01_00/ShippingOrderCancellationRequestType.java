 ...
 *         &lt;element name="ShippingOrder" type="{urn:rosettanet:specification:interchange:ShippingOrderCancellationRequestNotification:xsd:schema:01.00}ShippingOrderType"/&gt;
 *       &lt;/sequence&gt;
...
public class ShippingOrderCancellationRequestType {
