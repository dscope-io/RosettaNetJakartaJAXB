...
@XmlRootElement(name = "ShippingOrderCancellationRequest", namespace = "urn:rosettanet:specification:interchange:ShippingOrderCancellationRequest:xsd:schema:02.01")
public class ShippingOrderCancellationRequest
    extends JAXBElement<ShippingOrderCancellationRequestType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:ShippingOrderCancellationRequest:xsd:schema:02.01", "ShippingOrderCancellationRequest");
