...
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.PriceList;
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.ProductAvailability;
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.ProductLeadTime;
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.ProductPricingDetail;
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.WarehouseInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AdditionalProductPriceAndAvailabilityLineItem" type="{urn:rosettanet:specification:interchange:PriceAndAvailabilityResponse:xsd:schema:02.00}AdditionalProductPriceAndAvailabilityLineItemType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}PriceList" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}ProductAvailability" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}ProductPricingDetail" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.03}UnitOfMeasure" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17}WarehouseInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductPriceAndAvailabilityLineItemType {
    ...
    @XmlElementRef(name = "PriceList", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = PriceList.class, required = false)
    ...
    @XmlElementRef(name = "ProductAvailability", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = ProductAvailability.class)
    ...
    @XmlElementRef(name = "ProductPricingDetail", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = ProductPricingDetail.class)
    ...
    @XmlElementRef(name = "WarehouseInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.17", type = WarehouseInformation.class, required = false)
