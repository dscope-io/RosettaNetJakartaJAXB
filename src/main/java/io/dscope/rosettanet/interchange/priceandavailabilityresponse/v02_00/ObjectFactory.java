 ...
 * generated in the io.dscope.rosettanet.interchange.priceandavailabilityresponse.v02_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.priceandavailabilityresponse.v02_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:PriceAndAvailabilityResponse:xsd:schema:02.00", name = "PriceAndAvailabilityResponse")
