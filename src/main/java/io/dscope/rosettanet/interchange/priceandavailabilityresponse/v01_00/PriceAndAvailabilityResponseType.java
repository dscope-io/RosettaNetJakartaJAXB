 ...
 *         &lt;element name="ProductPriceAndAvailability" type="{urn:rosettanet:specification:interchange:PriceAndAvailabilityResponseNotification:xsd:schema:01.00}ProductPriceAndAvailabilityType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
