...
package io.dscope.rosettanet.interchange.shippingorderconfirmation.v02_04;
...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.IsDeliveryRequired;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.IsHazardousMaterial;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ReturnLabel;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.WarehouseLocation;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}IsDeliveryRequired" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}IsHazardousMaterial"/&gt;
 ...
 *         &lt;element name="OrderConfirmation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}OrderConfirmationType"/&gt;
 ...
 *         &lt;element name="QuantityInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}QuantityInformationType"/&gt;
 *         &lt;element name="RequestingOrderLineItemReference" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}RequestingOrderLineItemReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ReturnLabel" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ShippingContainer" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}ShippingContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}WarehouseLocation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ShipmentLineItemType {
    ...
    @XmlElementRef(name = "IsDeliveryRequired", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = IsDeliveryRequired.class, required = false)
    protected IsDeliveryRequired isDeliveryRequired;
    @XmlElementRef(name = "IsHazardousMaterial", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = IsHazardousMaterial.class)
    ...
    @XmlElementRef(name = "ReturnLabel", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = ReturnLabel.class, required = false)
    ...
    @XmlElementRef(name = "WarehouseLocation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = WarehouseLocation.class, required = false)
