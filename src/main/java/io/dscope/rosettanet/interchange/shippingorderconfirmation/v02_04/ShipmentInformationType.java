...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ExportDeclarationType;
...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.IsPartialShipment;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.PhysicalDimension;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ShipmentInstructions;
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.CurrencyConversion;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}CurrencyConversion" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomValue" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="DateInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}DateInformationType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}IsPartialShipment" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RoutingInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.04}RoutingInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="SED" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ExportDeclarationType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ShipmentInstructions" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ShipmentInformationType {
    ...
    @XmlElementRef(name = "CurrencyConversion", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = CurrencyConversion.class, required = false)
    ...
    @XmlElementRef(name = "IsPartialShipment", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = IsPartialShipment.class, required = false)
    ...
    @XmlElementRef(name = "ShipmentInstructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = ShipmentInstructions.class, required = false)
