...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.FreightPaymentInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ShippingLabel;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}FreightPaymentInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ShippingLabel" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}SpecialHandlingInstruction" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class RoutingInformationType {
    ...
    @XmlElementRef(name = "FreightPaymentInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = FreightPaymentInformation.class, required = false)
    ...
    @XmlElementRef(name = "ShippingLabel", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = ShippingLabel.class, required = false)
