 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConfirmedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}ProductQuantityType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class QuantityInformationType {
    ...
    protected Float confirmedQuantity;
     ...
     *     
     */
    public void setConfirmedQuantity(Float value) {
