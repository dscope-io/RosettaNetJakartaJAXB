...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.LotReference;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ManufacturerProfile;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}LotReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ManufacturerProfile" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RequestingOrderLineItemReference" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}RequestingOrderLineItemReferenceType"/&gt;
...
public class ShippingContainerItemType {
    ...
    @XmlElementRef(name = "LotReference", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = LotReference.class, required = false)
    protected List<LotReference> lotReference;
    @XmlElementRef(name = "ManufacturerProfile", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = ManufacturerProfile.class, required = false)
