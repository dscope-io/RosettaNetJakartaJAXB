...
package io.dscope.rosettanet.interchange.shippingorderconfirmation.v02_02;
...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.IsDeliveryRequired;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.IsHazardousMaterial;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ReturnLabel;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_19.WarehouseLocation;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}IsDeliveryRequired" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}IsHazardousMaterial"/&gt;
 *         &lt;element name="LineNumber" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="LineReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.08}BusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="OrderConfirmation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}OrderConfirmationType"/&gt;
 ...
 *         &lt;element name="QuantityInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}QuantityInformationType"/&gt;
 *         &lt;element name="RequestingOrderLineItemReference" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}RequestingOrderLineItemReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ReturnLabel" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ShippingContainer" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}ShippingContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}SpecialHandlingInstruction" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}WarehouseLocation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ShipmentLineItemType {
    ...
    @XmlElementRef(name = "IsDeliveryRequired", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = IsDeliveryRequired.class, required = false)
    protected IsDeliveryRequired isDeliveryRequired;
    @XmlElementRef(name = "IsHazardousMaterial", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = IsHazardousMaterial.class)
    ...
    @XmlElementRef(name = "ReturnLabel", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = ReturnLabel.class, required = false)
    ...
    @XmlElementRef(name = "WarehouseLocation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = WarehouseLocation.class, required = false)
