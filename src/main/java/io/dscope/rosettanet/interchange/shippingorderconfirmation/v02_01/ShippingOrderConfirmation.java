...
@XmlRootElement(name = "ShippingOrderConfirmation", namespace = "urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.01")
public class ShippingOrderConfirmation
    extends JAXBElement<ShippingOrderConfirmationType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.01", "ShippingOrderConfirmation");
