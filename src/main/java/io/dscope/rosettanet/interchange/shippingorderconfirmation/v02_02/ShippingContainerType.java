...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.LabelInstructionType;
 ...
 *         &lt;element name="ShippingContainerItem" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}ShippingContainerItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ShippingLabel" minOccurs="0"/&gt;
 *         &lt;element name="SubContainer" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}SubContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TrackingIdentifier" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}LabelInstructionType" maxOccurs="unbounded" minOccurs="0"/&gt;
