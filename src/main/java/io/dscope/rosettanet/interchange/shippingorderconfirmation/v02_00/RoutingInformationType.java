...
import io.dscope.rosettanet.domain.logistics.logistics.v02_09.FreightPaymentInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_09.ShippingLabel;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DeliveryPriorityIdenfier" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09}FreightPaymentInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09}ShippingLabel" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ShipVia" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.08}SpecialHandlingInstruction" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class RoutingInformationType {
    ...
    @XmlElement(name = "DeliveryPriorityIdenfier")
    protected String deliveryPriorityIdenfier;
    @XmlElementRef(name = "FreightPaymentInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09", type = FreightPaymentInformation.class, required = false)
    ...
    @XmlElementRef(name = "ShippingLabel", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.09", type = ShippingLabel.class, required = false)
    ...
    /**
     * Gets the value of the deliveryPriorityIdenfier property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getDeliveryPriorityIdenfier() {
        return deliveryPriorityIdenfier;
    }

    /**
     * Sets the value of the deliveryPriorityIdenfier property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDeliveryPriorityIdenfier(String value) {
        this.deliveryPriorityIdenfier = value;
    }
