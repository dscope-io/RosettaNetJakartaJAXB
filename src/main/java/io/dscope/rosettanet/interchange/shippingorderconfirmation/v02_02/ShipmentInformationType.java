...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ExportDeclarationType;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ExportLicense;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.FreeOnBoardTerms;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.IsPartialShipment;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.PhysicalDimension;
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.ShipmentInstructions;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}CurrencyConversion" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomValue" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="DateInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}DateInformationType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ExportLicense" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}FreeOnBoardTerms" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}IsPartialShipment" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}PhysicalDimension" minOccurs="0"/&gt;
 *         &lt;element name="RoutingInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}RoutingInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="SED" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ExportDeclarationType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}ShipmentInstructions" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ShipmentInformationType {
    ...
    @XmlElementRef(name = "FreeOnBoardTerms", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = FreeOnBoardTerms.class, required = false)
    ...
    @XmlElementRef(name = "IsPartialShipment", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = IsPartialShipment.class, required = false)
    ...
    @XmlElementRef(name = "PhysicalDimension", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = PhysicalDimension.class, required = false)
    ...
    @XmlElementRef(name = "ShipmentInstructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = ShipmentInstructions.class, required = false)
