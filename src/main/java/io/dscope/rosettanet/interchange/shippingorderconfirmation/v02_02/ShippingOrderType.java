 ...
 *         &lt;element name="RequestingOrderInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}RequestingOrderInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="ShipmentInformation" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}ShipmentInformationType"/&gt;
 *         &lt;element name="ShipmentLineItem" type="{urn:rosettanet:specification:interchange:ShippingOrderConfirmation:xsd:schema:02.02}ShipmentLineItemType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
