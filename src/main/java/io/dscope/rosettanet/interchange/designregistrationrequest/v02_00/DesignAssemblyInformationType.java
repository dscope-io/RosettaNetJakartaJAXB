 ...
 *         &lt;element name="DesignCustomerInformation" type="{urn:rosettanet:specification:interchange:DesignRegistrationRequest:xsd:schema:02.00}DesignCustomerInformationType"/&gt;
 *         &lt;element name="DesignPartInformation" type="{urn:rosettanet:specification:interchange:DesignRegistrationRequest:xsd:schema:02.00}DesignPartInformationType" maxOccurs="unbounded"/&gt;
