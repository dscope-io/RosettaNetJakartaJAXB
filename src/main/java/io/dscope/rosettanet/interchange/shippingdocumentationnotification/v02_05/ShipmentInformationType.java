...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.DateInformation;
...
import io.dscope.rosettanet.domain.logistics.logistics.v02_17.Instructions;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}DateInformation" minOccurs="0"/&gt;
 *         &lt;element name="DeclarationInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.05}DeclarationInformationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}FreeOnBoardTerms" minOccurs="0"/&gt;
 *         &lt;element name="FreightTotalPhysicalDimension" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}PhysicalDimensionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}Instructions" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PricingPaymentInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.05}PricingPaymentInformationType" minOccurs="0"/&gt;
 *         &lt;element name="RoutingInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.05}RoutingInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="SaleTerms" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentReturnInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.05}ShipmentReturnInformationType" minOccurs="0"/&gt;
...
public class ShipmentInformationType {
    ...
    @XmlElementRef(name = "DateInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = DateInformation.class, required = false)
    ...
    @XmlElementRef(name = "Instructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = Instructions.class, required = false)
