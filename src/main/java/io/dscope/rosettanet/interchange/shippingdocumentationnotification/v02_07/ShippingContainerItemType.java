 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28}RequestingOrderLineItemReference"/&gt;
...
public class ShippingContainerItemType {
    ...
    @XmlElementRef(name = "RequestingOrderLineItemReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28", type = RequestingOrderLineItemReference.class)
