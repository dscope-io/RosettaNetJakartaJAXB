 ...
 *         &lt;element name="ShippingBusinessDocument" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.09}ShippingBusinessDocumentType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
