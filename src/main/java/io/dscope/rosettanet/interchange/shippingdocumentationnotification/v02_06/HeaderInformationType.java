...
import io.dscope.rosettanet.domain.logistics.logistics.v02_20.BillOfLading;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20}BillOfLading" minOccurs="0"/&gt;
 *         &lt;element name="CommercialInvoice" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.11}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="PackingList" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.11}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="ShippingDocument" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.11}BusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ShippingOrderInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.06}ShippingOrderInformationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class HeaderInformationType {
    ...
    @XmlElementRef(name = "BillOfLading", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20", type = BillOfLading.class, required = false)
