 ...
 * generated in the io.dscope.rosettanet.interchange.shippingdocumentationnotification.v02_06 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.shippingdocumentationnotification.v02_06
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.06", name = "ShippingDocumentationNotification")
