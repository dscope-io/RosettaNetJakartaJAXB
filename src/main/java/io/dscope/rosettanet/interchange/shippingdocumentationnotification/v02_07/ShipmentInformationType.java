...
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.CustomsInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.DateInformation;
...
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.Instructions;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.PhysicalDimensionType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}CustomsInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}DateInformation" minOccurs="0"/&gt;
 *         &lt;element name="DeclarationInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}DeclarationInformationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}FreeOnBoardTerms" minOccurs="0"/&gt;
 *         &lt;element name="FreightTotalPhysicalDimension" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}PhysicalDimensionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}Instructions" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PricingPaymentInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}PricingPaymentInformationType" minOccurs="0"/&gt;
 *         &lt;element name="RoutingInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}RoutingInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="SaleTerms" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentReturnInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ShipmentReturnInformationType" minOccurs="0"/&gt;
...
public class ShipmentInformationType {
    ...
    @XmlElementRef(name = "CustomsInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = CustomsInformation.class, required = false)
    protected CustomsInformation customsInformation;
    @XmlElementRef(name = "DateInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = DateInformation.class, required = false)
    ...
    @XmlElementRef(name = "Instructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = Instructions.class, required = false)
