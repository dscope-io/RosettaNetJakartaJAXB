...
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.CustomsPermittedInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.ExportLicense;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.FreightValuation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.Handbook;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.HarmonizedTariffScheduleInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.HazardousMaterialDescription;
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.IsHazardousMaterial;
import io.dscope.rosettanet.domain.procurement.procurement.v02_28.RequestingOrderLineItemReference;
import io.dscope.rosettanet.domain.procurement.procurement.v02_28.TaxExemptStatus;
import io.dscope.rosettanet.domain.procurement.procurement.v02_28.TaxSummary;
import io.dscope.rosettanet.domain.shared.shared.v01_17.QuantityInformation;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}CustomsPermittedInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}FreightValuation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}Handbook" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}HarmonizedTariffScheduleInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}HazardousMaterialDescription" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}IsHazardousMaterial" minOccurs="0"/&gt;
 *         &lt;element name="LineNumber" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="PreviousBusinessDocumentReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.12}BusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PreviousCustomsProcedure" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PricingInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}PricingInformationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ProductIdentificationInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ProductIdentificationInformationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}QuantityInformation"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28}RequestingOrderLineItemReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ShippingContainer" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ShippingContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28}TaxExemptStatus" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28}TaxSummary" minOccurs="0"/&gt;
...
public class ShipmentLineItemType {
    ...
    @XmlElementRef(name = "CustomsPermittedInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = CustomsPermittedInformation.class, required = false)
    ...
    @XmlElementRef(name = "FreightValuation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = FreightValuation.class, required = false)
    protected FreightValuation freightValuation;
    @XmlElementRef(name = "Handbook", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = Handbook.class, required = false)
    protected List<Handbook> handbook;
    @XmlElementRef(name = "HarmonizedTariffScheduleInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = HarmonizedTariffScheduleInformation.class, required = false)
    protected List<HarmonizedTariffScheduleInformation> harmonizedTariffScheduleInformation;
    @XmlElementRef(name = "HazardousMaterialDescription", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = HazardousMaterialDescription.class, required = false)
    protected List<HazardousMaterialDescription> hazardousMaterialDescription;
    @XmlElementRef(name = "IsHazardousMaterial", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = IsHazardousMaterial.class, required = false)
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.17", type = QuantityInformation.class)
    protected QuantityInformation quantityInformation;
    @XmlElementRef(name = "RequestingOrderLineItemReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28", type = RequestingOrderLineItemReference.class, required = false)
    ...
    @XmlElementRef(name = "TaxExemptStatus", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28", type = TaxExemptStatus.class, required = false)
    protected TaxExemptStatus taxExemptStatus;
    @XmlElementRef(name = "TaxSummary", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28", type = TaxSummary.class, required = false)
