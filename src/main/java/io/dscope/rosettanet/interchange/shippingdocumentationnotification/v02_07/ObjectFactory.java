 ...
 * generated in the io.dscope.rosettanet.interchange.shippingdocumentationnotification.v02_07 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.shippingdocumentationnotification.v02_07
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07", name = "ShippingDocumentationNotification")
