...
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.CustomsPermittedInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.ExportLicense;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.FreightValuation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.Handbook;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.HarmonizedTariffScheduleInformation;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.HazardousMaterialDescription;
import io.dscope.rosettanet.domain.logistics.logistics.v02_23.IsHazardousMaterial;
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.RequestingOrderLineItemReference;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}CustomsPermittedInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomsValuationMethod" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}ExportLicense" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}FreightValuation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}Handbook" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}HarmonizedTariffScheduleInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23}IsHazardousMaterial" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PricingInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.09}PricingInformationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ProductIdentificationInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.09}ProductIdentificationInformationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}QuantityInformation"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}RequestingOrderLineItemReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ShippingContainer" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.09}ShippingContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ShipmentLineItemType {
    ...
    @XmlElementRef(name = "CustomsPermittedInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = CustomsPermittedInformation.class, required = false)
    ...
    @XmlElementRef(name = "ExportLicense", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = ExportLicense.class, required = false)
    ...
    @XmlElementRef(name = "Handbook", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = Handbook.class, required = false)
    protected List<Handbook> handbook;
    @XmlElementRef(name = "HarmonizedTariffScheduleInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = HarmonizedTariffScheduleInformation.class, required = false)
    ...
    @XmlElementRef(name = "IsHazardousMaterial", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.23", type = IsHazardousMaterial.class, required = false)
    ...
    @XmlElementRef(name = "RequestingOrderLineItemReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = RequestingOrderLineItemReference.class, required = false)
