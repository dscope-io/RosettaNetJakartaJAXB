...
import io.dscope.rosettanet.domain.logistics.logistics.v02_22.BillOfLading;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}BillOfLading" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ShippingOrderInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ShippingOrderInformationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class HeaderInformationType {
    ...
    @XmlElementRef(name = "BillOfLading", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22", type = BillOfLading.class, required = false)
