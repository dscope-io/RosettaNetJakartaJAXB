...
import io.dscope.rosettanet.domain.procurement.procurement.v02_19.PaymentOrder;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}PaymentOrder" minOccurs="0"/&gt;
...
public class PricingPaymentInformationType {
    ...
    @XmlElementRef(name = "PaymentOrder", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = PaymentOrder.class, required = false)
