 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ContainerPhysicalDimension" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.22}PhysicalDimensionType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ShippingContainerItem" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ShippingContainerItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SubContainer" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}SubContainerType" maxOccurs="unbounded" minOccurs="0"/&gt;
