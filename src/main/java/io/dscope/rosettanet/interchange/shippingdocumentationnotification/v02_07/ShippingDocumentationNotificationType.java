 ...
 *         &lt;element name="ShippingBusinessDocument" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.07}ShippingBusinessDocumentType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class ShippingDocumentationNotificationType {
