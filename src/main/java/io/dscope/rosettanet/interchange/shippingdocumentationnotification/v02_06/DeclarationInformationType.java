...
import io.dscope.rosettanet.domain.logistics.logistics.v02_20.ForeignCurrencyControl;
import io.dscope.rosettanet.domain.logistics.logistics.v02_20.ShippingDocumentReference;
...
import io.dscope.rosettanet.universal.partneridentification.v01_15.SpecifiedPartnerDescriptionType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AmendmentInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.06}AmendmentInformationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="DateInformation" type="{urn:rosettanet:specification:interchange:ShippingDocumentationNotification:xsd:schema:02.06}DateInformationType" minOccurs="0"/&gt;
 *         &lt;element name="Declarant" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.15}SpecifiedPartnerDescriptionType"/&gt;
 *         &lt;element name="DeclarationFormReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.11}BusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:interchange:DeliveryType:xsd:codelist:01.00}DeliveryType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20}ForeignCurrencyControl" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20}ShippingDocumentReference" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class DeclarationInformationType {
    ...
    @XmlElementRef(name = "ForeignCurrencyControl", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20", type = ForeignCurrencyControl.class, required = false)
    ...
    @XmlElementRef(name = "ShippingDocumentReference", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20", type = ShippingDocumentReference.class, required = false)
