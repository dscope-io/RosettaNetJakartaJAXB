...
import io.dscope.rosettanet.domain.procurement.procurement.v02_28.SpecialHandlingInstruction;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28}SpecialHandlingInstruction" minOccurs="0"/&gt;
...
public class RoutingInformationType {
    ...
    @XmlElementRef(name = "SpecialHandlingInstruction", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.28", type = SpecialHandlingInstruction.class, required = false)
