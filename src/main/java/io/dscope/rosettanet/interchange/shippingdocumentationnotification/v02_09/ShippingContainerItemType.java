 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}RequestingOrderLineItemReference"/&gt;
...
public class ShippingContainerItemType {
    ...
    @XmlElementRef(name = "RequestingOrderLineItemReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = RequestingOrderLineItemReference.class)
