...
import io.dscope.rosettanet.domain.procurement.procurement.v02_29.PaymentOrder;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29}PaymentOrder" minOccurs="0"/&gt;
...
public class PricingPaymentInformationType {
    ...
    @XmlElementRef(name = "PaymentOrder", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.29", type = PaymentOrder.class, required = false)
