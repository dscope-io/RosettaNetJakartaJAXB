 ...
 *         &lt;element name="InvoiceInformation" type="{urn:rosettanet:specification:interchange:ShipFromStockAndDebitClaimRequestNotification:xsd:schema:01.00}InvoiceInformationType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
