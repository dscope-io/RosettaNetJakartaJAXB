...
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.LotIdentification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}LotIdentification" minOccurs="0"/&gt;
...
public class ProductDescriptionType {
    ...
    @XmlElementRef(name = "LotIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = LotIdentification.class, required = false)
