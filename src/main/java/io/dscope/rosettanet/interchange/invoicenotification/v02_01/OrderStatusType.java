...
import io.dscope.rosettanet.domain.logistics.logistics.v02_16.TrackingReferenceType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PrimaryIdentifier" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16}TrackingReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PurchaseOrder" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.01}PurchaseOrderType"/&gt;
 *         &lt;element name="SecondaryIdentifier" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16}TrackingReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
