...
import io.dscope.rosettanet.domain.procurement.procurement.v02_07.InvoiceAmountType;
...
import io.dscope.rosettanet.universal.partneridentification.v01_08.PartnerDescriptionType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AncillaryAmount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.07}InvoiceAmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="BillFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}PartnerDescriptionType"/&gt;
 *         &lt;element name="BillTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}PartnerDescriptionType"/&gt;
 ...
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.00}InvoiceLineItemType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="OriginalInvoiceNumber" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.07}SpecifiedBusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.07}PaymentTerms" minOccurs="0"/&gt;
 *         &lt;element name="PreTaxAmount" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.00}AmountType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RemitTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}PartnerDescriptionType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="SalesOrderIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.07}SpecifiedBusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SoldTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalInvoiceAmount" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.00}AmountType"/&gt;
 *         &lt;element name="TransferTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
