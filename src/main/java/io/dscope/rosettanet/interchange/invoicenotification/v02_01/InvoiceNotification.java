...
@XmlRootElement(name = "InvoiceNotification", namespace = "urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.01")
public class InvoiceNotification
    extends JAXBElement<InvoiceNotificationType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.01", "InvoiceNotification");
