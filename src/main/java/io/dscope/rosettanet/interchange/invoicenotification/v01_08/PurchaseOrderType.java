 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GovernmentContractIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}SpecifiedBusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="ProductLineItem" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:01.08}ProductLineItemType" maxOccurs="unbounded"/&gt;
