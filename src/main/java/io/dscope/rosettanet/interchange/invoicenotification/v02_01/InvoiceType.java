...
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.AccountSummaryType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.AncillaryDates;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.Financing;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.InvoiceAmountType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.PaymentTerms;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.SpecifiedBusinessDocumentReferenceType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_18.TaxSummaryType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AncillaryAmount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}InvoiceAmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="BillFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.13}SpecifiedPartnerDescriptionType"/&gt;
 *         &lt;element name="BillTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.13}SpecifiedPartnerDescriptionType"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}Financing" minOccurs="0"/&gt;
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.01}InvoiceLineItemType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="OriginalInvoiceNumber" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}SpecifiedBusinessDocumentReferenceType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}PaymentTerms" minOccurs="0"/&gt;
 ...
 *         &lt;element name="RemitToAccount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}AccountSummaryType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RemitToTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}TaxSummaryType" minOccurs="0"/&gt;
 *         &lt;element name="SalesOrderIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}SpecifiedBusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SoldToAccount" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SoldToTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18}TaxSummaryType" minOccurs="0"/&gt;
 *         &lt;element name="TotalInvoiceAmount" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:02.01}AmountType"/&gt;
...
public class InvoiceType {
    ...
    @XmlElementRef(name = "Financing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18", type = Financing.class, required = false)
    ...
    @XmlElementRef(name = "PaymentTerms", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.18", type = PaymentTerms.class, required = false)
