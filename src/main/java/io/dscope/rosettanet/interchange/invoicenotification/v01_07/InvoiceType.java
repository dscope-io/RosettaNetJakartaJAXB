...
import io.dscope.rosettanet.domain.procurement.codelist.documenttype.v01_03.DocumentType;
import io.dscope.rosettanet.domain.procurement.codelist.purchasetype.v01_02.PurchaseType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.AccountSummaryType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.Financing;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.InvoiceAmountType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.PaymentTerms;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.SpecifiedBusinessDocumentReferenceType;
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.TaxSummaryType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AncillaryAmount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}InvoiceAmountType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="BillFrom" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05}PartnerDescriptionType"/&gt;
 *         &lt;element name="BillTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05}PartnerDescriptionType"/&gt;
 *         &lt;element name="BillToAccount" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Comments" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:DocumentType:xsd:codelist:01.03}DocumentType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}Financing" minOccurs="0"/&gt;
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:01.07}InvoiceLineItemType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="OriginalInvoiceNumber" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}SpecifiedBusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}PaymentTerms" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PurchaseOrderNumber" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}SpecifiedBusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PurchaseType:xsd:codelist:01.02}PurchaseType" minOccurs="0"/&gt;
 *         &lt;element name="RemitTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05}PartnerDescriptionType" minOccurs="0"/&gt;
 *         &lt;element name="RemitToAccount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}AccountSummaryType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RemitToTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}TaxSummaryType" minOccurs="0"/&gt;
 *         &lt;element name="SalesOrderIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}SpecifiedBusinessDocumentReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SoldTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 *         &lt;element name="SoldToAccount" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SoldToTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}TaxSummaryType" minOccurs="0"/&gt;
 *         &lt;element name="TotalInvoiceAmount" type="{urn:rosettanet:specification:interchange:InvoiceNotification:xsd:schema:01.07}AmountType"/&gt;
 *         &lt;element name="TransferTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
...
public class InvoiceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:domain:Procurement:DocumentType:xsd:codelist:01.03", type = DocumentType.class)
    protected DocumentType documentType;
    @XmlElementRef(name = "Financing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = Financing.class, required = false)
    ...
    @XmlElementRef(name = "PurchaseType", namespace = "urn:rosettanet:specification:domain:Procurement:PurchaseType:xsd:codelist:01.02", type = PurchaseType.class, required = false)
