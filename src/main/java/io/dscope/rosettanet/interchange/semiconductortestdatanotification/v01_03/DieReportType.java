...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.IntCoordinate;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.StartAndEndDateTimeType;
 ...
 *         &lt;element name="DieTestingPeriod" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}StartAndEndDateTimeType" minOccurs="0"/&gt;
 *         &lt;element name="FirstFailSort" type="{http://www.w3.org/2001/XMLSchema}integer" minOccurs="0"/&gt;
 *         &lt;element name="GangTest" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}GangTestType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}IntCoordinate" minOccurs="0"/&gt;
...
public class DieReportType {
    ...
    protected StartAndEndDateTimeType dieTestingPeriod;
    @XmlElement(name = "FirstFailSort")
    protected BigInteger firstFailSort;
    @XmlElement(name = "GangTest")
    protected GangTestType gangTest;
    @XmlElementRef(name = "IntCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = IntCoordinate.class, required = false)
     ...
     *     
     */
    public StartAndEndDateTimeType getDieTestingPeriod() {
     ...
     *     
     */
    public void setDieTestingPeriod(StartAndEndDateTimeType value) {
