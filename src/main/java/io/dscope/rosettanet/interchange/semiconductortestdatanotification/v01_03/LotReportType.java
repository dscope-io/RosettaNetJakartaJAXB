...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.Lot;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.Pin;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.TestSpecificationReport;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.Wafer;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BALocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}BALocationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="FabLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}FabLocationType" minOccurs="0"/&gt;
 *         &lt;element name="FileDataVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="FinalTestLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}FinalTestLocationType" minOccurs="0"/&gt;
 *         &lt;element name="GlobalLotStatusCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}Lot"/&gt;
 *         &lt;element name="OtherLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}OtherLocationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}Pin" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Sort" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}SortType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TestOperationDescription" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}TestOperationDescriptionType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}TestSpecificationReport" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}Wafer" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="WaferSortLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}WaferSortLocationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class LotReportType {
    ...
    @XmlElementRef(name = "Lot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = Lot.class)
    protected Lot lot;
    @XmlElement(name = "OtherLocation")
    protected List<OtherLocationType> otherLocation;
    @XmlElementRef(name = "Pin", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = Pin.class, required = false)
    ...
    @XmlElementRef(name = "TestSpecificationReport", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = TestSpecificationReport.class, required = false)
    protected List<TestSpecificationReport> testSpecificationReport;
    @XmlElementRef(name = "Wafer", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = Wafer.class, required = false)
