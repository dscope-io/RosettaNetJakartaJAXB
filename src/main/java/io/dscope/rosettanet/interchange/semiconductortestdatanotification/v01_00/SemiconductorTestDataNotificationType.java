 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:1.0}DocumentHeader" minOccurs="0"/&gt;
 *         &lt;element name="LotReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}LotReportType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class SemiconductorTestDataNotificationType {
    ...
    @XmlElementRef(name = "DocumentHeader", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:1.0", type = DocumentHeader.class, required = false)
