...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_23.Pin;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_23.TestSpecificationReport;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BALocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}BALocationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="FabLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}FabLocationType" minOccurs="0"/&gt;
 *         &lt;element name="FileDataVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="FinalTestLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}FinalTestLocationType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OtherLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}OtherLocationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PartnerSecurityID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}Pin" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Sort" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}SortType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TestOperationDescription" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}TestOperationDescriptionType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}TestSpecificationReport" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="WaferSortLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}WaferSortLocationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class LotReportType {
    ...
    @XmlElement(name = "PartnerSecurityID")
    protected String partnerSecurityID;
    @XmlElementRef(name = "Pin", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = Pin.class, required = false)
    ...
    @XmlElementRef(name = "TestSpecificationReport", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = TestSpecificationReport.class, required = false)
    ...
    /**
     * Gets the value of the partnerSecurityID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPartnerSecurityID() {
        return partnerSecurityID;
    }

    /**
     * Sets the value of the partnerSecurityID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPartnerSecurityID(String value) {
        this.partnerSecurityID = value;
    }
