 ...
 * generated in the io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_03 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_03
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03", name = "SemiconductorTestDataNotification")
