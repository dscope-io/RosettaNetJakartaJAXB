...
import io.dscope.rosettanet.domain.manufacturing.codelist.confidentiality.v01_00.Confidentiality;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.Lot;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.Pin;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.TestSpecificationReport;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.Wafer;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BALocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}BALocationType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:Confidentiality:xsd:codelist:1.0}Confidentiality" minOccurs="0"/&gt;
 *         &lt;element name="FabLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}FabLocationType" minOccurs="0"/&gt;
 *         &lt;element name="FileDataVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="FinalTestLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}FinalTestLocationType" minOccurs="0"/&gt;
 *         &lt;element name="GlobalLotStatusCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}Lot"/&gt;
 *         &lt;element name="OtherLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}OtherLocationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}Pin" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Sort" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}SortType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TestOperationDescription" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}TestOperationDescriptionType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}TestSpecificationReport" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}Wafer" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="WaferSortLocation" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}WaferSortLocationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class LotReportType {
    ...
    @XmlElementRef(name = "Confidentiality", namespace = "urn:rosettanet:specification:domain:Manufacturing:Confidentiality:xsd:codelist:1.0", type = Confidentiality.class, required = false)
    ...
    @XmlElementRef(name = "Lot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = Lot.class)
    protected Lot lot;
    @XmlElement(name = "OtherLocation")
    protected List<OtherLocationType> otherLocation;
    @XmlElementRef(name = "Pin", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = Pin.class, required = false)
    ...
    @XmlElementRef(name = "TestSpecificationReport", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = TestSpecificationReport.class, required = false)
    protected List<TestSpecificationReport> testSpecificationReport;
    @XmlElementRef(name = "Wafer", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = Wafer.class, required = false)
