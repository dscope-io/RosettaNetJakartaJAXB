...
import io.dscope.rosettanet.domain.manufacturing.codelist.coordinateflag.v01_00.CoordinateFlag;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.Dimension;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.TestSetup;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.Tester;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ChipPeriodicity" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:1.0}ChipPeriodicityType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:CoordinateFlag:xsd:codelist:1.0}CoordinateFlag" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}Dimension" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="SampleRate" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:1.0}PercentAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}Tester"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}TestSetup"/&gt;
 *       &lt;/sequence&gt;
...
public class SetupReportType {
    ...
    @XmlElementRef(name = "CoordinateFlag", namespace = "urn:rosettanet:specification:domain:Manufacturing:CoordinateFlag:xsd:codelist:1.0", type = CoordinateFlag.class, required = false)
    protected CoordinateFlag coordinateFlag;
    @XmlElementRef(name = "Dimension", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = Dimension.class)
    ...
    @XmlElementRef(name = "Tester", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = Tester.class)
    protected Tester tester;
    @XmlElementRef(name = "TestSetup", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = TestSetup.class)
