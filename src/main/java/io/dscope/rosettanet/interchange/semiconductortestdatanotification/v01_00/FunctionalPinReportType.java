...
import io.dscope.rosettanet.domain.manufacturing.codelist.bits.v01_00.Bits;
import io.dscope.rosettanet.domain.manufacturing.codelist.testresult.v01_00.TestResult;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:Bits:xsd:codelist:1.0}Bits" minOccurs="0"/&gt;
 *         &lt;element name="PrimaryIdentifier" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:TestResult:xsd:codelist:1.0}TestResult" minOccurs="0"/&gt;
...
public class FunctionalPinReportType {
    ...
    @XmlElementRef(name = "Bits", namespace = "urn:rosettanet:specification:domain:Manufacturing:Bits:xsd:codelist:1.0", type = Bits.class, required = false)
    protected Bits bits;
    @XmlElement(name = "PrimaryIdentifier", required = true)
    protected BigInteger primaryIdentifier;
    @XmlElementRef(name = "TestResult", namespace = "urn:rosettanet:specification:domain:Manufacturing:TestResult:xsd:codelist:1.0", type = TestResult.class, required = false)
