 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SetupReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}SetupReportType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="WaferTestingPeriod" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}StartAndEndDateTimeType" minOccurs="0"/&gt;
 *         &lt;element name="WaferUniqueID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;choice&gt;
 *           &lt;element name="FinalTest" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}FinalTestType"/&gt;
 *           &lt;element name="PCM" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}PCMType"/&gt;
 *           &lt;element name="WaferSort" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}WaferSortType"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
