...
import io.dscope.rosettanet.domain.manufacturing.codelist.sortweight.v01_00.SortWeight;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:SortWeight:xsd:codelist:1.0}SortWeight" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SortType {
    ...
    @XmlElementRef(name = "SortWeight", namespace = "urn:rosettanet:specification:domain:Manufacturing:SortWeight:xsd:codelist:1.0", type = SortWeight.class, required = false)
