...
import io.dscope.rosettanet.system.standarddocumentheader.v01_13.DocumentHeader;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13}DocumentHeader" minOccurs="0"/&gt;
 *         &lt;element name="LotReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.05}LotReportType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class SemiconductorTestDataNotificationType {

    @XmlElementRef(name = "DocumentHeader", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.13", type = DocumentHeader.class, required = false)
