...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.HexCoordinate;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}HexCoordinate"/&gt;
...
public class ECIDReportType {
    ...
    @XmlElementRef(name = "HexCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = HexCoordinate.class)
