...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_00.HexCoordinate;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}HexCoordinate"/&gt;
 *         &lt;element name="RawBits" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:1.0}HexadecimalType"/&gt;
 *       &lt;/sequence&gt;
...
public class ECIDReportType {
    ...
    @XmlElementRef(name = "HexCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = HexCoordinate.class)
