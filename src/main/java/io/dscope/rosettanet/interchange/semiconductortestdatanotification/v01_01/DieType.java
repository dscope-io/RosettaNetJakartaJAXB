 ...
 *         &lt;element name="TestReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}TestReportType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="WaferTestingPeriod" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.01}DateTimePeriodType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class DieType {
    ...
    protected DateTimePeriodType waferTestingPeriod;
     ...
     *     
     */
    public DateTimePeriodType getWaferTestingPeriod() {
     ...
     *     
     */
    public void setWaferTestingPeriod(DateTimePeriodType value) {
