...
import io.dscope.rosettanet.domain.manufacturing.codelist.status.v01_00.Status;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:Status:xsd:codelist:1.0}Status"/&gt;
...
public class VectorReportType {
    ...
    @XmlElementRef(name = "Status", namespace = "urn:rosettanet:specification:domain:Manufacturing:Status:xsd:codelist:1.0", type = Status.class)
