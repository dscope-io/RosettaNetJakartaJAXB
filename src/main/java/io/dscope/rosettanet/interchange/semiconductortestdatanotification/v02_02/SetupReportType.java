...
import io.dscope.rosettanet.domain.manufacturing.codelist.coordinateflag.v01_03.CoordinateFlag;
...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v02_23.Tester;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}ChipPeriodicity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:CoordinateFlag:xsd:codelist:01.03}CoordinateFlag" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}Dimension" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}Tester"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}TestSetup"/&gt;
 *       &lt;/sequence&gt;
...
public class SetupReportType {
    ...
    @XmlElementRef(name = "CoordinateFlag", namespace = "urn:rosettanet:specification:domain:Manufacturing:CoordinateFlag:xsd:codelist:01.03", type = CoordinateFlag.class, required = false)
    protected CoordinateFlag coordinateFlag;
    @XmlElementRef(name = "Dimension", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = Dimension.class)
    ...
    @XmlElementRef(name = "Tester", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = Tester.class)
    protected Tester tester;
    @XmlElementRef(name = "TestSetup", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = TestSetup.class)
