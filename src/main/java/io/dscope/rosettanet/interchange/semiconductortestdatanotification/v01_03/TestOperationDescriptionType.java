 ...
 *         &lt;element name="TestOpIdentification" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.03}TestOpIdentificationType" maxOccurs="unbounded"/&gt;
