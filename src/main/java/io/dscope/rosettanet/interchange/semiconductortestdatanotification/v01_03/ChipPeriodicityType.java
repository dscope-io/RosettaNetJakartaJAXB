...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_12.FloatCoordinate;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}FloatCoordinate"/&gt;
 *       &lt;/sequence&gt;
...
public class ChipPeriodicityType {
    ...
    @XmlElementRef(name = "FloatCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = FloatCoordinate.class)
