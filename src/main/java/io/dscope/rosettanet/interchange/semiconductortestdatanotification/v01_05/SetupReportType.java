...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.ChipPeriodicity;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.Dimension;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.TestSetup;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.Tester;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}ChipPeriodicity" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}Dimension" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="SampleRate" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.04}PercentAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}Tester"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}TestSetup"/&gt;
 *       &lt;/sequence&gt;
...
public class SetupReportType {
    ...
    @XmlElementRef(name = "ChipPeriodicity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = ChipPeriodicity.class, required = false)
    protected List<ChipPeriodicity> chipPeriodicity;
    ...
    @XmlElementRef(name = "Dimension", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = Dimension.class)
    ...
    @XmlElementRef(name = "Tester", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = Tester.class)
    protected Tester tester;
    @XmlElementRef(name = "TestSetup", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = TestSetup.class)
     ...
     * This is why there is not a <CODE>set</CODE> method for the chipPeriodicity property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChipPeriodicity().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ChipPeriodicity> getChipPeriodicity() {
        if (chipPeriodicity == null) {
            chipPeriodicity = new ArrayList<ChipPeriodicity>();
        }
        return this.chipPeriodicity;
    }
