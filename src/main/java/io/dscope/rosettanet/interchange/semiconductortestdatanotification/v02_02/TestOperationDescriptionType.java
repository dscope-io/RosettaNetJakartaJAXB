...
import io.dscope.rosettanet.domain.manufacturing.codelist.completionstatus.v01_03.CompletionStatusType;
 ...
 *         &lt;element name="LotStatusCompletion" type="{urn:rosettanet:specification:domain:Manufacturing:CompletionStatus:xsd:codelist:01.03}CompletionStatusType" minOccurs="0"/&gt;
 *         &lt;element name="TestOpIdentification" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:02.02}TestOpIdentificationType" maxOccurs="unbounded"/&gt;
