...
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.IntCoordinate;
import io.dscope.rosettanet.domain.manufacturing.manufacturing.v01_14.StartAndEndDateTimeType;
 ...
 *         &lt;element name="DieTestingPeriod" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}StartAndEndDateTimeType" minOccurs="0"/&gt;
 *         &lt;element name="FirstFailSort" type="{http://www.w3.org/2001/XMLSchema}integer" minOccurs="0"/&gt;
 *         &lt;element name="GangTest" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.05}GangTestType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}IntCoordinate" minOccurs="0"/&gt;
...
public class DieReportType {
    ...
    @XmlElementRef(name = "IntCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = IntCoordinate.class, required = false)
