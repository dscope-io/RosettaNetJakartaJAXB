 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Die" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}DieType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="ECIDReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}ECIDReportType" minOccurs="0"/&gt;
 *         &lt;element name="YieldReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}YieldReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
