 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CalcFailReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}CalcFailReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DieReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}DieReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="FPReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}FPReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="FunctionalPinReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}FunctionalPinReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PPReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}PPReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PRReport" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}PRReportType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TestMap" type="{urn:rosettanet:specification:interchange:SemiconductorTestDataNotification:xsd:schema:01.01}TestMapType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
