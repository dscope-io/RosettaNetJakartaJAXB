 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}DemandCreatorTrackingIdentifier" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Invoice" type="{urn:rosettanet:specification:interchange:WinClaimConfirmation:xsd:schema:02.00}InvoiceType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class DesignRegistrationIdentificationType {
    ...
    @XmlElementRef(name = "DemandCreatorTrackingIdentifier", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = DemandCreatorTrackingIdentifier.class, required = false)
