 ...
 *       &lt;sequence&gt;
 *         &lt;element name="InvoiceLineItem" type="{urn:rosettanet:specification:interchange:WinClaimConfirmation:xsd:schema:02.00}InvoiceLineItemType" minOccurs="0"/&gt;
 *         &lt;element name="InvoiceNumber" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.08}BusinessDocumentReferenceType"/&gt;
 *       &lt;/sequence&gt;
