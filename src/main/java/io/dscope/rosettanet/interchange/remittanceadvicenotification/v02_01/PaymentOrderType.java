...
import io.dscope.rosettanet.domain.procurement.procurement.v02_19.AccountDescriptionType;
 ...
 *         &lt;element name="TotalRemittanceAmount" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.04}FinancialAmountType"/&gt;
 *         &lt;element name="TransferFrom" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}AccountDescriptionType" minOccurs="0"/&gt;
 *         &lt;element name="TransferTo" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}AccountDescriptionType"/&gt;
 *       &lt;/sequence&gt;
