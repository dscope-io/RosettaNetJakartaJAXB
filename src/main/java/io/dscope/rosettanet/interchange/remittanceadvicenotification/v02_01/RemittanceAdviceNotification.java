...
@XmlRootElement(name = "RemittanceAdviceNotification", namespace = "urn:rosettanet:specification:interchange:RemittanceAdviceNotification:xsd:schema:02.01")
public class RemittanceAdviceNotification
    extends JAXBElement<RemittanceAdviceNotificationType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:RemittanceAdviceNotification:xsd:schema:02.01", "RemittanceAdviceNotification");
