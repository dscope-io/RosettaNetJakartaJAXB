 ...
 *         &lt;element name="PaymentOrder" type="{urn:rosettanet:specification:interchange:RemittanceAdviceNotification:xsd:schema:02.04}PaymentOrderType"/&gt;
 *         &lt;element name="RemittanceLineItem" type="{urn:rosettanet:specification:interchange:RemittanceAdviceNotification:xsd:schema:02.04}RemittanceLineItemType" maxOccurs="unbounded"/&gt;
