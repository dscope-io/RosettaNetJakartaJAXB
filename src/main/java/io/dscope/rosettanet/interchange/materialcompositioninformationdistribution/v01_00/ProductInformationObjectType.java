 ...
 *         &lt;element name="DescriptionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PIOActionCode" type="{urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:1.0}ActionCodeType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}ReferenceLocator" minOccurs="0"/&gt;
...
public class ProductInformationObjectType {
    ...
    @XmlElementRef(name = "ReferenceLocator", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = ReferenceLocator.class, required = false)
