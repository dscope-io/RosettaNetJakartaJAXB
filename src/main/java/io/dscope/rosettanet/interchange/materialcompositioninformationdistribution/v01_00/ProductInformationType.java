 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;urss:Constraint xmlns:urss="urn:rosettanet:specification:system:xml:1.0" xmlns:drnct="urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:1.0" xmlns:dsgn="urn:rosettanet:specification:domain:Design:xsd:schema:1.0" xmlns:p250021_="http://annox.dev.java.net" xmlns:p712355_="http://java.sun.com/xml/ns/jaxb" xmlns:sdctr="urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:1.0" xmlns:tns="urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:1.0" xmlns:udcmn="urn:rosettanet:specification:universal:Document:xsd:schema:1.0" xmlns:updtn="urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0" xmlns:uptrn="urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;If the occurence of ProductInformation/isGeneric is between 1 and 1 then the value of ProductInformation/isGeneric MUST be 'true'.&lt;/urss:Constraint&gt;
 * </pre>
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;urss:Constraint xmlns:urss="urn:rosettanet:specification:system:xml:1.0" xmlns:drnct="urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:1.0" xmlns:dsgn="urn:rosettanet:specification:domain:Design:xsd:schema:1.0" xmlns:p250021_="http://annox.dev.java.net" xmlns:p712355_="http://java.sun.com/xml/ns/jaxb" xmlns:sdctr="urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:1.0" xmlns:tns="urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:1.0" xmlns:udcmn="urn:rosettanet:specification:universal:Document:xsd:schema:1.0" xmlns:updtn="urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0" xmlns:uptrn="urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;If the occurence of ProductInformation/KnownPartner is between 1 and 1 then the value of ProductInformation/KnownPartner/ProcessRoleIdentifier MUST be 'MFG'.&lt;/urss:Constraint&gt;
 * </pre>
 * 
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}DependentCondition" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DistributionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="IsGeneric" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0}KnownPartner" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}Material" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ProductActionCode" type="{urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:1.0}ActionCodeType" minOccurs="0"/&gt;
 *         &lt;element name="ProductIdentifier" type="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0}ProductDescriptionType"/&gt;
 *         &lt;element name="ProductInformationObject" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:1.0}ProductInformationObjectType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}ProductMass"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}Subpart" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:1.0}Substance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductInformationType {
    ...
    @XmlElementRef(name = "DependentCondition", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = DependentCondition.class, required = false)
    ...
    @XmlElementRef(name = "Material", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = Material.class, required = false)
    ...
    protected ProductDescriptionType productIdentifier;
    @XmlElement(name = "ProductInformationObject")
    protected List<ProductInformationObjectType> productInformationObject;
    @XmlElementRef(name = "ProductMass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = ProductMass.class)
    protected ProductMass productMass;
    @XmlElementRef(name = "Subpart", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = Subpart.class, required = false)
    protected List<Subpart> subpart;
    @XmlElementRef(name = "Substance", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:1.0", type = Substance.class, required = false)
     ...
     *     
     */
    public ProductDescriptionType getProductIdentifier() {
     ...
     *     
     */
    public void setProductIdentifier(ProductDescriptionType value) {
