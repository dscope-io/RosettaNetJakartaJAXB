...
import io.dscope.rosettanet.universal.contactinformation.v01_02.ContactInformationType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AgreementIdentifier" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.04}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="Authorizer" type="{urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.02}ContactInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Creator" type="{urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.02}ContactInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.11}DocumentHeader" minOccurs="0"/&gt;
 *         &lt;element name="ProductInformation" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:02.00}ProductInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="ProductInformationHeader" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:02.00}ProductInformationHeaderType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
