...
import io.dscope.rosettanet.domain.design.design.v02_17.ReferenceLocator;
 ...
 *         &lt;element name="DescriptionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.17}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.17}ReferenceLocator" minOccurs="0"/&gt;
...
public class ProductInformationObjectType {
    ...
    @XmlElementRef(name = "ReferenceLocator", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.17", type = ReferenceLocator.class, required = false)
