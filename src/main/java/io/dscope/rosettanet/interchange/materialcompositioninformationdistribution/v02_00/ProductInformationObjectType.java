...
import io.dscope.rosettanet.domain.design.design.v02_07.ReferenceLocator;
 ...
 *         &lt;element name="DescriptionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ReferenceLocator" minOccurs="0"/&gt;
...
public class ProductInformationObjectType {
    ...
    @XmlElementRef(name = "ReferenceLocator", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = ReferenceLocator.class, required = false)
