...
import io.dscope.rosettanet.domain.design.design.v01_00.ReferenceLocator;
 ...
 *         &lt;element name="DescriptionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:01.01}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PIOActionCode" type="{urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:01.01}ActionCodeType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:01.01}ReferenceLocator" minOccurs="0"/&gt;
...
public class ProductInformationObjectType {
    ...
    @XmlElement(name = "PIOActionCode")
    protected ActionCodeType pioActionCode;
    @XmlElementRef(name = "ReferenceLocator", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.01", type = ReferenceLocator.class, required = false)
    ...
    /**
     * Gets the value of the pioActionCode property.
     * 
     * @return
     *     possible object is
     *     {@link ActionCodeType }
     *     
     */
    public ActionCodeType getPIOActionCode() {
        return pioActionCode;
    }

    /**
     * Sets the value of the pioActionCode property.
     * 
     * @param value
     *     allowed object is
     *     {@link ActionCodeType }
     *     
     */
    public void setPIOActionCode(ActionCodeType value) {
        this.pioActionCode = value;
    }
