...
import io.dscope.rosettanet.domain.design.design.v02_07.Directive;
import io.dscope.rosettanet.domain.design.design.v02_07.ManufacturingProcessInfo;
import io.dscope.rosettanet.domain.design.design.v02_07.Material;
import io.dscope.rosettanet.domain.design.design.v02_07.ProductIdentifier;
import io.dscope.rosettanet.domain.design.design.v02_07.ProductIdentifierType;
import io.dscope.rosettanet.domain.design.design.v02_07.ProductMass;
import io.dscope.rosettanet.domain.design.design.v02_07.Subpart;
import io.dscope.rosettanet.domain.design.design.v02_07.Substance;
import io.dscope.rosettanet.universal.partneridentification.v01_08.KnownPartner;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AlternativeProductIdentifier" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ProductIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Condition" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:02.00}ConditionType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}Directive" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DistributionNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}NoteType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="IsGeneric" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}KnownPartner" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ManufacturingProcessInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}Material" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ProductIdentifier"/&gt;
 *         &lt;element name="ProductInformationObject" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:02.00}ProductInformationObjectType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ProductMass" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}Subpart" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}Substance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductInformationType {
    ...
    @XmlElementRef(name = "Directive", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = Directive.class, required = false)
    ...
    @XmlElementRef(name = "KnownPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08", type = KnownPartner.class, required = false)
    protected KnownPartner knownPartner;
    @XmlElementRef(name = "ManufacturingProcessInfo", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = ManufacturingProcessInfo.class, required = false)
    protected List<ManufacturingProcessInfo> manufacturingProcessInfo;
    @XmlElementRef(name = "Material", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = Material.class, required = false)
    protected List<Material> material;
    @XmlElementRef(name = "ProductIdentifier", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = ProductIdentifier.class)
    ...
    @XmlElementRef(name = "ProductMass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = ProductMass.class, required = false)
    protected ProductMass productMass;
    @XmlElementRef(name = "Subpart", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = Subpart.class, required = false)
    protected List<Subpart> subpart;
    @XmlElementRef(name = "Substance", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = Substance.class, required = false)
