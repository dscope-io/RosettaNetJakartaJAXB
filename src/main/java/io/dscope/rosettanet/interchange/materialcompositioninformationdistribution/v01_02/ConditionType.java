...
import io.dscope.rosettanet.domain.design.design.v01_05.ActualValue;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:01.05}ActualValue" maxOccurs="unbounded"/&gt;
...
public class ConditionType {
    ...
    @XmlElementRef(name = "ActualValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", type = ActualValue.class)
