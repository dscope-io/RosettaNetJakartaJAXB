 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.02}KnownPartner" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductInformationHeaderType {
    ...
    @XmlElementRef(name = "KnownPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.02", type = KnownPartner.class)
