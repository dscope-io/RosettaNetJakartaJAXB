...
import io.dscope.rosettanet.universal.partneridentification.v01_08.FullPartner;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}FullPartner" maxOccurs="unbounded"/&gt;
...
public class ProductInformationHeaderType {
    ...
    @XmlElementRef(name = "FullPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08", type = FullPartner.class)
