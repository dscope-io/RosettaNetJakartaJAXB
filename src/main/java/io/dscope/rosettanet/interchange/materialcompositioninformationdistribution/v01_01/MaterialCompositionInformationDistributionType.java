...
import io.dscope.rosettanet.universal.contactinformation.v01_00.ContactInformationType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AgreementIdentifier" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.01}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="Authorizer" type="{urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.01}ContactInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Creator" type="{urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.01}ContactInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.01}DocumentHeader" minOccurs="0"/&gt;
 *         &lt;element name="ProductInformation" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:11.01.00}ProductInformationType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="ProductInformationHeader" type="{urn:rosettanet:specification:interchange:MaterialCompositionInformationDistribution:xsd:schema:11.01.00}ProductInformationHeaderType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MaterialCompositionInformationDistributionType {
    ...
    protected List<ContactInformationType> authorizer;
    @XmlElement(name = "Creator")
    protected List<ContactInformationType> creator;
    @XmlElementRef(name = "DocumentHeader", namespace = "urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.01", type = DocumentHeader.class, required = false)
     ...
     * 
     */
    public List<ContactInformationType> getAuthorizer() {
        if (authorizer == null) {
            authorizer = new ArrayList<ContactInformationType>();
        }
     ...
     * 
     */
    public List<ContactInformationType> getCreator() {
        if (creator == null) {
            creator = new ArrayList<ContactInformationType>();
        }
        return this.creator;
    }
