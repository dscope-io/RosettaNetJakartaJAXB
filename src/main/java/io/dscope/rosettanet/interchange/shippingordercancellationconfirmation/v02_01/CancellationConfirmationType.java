 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;urss:Constraint xmlns:urss="urn:rosettanet:specification:system:xml:1.0" xmlns:dl="urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17" xmlns:doa="urn:rosettanet:specification:domain:Procurement:OrderAdmin:xsd:codelist:01.03" xmlns:dsocrt="urn:rosettanet:specification:domain:Logistics:ShippingOrderCancellationReasonType:xsd:codelist:01.03" xmlns:dsocs="urn:rosettanet:specification:domain:Logistics:ShippingOrderCancellationStatus:xsd:codelist:01.03" xmlns:p475355_="http://annox.dev.java.net" xmlns:p675322_="http://java.sun.com/xml/ns/jaxb" xmlns:ssdh="urn:rosettanet:specification:system:StandardDocumentHeader:xsd:schema:01.18" xmlns:st="http://www.ascc.net/xml/schematron" xmlns:tns="urn:rosettanet:specification:interchange:ShippingOrderCancellationConfirmation:xsd:schema:02.01" xmlns:udc="urn:rosettanet:specification:universal:Document:xsd:schema:01.08" xmlns:upi="urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;In CancellationConfirmation, if the value of ShippingOrderCancellationStatus is equal to 'REJ' then the occurence of ShippingOrderCancellationReasonType MUST be 1.&lt;/urss:Constraint&gt;
 * </pre>
 * 
 * 
