...
@XmlRootElement(name = "ShippingOrderCancellationConfirmation", namespace = "urn:rosettanet:specification:interchange:ShippingOrderCancellationConfirmation:xsd:schema:02.02")
public class ShippingOrderCancellationConfirmation
    extends JAXBElement<ShippingOrderCancellationConfirmationType>
{

    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:ShippingOrderCancellationConfirmation:xsd:schema:02.02", "ShippingOrderCancellationConfirmation");
