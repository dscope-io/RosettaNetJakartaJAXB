 ...
 *         &lt;element name="ServicedUnit" type="{urn:rosettanet:specification:interchange:WarrantyClaimRequest:xsd:schema:01.01}ServicedUnitType"/&gt;
 *         &lt;element name="ServiceEvent" type="{urn:rosettanet:specification:interchange:WarrantyClaimRequest:xsd:schema:01.01}ServiceEventType"/&gt;
