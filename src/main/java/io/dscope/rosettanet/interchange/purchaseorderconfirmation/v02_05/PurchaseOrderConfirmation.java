    ...
    extends JAXBElement<PurchaseOrderConfirmationType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:interchange:PurchaseOrderConfirmation:xsd:schema:02.05", "PurchaseOrderConfirmation");
