 ...
 *         &lt;element name="OrderLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmation:xsd:schema:02.01}OrderLineItemType" maxOccurs="unbounded"/&gt;
