...
import io.dscope.rosettanet.domain.procurement.procurement.v02_27.ShippedQuantityInformation;
 ...
 *         &lt;element name="ProductSubLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmationNotification:xsd:schema:01.00}ProductSubLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27}ShippedQuantityInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TaxSummary" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmationNotification:xsd:schema:01.00}TaxSummaryType" minOccurs="0"/&gt;
...
public class ProductLineItemType {
    ...
    @XmlElementRef(name = "ShippedQuantityInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27", type = ShippedQuantityInformation.class, required = false)
