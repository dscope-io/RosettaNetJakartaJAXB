 ...
 *       &lt;sequence&gt;
 *         &lt;choice&gt;
 *           &lt;element name="ProductLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmation:xsd:schema:02.01}ProductLineItemType"/&gt;
 *           &lt;element name="ServiceLineItem" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmation:xsd:schema:02.01}ServiceLineItemType"/&gt;
 *           &lt;element name="ServiceLineItemByOption" type="{urn:rosettanet:specification:interchange:PurchaseOrderConfirmation:xsd:schema:02.01}ServiceLineItemByOptionType"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
