 ...
 * generated in the io.dscope.rosettanet.universal.physicaldimension.v01_04 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.physicaldimension.v01_04
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04", name = "Linear")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04", name = "Measure")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04", name = "Volume")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.04", name = "Weight")
