 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Height" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}MeasureType" minOccurs="0"/&gt;
 *         &lt;element name="Length" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}MeasureType" minOccurs="0"/&gt;
 *         &lt;element name="Width" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}MeasureType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
