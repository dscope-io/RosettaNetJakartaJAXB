 ...
 * generated in the io.dscope.rosettanet.universal.datatype.v01_04 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.datatype.v01_04
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "Contact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "DUNS")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "DUNSPlus4")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "GLN")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "GTIN")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "Hexadecimal")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.04", name = "PercentAmount")
