...
/**
 * <p>Java class for MimeTypeQualifierContentType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>
 * &lt;simpleType name="MimeTypeQualifierContentType"&gt;
 ...
 * 
 */
@XmlType(name = "MimeTypeQualifierContentType")
@XmlEnum
public enum MimeTypeQualifierContentType {
    ...
    MimeTypeQualifierContentType(String v) {
        value = v;
    }
    ...
    public static MimeTypeQualifierContentType fromValue(String v) {
        for (MimeTypeQualifierContentType c: MimeTypeQualifierContentType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
