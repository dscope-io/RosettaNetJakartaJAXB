...
package io.dscope.rosettanet.universal.document.v01_10;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_21.ForecastIdentifierReferenceType;
import io.dscope.rosettanet.universal.codelist.documenttype.v01_11.DocumentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.11}DocumentType"/&gt;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.11", type = DocumentType.class)
