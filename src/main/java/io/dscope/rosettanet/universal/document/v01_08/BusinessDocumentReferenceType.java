...
import io.dscope.rosettanet.domain.procurement.procurement.v02_17.ForecastIdentifierReferenceType;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.09", type = DocumentType.class)
