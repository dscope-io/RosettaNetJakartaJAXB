...
package io.dscope.rosettanet.universal.document.v01_11;
...
import io.dscope.rosettanet.domain.procurement.procurement.v02_22.ForecastIdentifierReferenceType;
import io.dscope.rosettanet.universal.codelist.documenttype.v01_12.DocumentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.12}DocumentType"/&gt;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.12", type = DocumentType.class)
