...
import io.dscope.rosettanet.domain.procurement.procurement.v02_04.ForecastIdentifierReferenceType;
import io.dscope.rosettanet.universal.codelist.documenttype.v01_04.DocumentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.04}DocumentType"/&gt;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.04", type = DocumentType.class)
