...
import io.dscope.rosettanet.domain.procurement.procurement.v02_01.ForecastIdentifierReferenceType;
import io.dscope.rosettanet.universal.codelist.documenttype.v01_03.DocumentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.03}DocumentType"/&gt;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.03", type = DocumentType.class)
