...
import io.dscope.rosettanet.universal.codelist.documenttype.v01_07.DocumentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.07}DocumentType"/&gt;
...
public class BusinessDocumentReferenceType {
    ...
    @XmlElementRef(name = "DocumentType", namespace = "urn:rosettanet:specification:universal:DocumentType:xsd:codelist:01.07", type = DocumentType.class)
