 ...
 * generated in the io.dscope.rosettanet.universal.contactinformation.v01_04 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.contactinformation.v01_04
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.04", name = "ContactAndPhone")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ContactInformation:xsd:schema:01.04", name = "ContactInformation")
