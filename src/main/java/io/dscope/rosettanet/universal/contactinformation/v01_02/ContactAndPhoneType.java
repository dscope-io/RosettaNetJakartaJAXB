...
import io.dscope.rosettanet.universal.datatype.v01_03.Contact;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.03}Contact"/&gt;
...
public class ContactAndPhoneType {

    @XmlElementRef(name = "Contact", namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.03", type = Contact.class)
