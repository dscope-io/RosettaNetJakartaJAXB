 ...
 * generated in the io.dscope.rosettanet.universal.monetaryexpression.v01_01 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.monetaryexpression.v01_01
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01", name = "FinancialAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01", name = "ProductPricing")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01", name = "TaxAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01", name = "TaxJurisdiction")
