 ...
 * generated in the io.dscope.rosettanet.universal.monetaryexpression.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.monetaryexpression.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.02", name = "FinancialAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.02", name = "ProductPricing")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.02", name = "TaxAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.02", name = "TaxJurisdiction")
