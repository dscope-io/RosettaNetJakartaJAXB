 ...
 * generated in the io.dscope.rosettanet.universal.monetaryexpression.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.monetaryexpression.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0", name = "FinancialAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0", name = "ProductPricing")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0", name = "TaxAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0", name = "TaxJurisdiction")
