...
import io.dscope.rosettanet.universal.codelist.taxtype.v01_01.TaxType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:TaxType:xsd:codelist:01.01}TaxType"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxAmountType {
    ...
    @XmlElementRef(name = "TaxType", namespace = "urn:rosettanet:specification:universal:TaxType:xsd:codelist:01.01", type = TaxType.class)
