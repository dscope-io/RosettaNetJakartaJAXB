...
import io.dscope.rosettanet.universal.datatype.v01_02.GTIN;
 ...
 *           &lt;element ref="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}GTIN"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
    ...
    extends IdentifierType
{
    ...
    @XmlElementRef(name = "GTIN", namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.02", type = GTIN.class, required = false)
    protected GTIN gtin;
