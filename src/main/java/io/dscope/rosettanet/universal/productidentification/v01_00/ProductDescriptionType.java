 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0}TextualDescription" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductDescriptionType {
    ...
    @XmlElementRef(name = "TextualDescription", namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0", type = TextualDescription.class, required = false)
