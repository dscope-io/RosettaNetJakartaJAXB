 ...
 * generated in the io.dscope.rosettanet.universal.productidentification.v01_03 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.productidentification.v01_03
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", name = "NewProduct")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", name = "ProductDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", name = "ProductIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", name = "ProductSerialIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03", name = "TextualDescription")
