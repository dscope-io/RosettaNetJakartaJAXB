 ...
 * generated in the io.dscope.rosettanet.universal.dates.v01_01 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.dates.v01_01
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:01.01", name = "DatePeriod")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:01.01", name = "DateTimePeriod")
