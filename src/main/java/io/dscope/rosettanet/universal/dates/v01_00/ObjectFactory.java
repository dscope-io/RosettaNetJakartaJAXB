 ...
 * generated in the io.dscope.rosettanet.universal.dates.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.dates.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:1.0", name = "DatePeriod")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:1.0", name = "DateTimePeriod")
