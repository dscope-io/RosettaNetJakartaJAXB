 ...
 * generated in the io.dscope.rosettanet.universal.locations.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.locations.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Locations:xsd:schema:01.02", name = "AlternativeIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Locations:xsd:schema:01.02", name = "Location")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:Locations:xsd:schema:01.02", name = "PhysicalAddress")
