...
import io.dscope.rosettanet.universal.codelist.countrysubdivision.v01_01.CountrySubdivision;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:CountrySubdivision:xsd:codelist:01.01}CountrySubdivision" minOccurs="0"/&gt;
...
public class PhysicalAddressType {
    ...
    @XmlElementRef(name = "CountrySubdivision", namespace = "urn:rosettanet:specification:universal:CountrySubdivision:xsd:codelist:01.01", type = CountrySubdivision.class, required = false)
