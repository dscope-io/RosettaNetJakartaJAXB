 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08}PartnerIdentification" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class SpecifiedFullPartnerType {
    ...
    @XmlElementRef(name = "PartnerIdentification", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.08", type = PartnerIdentification.class, required = false)
