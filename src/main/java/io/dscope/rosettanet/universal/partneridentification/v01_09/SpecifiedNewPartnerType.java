 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.09}PartnerIdentification" maxOccurs="unbounded"/&gt;
...
public class SpecifiedNewPartnerType {
    ...
    @XmlElementRef(name = "PartnerIdentification", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.09", type = PartnerIdentification.class)
