 ...
 * generated in the io.dscope.rosettanet.universal.partneridentification.v01_05 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.partneridentification.v01_05
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "FullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "IntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "KnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "KnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "NewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "PartnerDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "PartnerIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedFullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedIntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedKnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedKnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedNewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.05", name = "SpecifiedPartnerDescription")
