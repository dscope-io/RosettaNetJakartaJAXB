 ...
 * generated in the io.dscope.rosettanet.universal.partneridentification.v01_14 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.partneridentification.v01_14
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "FullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "IntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "KnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "KnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "NewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "PartnerDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "PartnerIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedFullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedIntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedKnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedKnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedNewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.14", name = "SpecifiedPartnerDescription")
