 ...
 * generated in the io.dscope.rosettanet.universal.partneridentification.v01_06 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.partneridentification.v01_06
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "FullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "IntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "KnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "KnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "NewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "PartnerDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "PartnerIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedFullPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedIntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedKnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedKnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedNewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", name = "SpecifiedPartnerDescription")
