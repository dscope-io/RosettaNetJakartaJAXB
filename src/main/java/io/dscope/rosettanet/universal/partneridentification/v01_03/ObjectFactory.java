 ...
 * generated in the io.dscope.rosettanet.universal.partneridentification.v01_03 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.universal.partneridentification.v01_03
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "IntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "KnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "KnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "NewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "PartnerDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "PartnerIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "SpecifiedIntermittentPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "SpecifiedKnownPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "SpecifiedKnownPartnerContact")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "SpecifiedNewPartner")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", name = "SpecifiedPartnerDescription")
