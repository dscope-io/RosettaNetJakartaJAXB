...
import io.dscope.rosettanet.universal.datatype.v01_02.DUNS;
import io.dscope.rosettanet.universal.datatype.v01_02.DUNSPlus4;
import io.dscope.rosettanet.universal.datatype.v01_02.GLN;
 ...
 *           &lt;element ref="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}DUNS"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}DUNSPlus4"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}GLN"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
    ...
    extends IdentifierType
{
    ...
    @XmlElementRef(name = "DUNS", namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.02", type = DUNS.class, required = false)
    protected DUNS duns;
    @XmlElementRef(name = "DUNSPlus4", namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.02", type = DUNSPlus4 .class, required = false)
    protected DUNSPlus4 dunsPlus4;
    @XmlElementRef(name = "GLN", namespace = "urn:rosettanet:specification:universal:DataType:xsd:schema:01.02", type = GLN.class, required = false)
    protected GLN gln;
