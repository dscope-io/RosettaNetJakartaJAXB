    ...
    extends JAXBElement<SpecifiedIntermittentPartnerType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.12", "SpecifiedIntermittentPartner");
