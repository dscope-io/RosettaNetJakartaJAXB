 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.07}KnownPartner"/&gt;
 *       &lt;/sequence&gt;
...
public class KnownPartnerContactType {
    ...
    @XmlElementRef(name = "KnownPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.07", type = KnownPartner.class)
