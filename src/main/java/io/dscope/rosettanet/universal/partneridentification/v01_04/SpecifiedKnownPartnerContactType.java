 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04}SpecifiedKnownPartner"/&gt;
 *       &lt;/sequence&gt;
...
public class SpecifiedKnownPartnerContactType {
    ...
    @XmlElementRef(name = "SpecifiedKnownPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.04", type = SpecifiedKnownPartner.class)
