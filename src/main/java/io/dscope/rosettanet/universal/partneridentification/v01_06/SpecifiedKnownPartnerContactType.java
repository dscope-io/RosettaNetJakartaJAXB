 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06}SpecifiedKnownPartner"/&gt;
 *       &lt;/sequence&gt;
...
public class SpecifiedKnownPartnerContactType {
    ...
    @XmlElementRef(name = "SpecifiedKnownPartner", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.06", type = SpecifiedKnownPartner.class)
