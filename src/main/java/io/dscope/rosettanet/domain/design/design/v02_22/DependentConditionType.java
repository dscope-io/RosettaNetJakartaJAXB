 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.22}ActualValue" maxOccurs="unbounded"/&gt;
...
public class DependentConditionType {
    ...
    @XmlElementRef(name = "ActualValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.22", type = ActualValue.class)
