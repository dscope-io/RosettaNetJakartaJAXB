 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.15}MaterialMass" minOccurs="0"/&gt;
...
public class MaterialType {
    ...
    @XmlElementRef(name = "MaterialMass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", type = MaterialMass.class, required = false)
