 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.05}Mass" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.05}MassPercentage" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductMassType {
    ...
    @XmlElementRef(name = "Mass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.05", type = Mass.class)
    protected List<Mass> mass;
    @XmlElementRef(name = "MassPercentage", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.05", type = MassPercentage.class, required = false)
