...
import io.dscope.rosettanet.domain.design.codelist.productlifecyclestatuscode.v01_00.ProductLifeCycleStatusCode;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:ProductLifeCycleStatusCode:xsd:codelist:01.01}ProductLifeCycleStatusCode"/&gt;
 *       &lt;/sequence&gt;
...
public class LifeCycleStatusType {
    ...
    @XmlElementRef(name = "ProductLifeCycleStatusCode", namespace = "urn:rosettanet:specification:domain:Design:ProductLifeCycleStatusCode:xsd:codelist:01.01", type = ProductLifeCycleStatusCode.class)
