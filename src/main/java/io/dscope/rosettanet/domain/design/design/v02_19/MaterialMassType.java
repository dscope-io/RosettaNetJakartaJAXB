 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.19}Mass" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class MaterialMassType {
    ...
    @XmlElementRef(name = "Mass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.19", type = Mass.class, required = false)
