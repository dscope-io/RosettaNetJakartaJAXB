 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.19}ActualValue" maxOccurs="unbounded"/&gt;
...
public class DependentConditionType {
    ...
    @XmlElementRef(name = "ActualValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.19", type = ActualValue.class)
