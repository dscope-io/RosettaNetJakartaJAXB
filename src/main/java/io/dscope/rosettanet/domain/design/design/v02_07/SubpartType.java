 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}DependentCondition" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}SubpartIdentifier"/&gt;
...
public class SubpartType {
    ...
    @XmlElementRef(name = "DependentCondition", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = DependentCondition.class, required = false)
    ...
    @XmlElementRef(name = "SubpartIdentifier", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = SubpartIdentifier.class)
