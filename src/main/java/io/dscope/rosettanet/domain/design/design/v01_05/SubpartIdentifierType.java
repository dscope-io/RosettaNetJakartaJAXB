...
import io.dscope.rosettanet.universal.productidentification.v01_02.TextualDescription;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02}ProductIdentification" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02}TextualDescription" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SubpartIdentifierType {
    ...
    @XmlElementRef(name = "TextualDescription", namespace = "urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02", type = TextualDescription.class, required = false)
