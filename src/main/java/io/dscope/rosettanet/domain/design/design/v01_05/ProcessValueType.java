 ...
 *       &lt;sequence&gt;
 *         &lt;choice&gt;
 *           &lt;element name="Measurement" type="{urn:rosettanet:specification:domain:Design:xsd:schema:01.05}ActualValueType"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:01.05}Text"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class ProcessValueType {
    ...
    @XmlElementRef(name = "Text", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", type = Text.class, required = false)
    protected Text text;
