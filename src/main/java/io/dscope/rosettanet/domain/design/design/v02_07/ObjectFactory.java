 ...
 * generated in the io.dscope.rosettanet.domain.design.design.v02_07 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.design.design.v02_07
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ActualValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Attachment")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "CAS")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "DependentCondition")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Directive")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "LifeCycleStatus")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ManufacturingProcessInfo")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Mass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "MassPercentage")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Material")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "MaterialMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Note")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ProcessValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ProductIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ProductMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Radioactivity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "ReferenceLocator")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Subpart")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "SubpartIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Substance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "SubstanceIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "SubstanceMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Text")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Threshold")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Tolerance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "url")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", name = "Value")
