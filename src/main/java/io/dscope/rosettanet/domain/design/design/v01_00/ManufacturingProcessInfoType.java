 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:01.01}ProcessValue"/&gt;
 *       &lt;/sequence&gt;
...
public class ManufacturingProcessInfoType {
    ...
    @XmlElementRef(name = "ProcessValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.01", type = ProcessValue.class)
