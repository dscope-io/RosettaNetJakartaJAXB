 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:01.05}SubpartIdentifier"/&gt;
...
public class SubpartType {
    ...
    @XmlElementRef(name = "SubpartIdentifier", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", type = SubpartIdentifier.class)
