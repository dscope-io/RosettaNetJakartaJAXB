 ...
 * generated in the io.dscope.rosettanet.domain.design.design.v02_15 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.design.design.v02_15
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ActualValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Attachment")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "CAS")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ChangeDescription")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "DateReference")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "DependentCondition")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Directive")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "EngineeringInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "LifeCycleStatus")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ManufacturingProcessInfo")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Mass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "MassPercentage")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Material")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "MaterialMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Note")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ProcessValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ProductIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ProductMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "QualData")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Radioactivity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "ReferenceLocator")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Subpart")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "SubpartIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Substance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "SubstanceIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "SubstanceMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Text")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Threshold")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Tolerance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "url")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", name = "Value")
