 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.17}SubpartIdentifier"/&gt;
...
public class SubpartType {
    ...
    @XmlElementRef(name = "SubpartIdentifier", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.17", type = SubpartIdentifier.class)
