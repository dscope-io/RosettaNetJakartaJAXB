 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.05}ProcessValue"/&gt;
 *       &lt;/sequence&gt;
...
public class ManufacturingProcessInfoType {
    ...
    @XmlElementRef(name = "ProcessValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.05", type = ProcessValue.class)
