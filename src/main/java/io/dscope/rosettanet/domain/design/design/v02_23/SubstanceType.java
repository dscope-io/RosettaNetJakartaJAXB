 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}Radioactivity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}SubstanceIdentification"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}SubstanceMass" minOccurs="0"/&gt;
 *         &lt;element name="SubstanceNote" type="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}NoteType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}Threshold" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SubstanceType {
    ...
    @XmlElementRef(name = "Radioactivity", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = Radioactivity.class, required = false)
    protected List<Radioactivity> radioactivity;
    @XmlElementRef(name = "SubstanceIdentification", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = SubstanceIdentification.class)
    protected SubstanceIdentification substanceIdentification;
    @XmlElementRef(name = "SubstanceMass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = SubstanceMass.class, required = false)
    protected SubstanceMass substanceMass;
    @XmlElement(name = "SubstanceNote")
    protected String substanceNote;
    @XmlElementRef(name = "Threshold", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = Threshold.class, required = false)
