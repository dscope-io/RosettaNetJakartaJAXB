...
import io.dscope.rosettanet.domain.design.codelist.compliant.v01_01.Compliant;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:Compliant:xsd:codelist:01.01}Compliant"/&gt;
...
public class DirectiveType {
    ...
    @XmlElementRef(name = "Compliant", namespace = "urn:rosettanet:specification:domain:Design:Compliant:xsd:codelist:01.01", type = Compliant.class)
