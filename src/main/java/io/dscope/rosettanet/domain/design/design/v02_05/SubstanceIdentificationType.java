 ...
 *           &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.05}CAS"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class SubstanceIdentificationType {
    ...
    @XmlElementRef(name = "CAS", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.05", type = CAS.class, required = false)
    protected CAS cas;
