 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}Attachment"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.23}url" maxOccurs="unbounded"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class ReferenceLocatorType {
    ...
    @XmlElementRef(name = "Attachment", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = Attachment.class, required = false)
    protected Attachment attachment;
    @XmlElementRef(name = "url", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.23", type = Url.class, required = false)
