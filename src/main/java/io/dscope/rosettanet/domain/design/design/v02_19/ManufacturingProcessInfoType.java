 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.19}ProcessValue"/&gt;
 *       &lt;/sequence&gt;
...
public class ManufacturingProcessInfoType {
    ...
    @XmlElementRef(name = "ProcessValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.19", type = ProcessValue.class)
