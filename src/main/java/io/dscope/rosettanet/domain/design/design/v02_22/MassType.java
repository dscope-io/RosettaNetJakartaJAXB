 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.22}Value"/&gt;
 *       &lt;/sequence&gt;
...
public class MassType {
    ...
    @XmlElementRef(name = "Value", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.22", type = Value.class)
