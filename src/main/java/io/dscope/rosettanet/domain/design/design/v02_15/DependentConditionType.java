 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:01.03}ActionCode" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.15}ActualValue" maxOccurs="unbounded"/&gt;
...
public class DependentConditionType {

    @XmlElementRef(name = "ActionCode", namespace = "urn:rosettanet:specification:domain:Design:ActionCode:xsd:codelist:01.03", type = ActionCode.class, required = false)
    protected ActionCode actionCode;
    @XmlElementRef(name = "ActualValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.15", type = ActualValue.class)
