 ...
 * generated in the io.dscope.rosettanet.domain.design.design.v01_05 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.design.design.v01_05
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "ActualValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Attachment")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "CAS")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "DependentCondition")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Directive")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "LifeCycleStatus")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "ManufacturingProcessInfo")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Mass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "MassPercentage")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Material")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "MaterialMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Note")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "ProcessValue")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "ProductMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Radioactivity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "ReferenceLocator")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Subpart")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "SubpartIdentifier")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Substance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "SubstanceIdentification")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "SubstanceMass")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Text")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Threshold")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Tolerance")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "url")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:01.05", name = "Value")
