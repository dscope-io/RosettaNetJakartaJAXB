 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.07}ActualValue" maxOccurs="unbounded"/&gt;
...
public class DependentConditionType {
    ...
    @XmlElementRef(name = "ActualValue", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.07", type = ActualValue.class)
