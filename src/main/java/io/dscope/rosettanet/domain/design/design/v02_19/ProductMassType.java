 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.19}Mass" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Design:xsd:schema:02.19}MassPercentage" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductMassType {
    ...
    @XmlElementRef(name = "Mass", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.19", type = Mass.class)
    protected List<Mass> mass;
    @XmlElementRef(name = "MassPercentage", namespace = "urn:rosettanet:specification:domain:Design:xsd:schema:02.19", type = MassPercentage.class, required = false)
