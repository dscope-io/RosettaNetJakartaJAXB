 ...
 *           &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22}UNSPSC"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
    ...
    extends IdentifierType
{
    ...
    @XmlElementRef(name = "UNSPSC", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22", type = UNSPSC.class, required = false)
