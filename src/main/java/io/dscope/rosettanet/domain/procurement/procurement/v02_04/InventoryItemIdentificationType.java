...
import io.dscope.rosettanet.domain.shared.shared.v01_03.ManufacturedDate;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.03}ManufacturedDate" minOccurs="0"/&gt;
...
public class InventoryItemIdentificationType {
    ...
    @XmlElementRef(name = "ManufacturedDate", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.03", type = ManufacturedDate.class, required = false)
