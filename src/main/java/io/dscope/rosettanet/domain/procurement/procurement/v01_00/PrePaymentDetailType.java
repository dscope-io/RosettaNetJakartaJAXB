...
/**
 * <p>Java class for PrePaymentDetailType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PrePaymentDetailType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Date" type="{http://www.w3.org/2001/XMLSchema}date" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}FinancialAmount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "PrePaymentDetailType", propOrder = {
    "date",
    "financialAmount"
})
public class PrePaymentDetailType {

    @XmlElement(name = "Date")
    @XmlSchemaType(name = "date")
    protected List<XMLGregorianCalendar> date;
    @XmlElementRef(name = "FinancialAmount", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = FinancialAmount.class, required = false)
