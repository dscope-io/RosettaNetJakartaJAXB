 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.salesreportdiscrepancycode.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.salesreportdiscrepancycode.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:1.0", name = "SalesReportDiscrepancyCodeA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:1.0", name = "SalesReportDiscrepancyCode", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:1.0", substitutionHeadName = "SalesReportDiscrepancyCodeA")
