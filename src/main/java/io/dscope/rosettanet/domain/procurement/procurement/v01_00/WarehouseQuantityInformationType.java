 ...
 *       &lt;sequence&gt;
 *         &lt;element name="WarehouseAvailabilityDate" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:1.0}DatePeriodType" minOccurs="0"/&gt;
 *         &lt;element name="WarehouseQuantity" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}ProductQuantityType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
