 ...
 *         &lt;element name="OrderSizeRounding" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.13}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="PreviousUnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}PriceListType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}ProductQuantityRange"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}PriceListType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
