...
import io.dscope.rosettanet.domain.procurement.codelist.bookpricequalifier.v01_02.BookPriceQualifier;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:01.02}BookPriceQualifier"/&gt;
...
public class BookPriceType {
    ...
    @XmlElementRef(name = "BookPriceQualifier", namespace = "urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:01.02", type = BookPriceQualifier.class)
