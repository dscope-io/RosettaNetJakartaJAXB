 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27}TaxExemption" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxExemptStatusType {
    ...
    @XmlElementRef(name = "TaxExemption", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27", type = TaxExemption.class, required = false)
