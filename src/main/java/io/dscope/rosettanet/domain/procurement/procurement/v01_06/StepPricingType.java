...
import io.dscope.rosettanet.domain.procurement.codelist.pricingtypecode.v01_02.PricingTypeCode;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}MonetaryAmount"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PricingTypeCode:xsd:codelist:01.02}PricingTypeCode" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}ProductQuantityRange"/&gt;
 *       &lt;/sequence&gt;
...
public class StepPricingType {
    ...
    @XmlElementRef(name = "MonetaryAmount", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06", type = MonetaryAmount.class)
    protected MonetaryAmount monetaryAmount;
    @XmlElementRef(name = "PricingTypeCode", namespace = "urn:rosettanet:specification:domain:Procurement:PricingTypeCode:xsd:codelist:01.02", type = PricingTypeCode.class, required = false)
    protected PricingTypeCode pricingTypeCode;
    @XmlElementRef(name = "ProductQuantityRange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06", type = ProductQuantityRange.class)
