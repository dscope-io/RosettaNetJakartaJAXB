 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Day" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}DayOfMonthType" minOccurs="0"/&gt;
 *         &lt;element name="Days" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}DayOfMonthType" minOccurs="0"/&gt;
