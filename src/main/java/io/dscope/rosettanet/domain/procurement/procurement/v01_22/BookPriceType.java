...
import io.dscope.rosettanet.domain.procurement.codelist.bookpricequalifier.v01_03.BookPriceQualifier;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:01.03}BookPriceQualifier"/&gt;
...
public class BookPriceType {
    ...
    @XmlElementRef(name = "BookPriceQualifier", namespace = "urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:01.03", type = BookPriceQualifier.class)
