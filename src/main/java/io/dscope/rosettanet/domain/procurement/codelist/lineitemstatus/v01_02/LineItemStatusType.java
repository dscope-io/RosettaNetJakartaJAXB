 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Procurement:LineItemStatus:xsd:codelist:01.02&gt;LineItemStatusContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="LineItemStatus" /&gt;
...
public class LineItemStatusType {
    ...
    @XmlValue
    protected LineItemStatusContentType value;
     ...
     * @return
     *     possible object is
     *     {@link LineItemStatusContentType }
     *     
     */
    public LineItemStatusContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(LineItemStatusContentType value) {
        this.value = value;
    }
