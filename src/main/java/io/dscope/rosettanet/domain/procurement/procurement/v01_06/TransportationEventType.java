...
import io.dscope.rosettanet.domain.procurement.codelist.transportevent.v01_02.TransportEvent;
import io.dscope.rosettanet.universal.dates.v01_01.DateTimePeriod;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.01}DateTimePeriod" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02}TransportEvent"/&gt;
 *       &lt;/sequence&gt;
...
public class TransportationEventType {
    ...
    @XmlElementRef(name = "DateTimePeriod", namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:01.01", type = DateTimePeriod.class, required = false)
    protected DateTimePeriod dateTimePeriod;
    @XmlElementRef(name = "TransportEvent", namespace = "urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02", type = TransportEvent.class)
