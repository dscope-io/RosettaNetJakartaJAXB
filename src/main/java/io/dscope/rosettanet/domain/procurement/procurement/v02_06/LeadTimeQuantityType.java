 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OrderSizeRoundingQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}ProductQuantityRange"/&gt;
 *       &lt;/sequence&gt;
...
public class LeadTimeQuantityType {
    ...
    @XmlElementRef(name = "ProductQuantityRange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = ProductQuantityRange.class)
