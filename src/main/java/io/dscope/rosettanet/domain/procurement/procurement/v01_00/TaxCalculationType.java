 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0}TaxAmount" maxOccurs="unbounded"/&gt;
 *         &lt;element name="TotalAmount" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}MonetaryAmountType"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxCalculationType {
    ...
    @XmlElementRef(name = "TaxAmount", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0", type = TaxAmount.class)
