 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.salesreportdiscrepancycode.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.salesreportdiscrepancycode.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:01.02", name = "SalesReportDiscrepancyCodeA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:01.02", name = "SalesReportDiscrepancyCode", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:SalesReportDiscrepancyCode:xsd:codelist:01.02", substitutionHeadName = "SalesReportDiscrepancyCodeA")
