...
import io.dscope.rosettanet.domain.logistics.logistics.v01_07.CarrierInformation;
import io.dscope.rosettanet.domain.procurement.codelist.freeonboard.v01_02.FreeOnBoard;
import io.dscope.rosettanet.domain.procurement.codelist.shipmentterms.v01_02.ShipmentTerms;
import io.dscope.rosettanet.domain.procurement.codelist.shippingservicelevel.v01_02.ShippingServiceLevel;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.07}CarrierInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:01.02}FreeOnBoard" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ShippingServiceLevel:xsd:codelist:01.02}ShippingServiceLevel" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "CarrierInformation", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.07", type = CarrierInformation.class, required = false)
    protected CarrierInformation carrierInformation;
    @XmlElementRef(name = "FreeOnBoard", namespace = "urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:01.02", type = FreeOnBoard.class, required = false)
    ...
    @XmlElementRef(name = "ShippingServiceLevel", namespace = "urn:rosettanet:specification:domain:Procurement:ShippingServiceLevel:xsd:codelist:01.02", type = ShippingServiceLevel.class, required = false)
