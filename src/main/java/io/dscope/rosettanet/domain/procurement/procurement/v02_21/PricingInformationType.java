...
import io.dscope.rosettanet.domain.shared.shared.v01_14.ProductPricing;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.14}ProductPricing" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingInformationType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.14", type = ProductPricing.class)
