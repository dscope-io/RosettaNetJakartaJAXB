...
import io.dscope.rosettanet.domain.procurement.codelist.productsubstitutionreason.v01_00.ProductSubstitutionReason;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0}ProductIdentification" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ProductSubstitutionReason:xsd:codelist:1.0}ProductSubstitutionReason"/&gt;
 *       &lt;/sequence&gt;
...
public class SubstituteProductReferenceType {
    ...
    @XmlElementRef(name = "ProductSubstitutionReason", namespace = "urn:rosettanet:specification:domain:Procurement:ProductSubstitutionReason:xsd:codelist:1.0", type = ProductSubstitutionReason.class)
