...
import io.dscope.rosettanet.domain.shared.codelist.interval.v01_00.Interval;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:Interval:xsd:codelist:01.00}Interval"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}IsCallFactory" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}LeadTimeQuantity" minOccurs="0"/&gt;
...
public class ProductLeadTimeType {
    ...
    @XmlElementRef(name = "Interval", namespace = "urn:rosettanet:specification:domain:Shared:Interval:xsd:codelist:01.00", type = Interval.class)
    protected Interval interval;
    @XmlElementRef(name = "IsCallFactory", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = IsCallFactory.class, required = false)
    ...
    @XmlElementRef(name = "LeadTimeQuantity", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = LeadTimeQuantity.class, required = false)
