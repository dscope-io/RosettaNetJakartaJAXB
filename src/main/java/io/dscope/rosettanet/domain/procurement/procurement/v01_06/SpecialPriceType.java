 ...
 *       &lt;sequence&gt;
 *         &lt;element name="EligiblePeriod" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}DatePeriodAndDurationType" minOccurs="0"/&gt;
 *         &lt;element name="EligibleUnits" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}ProductQuantityType" minOccurs="0"/&gt;
