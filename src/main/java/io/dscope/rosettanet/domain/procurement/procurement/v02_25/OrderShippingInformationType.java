 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.25}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "SpecialHandlingInstruction", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.25", type = SpecialHandlingInstruction.class, required = false)
