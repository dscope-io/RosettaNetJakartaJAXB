...
import io.dscope.rosettanet.domain.procurement.codelist.paymentmethod.v01_00.PaymentMethod;
import io.dscope.rosettanet.domain.procurement.codelist.purchasemethod.v01_00.PurchaseMethod;
import io.dscope.rosettanet.domain.procurement.codelist.transactiontype.v01_00.TransactionType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}BookPrice" minOccurs="0"/&gt;
 *         &lt;element name="LeaseDescription" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PaymentMethod:xsd:codelist:1.0}PaymentMethod" minOccurs="0"/&gt;
 *         &lt;element name="PriceListIdentifier" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PurchaseMethod:xsd:codelist:1.0}PurchaseMethod" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}SalesOut"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:1.0}TransactionType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SalesOutAndTransactionType {
    ...
    @XmlElementRef(name = "BookPrice", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = BookPrice.class, required = false)
    protected BookPrice bookPrice;
    @XmlElement(name = "LeaseDescription")
    protected String leaseDescription;
    @XmlElementRef(name = "PaymentMethod", namespace = "urn:rosettanet:specification:domain:Procurement:PaymentMethod:xsd:codelist:1.0", type = PaymentMethod.class, required = false)
    protected PaymentMethod paymentMethod;
    @XmlElement(name = "PriceListIdentifier")
    protected String priceListIdentifier;
    @XmlElementRef(name = "PurchaseMethod", namespace = "urn:rosettanet:specification:domain:Procurement:PurchaseMethod:xsd:codelist:1.0", type = PurchaseMethod.class, required = false)
    protected PurchaseMethod purchaseMethod;
    @XmlElement(name = "ResaleUnitPrice")
    protected FinancialAmountType resaleUnitPrice;
    @XmlElementRef(name = "SalesOut", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = SalesOut.class)
    protected SalesOut salesOut;
    @XmlElementRef(name = "TransactionType", namespace = "urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:1.0", type = TransactionType.class, required = false)
