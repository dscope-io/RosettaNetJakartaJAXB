 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}IsCallFactory" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06}LeadTimeQuantity" minOccurs="0"/&gt;
...
public class ProductLeadTimeType {
    ...
    @XmlElementRef(name = "IsCallFactory", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = IsCallFactory.class, required = false)
    ...
    @XmlElementRef(name = "LeadTimeQuantity", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.06", type = LeadTimeQuantity.class, required = false)
