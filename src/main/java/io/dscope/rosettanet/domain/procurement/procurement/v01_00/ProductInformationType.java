 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}LotIdentification" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:1.0}ProductIdentification"/&gt;
 *         &lt;element name="ProvisionPeriod" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}DatePeriodAndDurationType" minOccurs="0"/&gt;
...
public class ProductInformationType {
    ...
    @XmlElementRef(name = "LotIdentification", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = LotIdentification.class, required = false)
