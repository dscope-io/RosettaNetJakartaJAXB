...
import io.dscope.rosettanet.domain.shared.shared.v01_13.ProductPricing;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.13}ProductPricing" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingInformationType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", type = ProductPricing.class)
