...
import io.dscope.rosettanet.domain.procurement.codelist.paymenttype.v01_02.PaymentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PaymentType:xsd:codelist:01.02}PaymentType"/&gt;
 *       &lt;/sequence&gt;
...
public class PaymentInformationType {
    ...
    @XmlElementRef(name = "PaymentType", namespace = "urn:rosettanet:specification:domain:Procurement:PaymentType:xsd:codelist:01.02", type = PaymentType.class)
