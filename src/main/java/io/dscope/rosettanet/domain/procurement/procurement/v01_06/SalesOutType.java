...
import io.dscope.rosettanet.domain.procurement.codelist.saletype.v01_02.SaleType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:SaleType:xsd:codelist:01.02}SaleType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SalesOutType {
    ...
    @XmlElementRef(name = "SaleType", namespace = "urn:rosettanet:specification:domain:Procurement:SaleType:xsd:codelist:01.02", type = SaleType.class, required = false)
