 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}ForecastPeriod"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}ProductQuantity"/&gt;
 *         &lt;element name="ScheduleProductForecastIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}ForecastIdentifierReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ForecastProductScheduleType {
    ...
    @XmlElementRef(name = "ForecastPeriod", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30", type = ForecastPeriod.class)
