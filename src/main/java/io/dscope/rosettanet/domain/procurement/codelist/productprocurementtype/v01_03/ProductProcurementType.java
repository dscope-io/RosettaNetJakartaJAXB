    ...
    extends JAXBElement<ProductProcurementTypeType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Procurement:ProductProcurementType:xsd:codelist:01.03", "ProductProcurementType");
