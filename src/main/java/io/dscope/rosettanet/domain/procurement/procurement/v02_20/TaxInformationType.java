...
import io.dscope.rosettanet.universal.monetaryexpression.v01_05.TaxJurisdiction;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.13}MonetaryAmount"/&gt;
 *         &lt;element name="Rate" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.04}PercentAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05}TaxJurisdiction" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxInformationType {
    ...
    @XmlElementRef(name = "MonetaryAmount", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", type = MonetaryAmount.class)
    protected MonetaryAmount monetaryAmount;
    @XmlElement(name = "Rate")
    protected BigDecimal rate;
    @XmlElementRef(name = "TaxJurisdiction", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05", type = TaxJurisdiction.class, required = false)
