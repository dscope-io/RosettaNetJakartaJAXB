 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.specialfulfillmentrequest.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.specialfulfillmentrequest.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:1.0", name = "SpecialFulfillmentRequestA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:1.0", name = "SpecialFulfillmentRequest", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:1.0", substitutionHeadName = "SpecialFulfillmentRequestA")
