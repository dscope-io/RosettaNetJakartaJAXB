 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ContractIdentifier" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="GeneralServiceAdministrationNumber" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element name="SpecialPriceCondition" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="SpecialPricingDatePeriod" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.02}DatePeriodType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
