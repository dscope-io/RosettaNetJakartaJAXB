 ...
 *         &lt;element name="SafetyStockQuantity" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}ProductQuantityRangeType" minOccurs="0"/&gt;
 *         &lt;element name="ShippingAvailability" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:1.0}DatePeriodType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
