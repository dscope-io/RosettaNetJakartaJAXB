 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PricingTypeCode:xsd:codelist:01.02}PricingTypeCode"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductPricingType {
    ...
    @XmlElementRef(name = "PricingTypeCode", namespace = "urn:rosettanet:specification:domain:Procurement:PricingTypeCode:xsd:codelist:01.02", type = PricingTypeCode.class)
