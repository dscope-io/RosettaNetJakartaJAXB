...
import io.dscope.rosettanet.domain.shared.shared.v01_13.MonetaryAmount;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CityTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}CurrencyConversion" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.13}MonetaryAmount" minOccurs="0"/&gt;
 *         &lt;element name="NationalTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}OtherTaxes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RegionalTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20}TaxPhrase" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxSummaryType {
    ...
    @XmlElementRef(name = "CurrencyConversion", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20", type = CurrencyConversion.class, required = false)
    protected CurrencyConversion currencyConversion;
    @XmlElementRef(name = "MonetaryAmount", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", type = MonetaryAmount.class, required = false)
    protected MonetaryAmount monetaryAmount;
    @XmlElement(name = "NationalTax")
    protected List<TaxInformationType> nationalTax;
    @XmlElementRef(name = "OtherTaxes", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20", type = OtherTaxes.class, required = false)
    protected List<OtherTaxes> otherTaxes;
    @XmlElement(name = "RegionalTax")
    protected List<TaxInformationType> regionalTax;
    @XmlElementRef(name = "TaxPhrase", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.20", type = TaxPhrase.class, required = false)
