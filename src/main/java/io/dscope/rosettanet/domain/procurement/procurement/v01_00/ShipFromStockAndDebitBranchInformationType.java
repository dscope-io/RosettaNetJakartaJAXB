 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DistributedBy" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0}SpecifiedPartnerDescriptionType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}ShipFromStockAndDebitCustomerInformation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ShipFromStockAndDebitBranchInformationType {
    ...
    @XmlElementRef(name = "ShipFromStockAndDebitCustomerInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = ShipFromStockAndDebitCustomerInformation.class, required = false)
