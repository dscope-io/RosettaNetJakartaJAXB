 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}ProductFamilyReporting"/&gt;
 *         &lt;element name="ProductForecastIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}ForecastIdentifierReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}ProductReceiptReference" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductForecastType {
    ...
    @XmlElementRef(name = "ProductFamilyReporting", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = ProductFamilyReporting.class)
    ...
    @XmlElementRef(name = "ProductReceiptReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = ProductReceiptReference.class, required = false)
