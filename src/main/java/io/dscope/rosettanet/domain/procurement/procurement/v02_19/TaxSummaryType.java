 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CityTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}CurrencyConversion" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}MonetaryAmount" minOccurs="0"/&gt;
 *         &lt;element name="NationalTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}OtherTaxes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="RegionalTax" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}TaxInformationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}TaxPhrase" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxSummaryType {
    ...
    @XmlElementRef(name = "OtherTaxes", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = OtherTaxes.class, required = false)
    protected List<OtherTaxes> otherTaxes;
    @XmlElement(name = "RegionalTax")
    protected List<TaxInformationType> regionalTax;
    @XmlElementRef(name = "TaxPhrase", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = TaxPhrase.class, required = false)
