 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.08}BookPrice" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ResaleUnitPrice" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.03}FinancialAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.08}SalesOut"/&gt;
...
public class SalesOutAndTransactionType {
    ...
    @XmlElementRef(name = "BookPrice", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.08", type = BookPrice.class, required = false)
    ...
    @XmlElementRef(name = "SalesOut", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.08", type = SalesOut.class)
