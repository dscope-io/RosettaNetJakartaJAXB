...
import io.dscope.rosettanet.domain.procurement.codelist.freeonboard.v01_00.FreeOnBoard;
import io.dscope.rosettanet.domain.procurement.codelist.shipmentterms.v01_00.ShipmentTerms;
import io.dscope.rosettanet.domain.procurement.codelist.shippingservicelevel.v01_00.ShippingServiceLevel;
import io.dscope.rosettanet.domain.procurement.codelist.specialfulfillmentrequest.v01_00.SpecialFulfillmentRequest;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}CarrierInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:1.0}FreeOnBoard" minOccurs="0"/&gt;
 *         &lt;element name="PackList" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ShipmentTerms:xsd:codelist:1.0}ShipmentTerms" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ShippingServiceLevel:xsd:codelist:1.0}ShippingServiceLevel" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:1.0}SpecialFulfillmentRequest" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "CarrierInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = CarrierInformation.class, required = false)
    protected CarrierInformation carrierInformation;
    @XmlElementRef(name = "FreeOnBoard", namespace = "urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:1.0", type = FreeOnBoard.class, required = false)
    protected FreeOnBoard freeOnBoard;
    @XmlElement(name = "PackList")
    protected String packList;
    @XmlElementRef(name = "ShipmentTerms", namespace = "urn:rosettanet:specification:domain:Procurement:ShipmentTerms:xsd:codelist:1.0", type = ShipmentTerms.class, required = false)
    protected ShipmentTerms shipmentTerms;
    @XmlElementRef(name = "ShippingServiceLevel", namespace = "urn:rosettanet:specification:domain:Procurement:ShippingServiceLevel:xsd:codelist:1.0", type = ShippingServiceLevel.class, required = false)
    protected ShippingServiceLevel shippingServiceLevel;
    @XmlElementRef(name = "SpecialFulfillmentRequest", namespace = "urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:1.0", type = SpecialFulfillmentRequest.class, required = false)
    protected List<SpecialFulfillmentRequest> specialFulfillmentRequest;
    @XmlElementRef(name = "SpecialHandlingInstruction", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = SpecialHandlingInstruction.class, required = false)
