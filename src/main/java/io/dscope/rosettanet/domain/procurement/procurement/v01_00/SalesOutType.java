...
import io.dscope.rosettanet.domain.procurement.codelist.saletype.v01_00.SaleTypeType;
 ...
 *         &lt;element name="SaleType" type="{urn:rosettanet:specification:domain:Procurement:SaleType:xsd:codelist:1.0}SaleTypeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SalesOutType {
    ...
    protected SaleTypeType saleType;
     ...
     *     
     */
    public SaleTypeType getSaleType() {
        return saleType;
    }
     ...
     *     
     */
    public void setSaleType(SaleTypeType value) {
        this.saleType = value;
    }
