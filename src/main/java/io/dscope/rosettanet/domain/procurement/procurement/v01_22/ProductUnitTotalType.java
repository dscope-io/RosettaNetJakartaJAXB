...
import io.dscope.rosettanet.domain.procurement.codelist.totalqualifier.v01_02.TotalQualifier;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TotalQualifier:xsd:codelist:01.02}TotalQualifier"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductUnitTotalType {
    ...
    @XmlElementRef(name = "TotalQualifier", namespace = "urn:rosettanet:specification:domain:Procurement:TotalQualifier:xsd:codelist:01.02", type = TotalQualifier.class)
