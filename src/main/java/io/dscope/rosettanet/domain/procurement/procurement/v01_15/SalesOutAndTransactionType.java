...
import io.dscope.rosettanet.domain.procurement.codelist.purchasemethod.v01_02.PurchaseMethod;
import io.dscope.rosettanet.domain.procurement.codelist.transactiontype.v01_03.TransactionType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}BookPrice" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PurchaseMethod:xsd:codelist:01.02}PurchaseMethod" minOccurs="0"/&gt;
 *         &lt;element name="ResaleUnitPrice" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01}FinancialAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}SalesOut"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:01.03}TransactionType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SalesOutAndTransactionType {
    ...
    @XmlElementRef(name = "BookPrice", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15", type = BookPrice.class, required = false)
    ...
    @XmlElementRef(name = "PurchaseMethod", namespace = "urn:rosettanet:specification:domain:Procurement:PurchaseMethod:xsd:codelist:01.02", type = PurchaseMethod.class, required = false)
    protected PurchaseMethod purchaseMethod;
    @XmlElement(name = "ResaleUnitPrice")
    protected FinancialAmountType resaleUnitPrice;
    @XmlElementRef(name = "SalesOut", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15", type = SalesOut.class)
    protected SalesOut salesOut;
    @XmlElementRef(name = "TransactionType", namespace = "urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:01.03", type = TransactionType.class, required = false)
