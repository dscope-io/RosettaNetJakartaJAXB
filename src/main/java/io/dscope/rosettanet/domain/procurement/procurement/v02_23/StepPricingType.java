 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.23}ProductQuantityRange"/&gt;
 *       &lt;/sequence&gt;
...
public class StepPricingType {
    ...
    @XmlElementRef(name = "ProductQuantityRange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.23", type = ProductQuantityRange.class)
