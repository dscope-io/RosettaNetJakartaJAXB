...
import io.dscope.rosettanet.domain.shared.shared.v01_19.DatePeriodAndDurationType;
import io.dscope.rosettanet.universal.monetaryexpression.v01_07.ProductPricing;
 ...
 *         &lt;element name="EligiblePeriod" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}DatePeriodAndDurationType" minOccurs="0"/&gt;
 *         &lt;element name="EligibleUnits" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.07}ProductPricing"/&gt;
 *       &lt;/sequence&gt;
...
public class SpecialPriceType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.07", type = ProductPricing.class)
