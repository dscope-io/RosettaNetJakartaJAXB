...
import io.dscope.rosettanet.domain.shared.codelist.freeonboard.v01_00.FreeOnBoard;
import io.dscope.rosettanet.domain.shared.codelist.shippingservicelevel.v01_00.ShippingServiceLevel;
import io.dscope.rosettanet.domain.shared.shared.v01_01.CarrierInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.01}CarrierInformation" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:FreeOnBoard:xsd:codelist:01.00}FreeOnBoard" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "CarrierInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.01", type = CarrierInformation.class, required = false)
    protected CarrierInformation carrierInformation;
    @XmlElementRef(name = "FreeOnBoard", namespace = "urn:rosettanet:specification:domain:Shared:FreeOnBoard:xsd:codelist:01.00", type = FreeOnBoard.class, required = false)
    ...
    @XmlElementRef(name = "SpecialHandlingInstruction", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = SpecialHandlingInstruction.class, required = false)
