...
import io.dscope.rosettanet.universal.dates.v01_02.DateTimePeriod;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.02}DateTimePeriod" minOccurs="0"/&gt;
...
public class TransportationEventType {
    ...
    @XmlElementRef(name = "DateTimePeriod", namespace = "urn:rosettanet:specification:universal:Dates:xsd:schema:01.02", type = DateTimePeriod.class, required = false)
