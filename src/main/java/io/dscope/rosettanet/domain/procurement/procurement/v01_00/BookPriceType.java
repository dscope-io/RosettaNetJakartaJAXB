...
import io.dscope.rosettanet.domain.procurement.codelist.bookpricequalifier.v01_00.BookPriceQualifier;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:1.0}BookPriceQualifier"/&gt;
...
public class BookPriceType {
    ...
    @XmlElementRef(name = "BookPriceQualifier", namespace = "urn:rosettanet:specification:domain:Procurement:BookPriceQualifier:xsd:codelist:1.0", type = BookPriceQualifier.class)
