 ...
 *           &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22}Duration"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class DatePeriodAndDurationType {
    ...
    @XmlElementRef(name = "Duration", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22", type = Duration.class, required = false)
