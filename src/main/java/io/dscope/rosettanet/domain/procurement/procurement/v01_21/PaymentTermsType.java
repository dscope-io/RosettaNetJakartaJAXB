...
import io.dscope.rosettanet.domain.procurement.codelist.paymentcondition.v01_02.PaymentCondition;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.21}Discounts" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.21}NetTerms"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PaymentCondition:xsd:codelist:01.02}PaymentCondition" minOccurs="0"/&gt;
 *         &lt;element name="PercentDue" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}PercentAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PaymentTermsType {
    ...
    @XmlElementRef(name = "Discounts", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.21", type = Discounts.class, required = false)
    protected List<Discounts> discounts;
    @XmlElementRef(name = "NetTerms", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.21", type = NetTerms.class)
    protected NetTerms netTerms;
    @XmlElementRef(name = "PaymentCondition", namespace = "urn:rosettanet:specification:domain:Procurement:PaymentCondition:xsd:codelist:01.02", type = PaymentCondition.class, required = false)
