...
import io.dscope.rosettanet.domain.procurement.codelist.transactiontype.v01_02.TransactionType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}BookPrice" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06}SalesOut"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:01.02}TransactionType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SalesOutAndTransactionType {
    ...
    @XmlElementRef(name = "BookPrice", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06", type = BookPrice.class, required = false)
    ...
    @XmlElementRef(name = "SalesOut", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.06", type = SalesOut.class)
    protected SalesOut salesOut;
    @XmlElementRef(name = "TransactionType", namespace = "urn:rosettanet:specification:domain:Procurement:TransactionType:xsd:codelist:01.02", type = TransactionType.class, required = false)
