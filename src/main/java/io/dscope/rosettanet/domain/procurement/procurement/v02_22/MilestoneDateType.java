 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}AlternativeEvent"/&gt;
...
public class MilestoneDateType {
    ...
    @XmlElementRef(name = "AlternativeEvent", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22", type = AlternativeEvent.class, required = false)
