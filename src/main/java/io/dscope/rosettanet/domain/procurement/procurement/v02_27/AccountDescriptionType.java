 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27}CreditCard" minOccurs="0"/&gt;
...
public class AccountDescriptionType {
    ...
    @XmlElementRef(name = "CreditCard", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.27", type = CreditCard.class, required = false)
