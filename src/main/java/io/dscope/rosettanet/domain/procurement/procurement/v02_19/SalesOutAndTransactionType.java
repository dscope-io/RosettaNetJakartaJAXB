 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}BookPrice" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}SalesOut"/&gt;
...
public class SalesOutAndTransactionType {
    ...
    @XmlElementRef(name = "BookPrice", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = BookPrice.class, required = false)
    ...
    @XmlElementRef(name = "SalesOut", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = SalesOut.class)
