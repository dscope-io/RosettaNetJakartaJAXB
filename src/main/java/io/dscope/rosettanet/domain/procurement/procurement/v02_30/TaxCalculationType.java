...
import io.dscope.rosettanet.domain.shared.shared.v01_19.MonetaryAmountType;
import io.dscope.rosettanet.universal.monetaryexpression.v01_07.TaxAmount;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.07}TaxAmount" maxOccurs="unbounded"/&gt;
 *         &lt;element name="TotalAmount" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}MonetaryAmountType"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxCalculationType {
    ...
    @XmlElementRef(name = "TaxAmount", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.07", type = TaxAmount.class)
