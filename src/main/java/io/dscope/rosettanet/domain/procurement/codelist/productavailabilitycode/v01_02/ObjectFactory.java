 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.productavailabilitycode.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.productavailabilitycode.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:ProductAvailabilityCode:xsd:codelist:01.02", name = "ProductAvailabilityCodeA")
