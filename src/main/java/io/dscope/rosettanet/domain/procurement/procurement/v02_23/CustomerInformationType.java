 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:CustomerType:xsd:codelist:01.03}CustomerType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.15}PartnerDescription"/&gt;
...
public class CustomerInformationType {
    ...
    @XmlElementRef(name = "CustomerType", namespace = "urn:rosettanet:specification:domain:Procurement:CustomerType:xsd:codelist:01.03", type = CustomerType.class, required = false)
    protected CustomerType customerType;
    @XmlElementRef(name = "PartnerDescription", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.15", type = PartnerDescription.class)
