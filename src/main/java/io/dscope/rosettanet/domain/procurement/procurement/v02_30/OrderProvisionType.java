 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}ProductAvailabilityType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="OrderQuantity" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}ProductQuantityRangeType"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}ProductLeadTime" minOccurs="0"/&gt;
    ...
    extends ProductAvailabilityType
{
    ...
    @XmlElementRef(name = "ProductLeadTime", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30", type = ProductLeadTime.class, required = false)
