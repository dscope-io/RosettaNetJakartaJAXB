    ...
    extends JAXBElement<PurchaseOrderAcknowledgmentReasonType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Procurement:PurchaseOrderAcknowledgmentReason:xsd:codelist:01.03", "PurchaseOrderAcknowledgmentReason");
