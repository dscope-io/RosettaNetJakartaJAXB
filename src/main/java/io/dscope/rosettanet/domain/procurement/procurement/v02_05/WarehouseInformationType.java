 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05}WarehouseLocation"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05}WarehouseQuantityInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class WarehouseInformationType {
    ...
    @XmlElementRef(name = "WarehouseLocation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05", type = WarehouseLocation.class)
    protected WarehouseLocation warehouseLocation;
    @XmlElementRef(name = "WarehouseQuantityInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.05", type = WarehouseQuantityInformation.class, required = false)
