 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}CustomerInformation" minOccurs="0"/&gt;
...
public class BranchInformationType {
    ...
    @XmlElementRef(name = "CustomerInformation", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22", type = CustomerInformation.class, required = false)
