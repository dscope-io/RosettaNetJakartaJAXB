 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.governmentpriorityrating.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.governmentpriorityrating.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:GovernmentPriorityRating:xsd:codelist:1.0", name = "GovernmentPriorityRatingA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:GovernmentPriorityRating:xsd:codelist:1.0", name = "GovernmentPriorityRating", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:GovernmentPriorityRating:xsd:codelist:1.0", substitutionHeadName = "GovernmentPriorityRatingA")
