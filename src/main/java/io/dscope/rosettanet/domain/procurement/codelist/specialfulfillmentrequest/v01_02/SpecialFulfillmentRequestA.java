    ...
    extends JAXBElement<Object>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Procurement:SpecialFulfillmentRequest:xsd:codelist:01.02", "SpecialFulfillmentRequestA");
