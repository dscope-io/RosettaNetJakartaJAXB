 ...
 *           &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}UNSPSC"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
    ...
    extends IdentifierType
{
    ...
    @XmlElementRef(name = "UNSPSC", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = UNSPSC.class, required = false)
