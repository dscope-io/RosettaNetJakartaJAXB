 ...
 *         &lt;element name="OrderSizeRounding" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.15}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="PreviousUnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}PriceListType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}ProductQuantityRange"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22}PriceListType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingDetailType {
    ...
    @XmlElementRef(name = "ProductQuantityRange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.22", type = ProductQuantityRange.class)
