...
import io.dscope.rosettanet.domain.shared.shared.v01_19.ProductPricing;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}ProductPricing" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingInformationType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.19", type = ProductPricing.class)
