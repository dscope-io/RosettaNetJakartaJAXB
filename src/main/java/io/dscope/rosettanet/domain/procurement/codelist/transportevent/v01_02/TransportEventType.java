 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Procurement:TransportEvent:xsd:codelist:01.02&gt;TransportEventContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="TransportEvent" /&gt;
...
public class TransportEventType {
    ...
    @XmlValue
    protected TransportEventContentType value;
     ...
     * @return
     *     possible object is
     *     {@link TransportEventContentType }
     *     
     */
    public TransportEventContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(TransportEventContentType value) {
        this.value = value;
    }
