...
import io.dscope.rosettanet.domain.shared.shared.v01_16.CarrierInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}CarrierInformation" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.23}SpecialHandlingInstruction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "CarrierInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", type = CarrierInformation.class, required = false)
    ...
    @XmlElementRef(name = "SpecialHandlingInstruction", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.23", type = SpecialHandlingInstruction.class, required = false)
