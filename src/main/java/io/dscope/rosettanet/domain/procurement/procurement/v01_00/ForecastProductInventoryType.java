...
import io.dscope.rosettanet.domain.procurement.codelist.inventorytype.v01_00.InventoryType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:InventoryType:xsd:codelist:1.0}InventoryType"/&gt;
...
public class ForecastProductInventoryType {
    ...
    @XmlElementRef(name = "InventoryType", namespace = "urn:rosettanet:specification:domain:Procurement:InventoryType:xsd:codelist:1.0", type = InventoryType.class)
