 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30}LeadTimeQuantity" minOccurs="0"/&gt;
...
public class ProductLeadTimeType {
    ...
    @XmlElementRef(name = "LeadTimeQuantity", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.30", type = LeadTimeQuantity.class, required = false)
