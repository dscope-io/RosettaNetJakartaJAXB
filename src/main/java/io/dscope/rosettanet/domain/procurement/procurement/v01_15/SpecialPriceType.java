 ...
 *         &lt;element name="EligiblePeriod" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}DatePeriodAndDurationType" minOccurs="0"/&gt;
 *         &lt;element name="EligibleUnits" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.15}ProductQuantityType" minOccurs="0"/&gt;
