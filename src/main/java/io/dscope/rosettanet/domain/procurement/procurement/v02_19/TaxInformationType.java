 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}MonetaryAmount"/&gt;
...
public class TaxInformationType {
    ...
    @XmlElementRef(name = "MonetaryAmount", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.12", type = MonetaryAmount.class)
