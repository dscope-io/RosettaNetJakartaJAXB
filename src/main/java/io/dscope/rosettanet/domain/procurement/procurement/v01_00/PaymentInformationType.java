...
import io.dscope.rosettanet.domain.procurement.codelist.paymenttype.v01_00.PaymentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PaymentType:xsd:codelist:1.0}PaymentType"/&gt;
 *       &lt;/sequence&gt;
...
public class PaymentInformationType {
    ...
    @XmlElementRef(name = "PaymentType", namespace = "urn:rosettanet:specification:domain:Procurement:PaymentType:xsd:codelist:1.0", type = PaymentType.class)
