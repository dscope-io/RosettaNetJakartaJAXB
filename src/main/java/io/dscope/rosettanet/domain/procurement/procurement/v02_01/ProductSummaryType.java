 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}ProductUnitTotal" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductSummaryType {
    ...
    @XmlElementRef(name = "ProductUnitTotal", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = ProductUnitTotal.class)
