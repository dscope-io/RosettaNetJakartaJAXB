...
import io.dscope.rosettanet.domain.shared.shared.v01_16.MonetaryAmountType;
import io.dscope.rosettanet.universal.monetaryexpression.v01_05.TaxAmount;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05}TaxAmount" maxOccurs="unbounded"/&gt;
 *         &lt;element name="TotalAmount" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}MonetaryAmountType"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxCalculationType {
    ...
    @XmlElementRef(name = "TaxAmount", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05", type = TaxAmount.class)
