...
import io.dscope.rosettanet.domain.procurement.codelist.monetaryamounttype.v01_02.MonetaryAmountType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:InvoiceChargeType:xsd:codelist:01.02}InvoiceChargeType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:MonetaryAmountType:xsd:codelist:01.02}MonetaryAmountType"/&gt;
 *       &lt;/sequence&gt;
...
public class InvoiceAmountType {
    ...
    @XmlElementRef(name = "InvoiceChargeType", namespace = "urn:rosettanet:specification:domain:Procurement:InvoiceChargeType:xsd:codelist:01.02", type = InvoiceChargeType.class)
    protected InvoiceChargeType invoiceChargeType;
    @XmlElementRef(name = "MonetaryAmountType", namespace = "urn:rosettanet:specification:domain:Procurement:MonetaryAmountType:xsd:codelist:01.02", type = MonetaryAmountType.class)
