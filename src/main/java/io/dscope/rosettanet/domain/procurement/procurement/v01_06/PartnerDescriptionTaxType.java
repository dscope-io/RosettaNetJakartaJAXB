...
import io.dscope.rosettanet.universal.partneridentification.v01_03.PartnerDescription;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03}PartnerDescription"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01}TaxJurisdiction" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PartnerDescriptionTaxType {
    ...
    @XmlElementRef(name = "PartnerDescription", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.03", type = PartnerDescription.class)
