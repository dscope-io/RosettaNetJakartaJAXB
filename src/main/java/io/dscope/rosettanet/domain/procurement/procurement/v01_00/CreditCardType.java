...
import io.dscope.rosettanet.domain.procurement.codelist.creditcardclassification.v01_00.CreditCardClassification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:CreditCardClassification:xsd:codelist:1.0}CreditCardClassification"/&gt;
...
public class CreditCardType {
    ...
    @XmlElementRef(name = "CreditCardClassification", namespace = "urn:rosettanet:specification:domain:Procurement:CreditCardClassification:xsd:codelist:1.0", type = CreditCardClassification.class)
