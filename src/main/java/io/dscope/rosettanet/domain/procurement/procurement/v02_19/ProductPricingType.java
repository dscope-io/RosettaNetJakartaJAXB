 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AssociatedProduct" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}SubstituteProductReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}IsCallFactory" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}IsCostChange"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}IsPriceProtect"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}IsSuggestedResaleChange"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19}PricingDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductPricingType {
    ...
    @XmlElementRef(name = "IsCallFactory", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = IsCallFactory.class, required = false)
    protected IsCallFactory isCallFactory;
    @XmlElementRef(name = "IsCostChange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = IsCostChange.class)
    protected IsCostChange isCostChange;
    @XmlElementRef(name = "IsPriceProtect", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = IsPriceProtect.class)
    protected IsPriceProtect isPriceProtect;
    @XmlElementRef(name = "IsSuggestedResaleChange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = IsSuggestedResaleChange.class)
    protected IsSuggestedResaleChange isSuggestedResaleChange;
    @XmlElementRef(name = "PricingDetail", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.19", type = PricingDetail.class, required = false)
