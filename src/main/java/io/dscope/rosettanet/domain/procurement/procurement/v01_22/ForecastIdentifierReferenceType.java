...
import io.dscope.rosettanet.domain.procurement.codelist.forecastreferencetype.v01_02.ForecastReferenceType;
 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:rosettanet:specification:universal:Document:xsd:schema:01.06}BusinessDocumentReferenceType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ForecastReferenceType:xsd:codelist:01.02}ForecastReferenceType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends BusinessDocumentReferenceType
{
    ...
    @XmlElementRef(name = "ForecastReferenceType", namespace = "urn:rosettanet:specification:domain:Procurement:ForecastReferenceType:xsd:codelist:01.02", type = ForecastReferenceType.class)
