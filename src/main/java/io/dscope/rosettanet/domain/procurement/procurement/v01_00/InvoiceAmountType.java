 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:InvoiceChargeType:xsd:codelist:1.0}InvoiceChargeType"/&gt;
...
public class InvoiceAmountType {
    ...
    @XmlElementRef(name = "InvoiceChargeType", namespace = "urn:rosettanet:specification:domain:Procurement:InvoiceChargeType:xsd:codelist:1.0", type = InvoiceChargeType.class)
