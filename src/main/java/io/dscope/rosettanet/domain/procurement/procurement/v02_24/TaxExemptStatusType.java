 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.24}TaxExemption" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxExemptStatusType {
    ...
    @XmlElementRef(name = "TaxExemption", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.24", type = TaxExemption.class, required = false)
