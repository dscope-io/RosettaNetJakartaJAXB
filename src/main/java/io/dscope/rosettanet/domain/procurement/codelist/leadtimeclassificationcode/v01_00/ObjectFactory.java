 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.leadtimeclassificationcode.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.leadtimeclassificationcode.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:LeadTimeClassificationCode:xsd:codelist:1.0", name = "LeadTimeClassificationCodeA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:LeadTimeClassificationCode:xsd:codelist:1.0", name = "LeadTimeClassificationCode", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:LeadTimeClassificationCode:xsd:codelist:1.0", substitutionHeadName = "LeadTimeClassificationCodeA")
