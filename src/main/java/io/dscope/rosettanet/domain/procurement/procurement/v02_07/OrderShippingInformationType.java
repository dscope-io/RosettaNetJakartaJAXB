...
import io.dscope.rosettanet.domain.shared.shared.v01_05.CarrierInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.05}CarrierInformation" minOccurs="0"/&gt;
...
public class OrderShippingInformationType {
    ...
    @XmlElementRef(name = "CarrierInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.05", type = CarrierInformation.class, required = false)
