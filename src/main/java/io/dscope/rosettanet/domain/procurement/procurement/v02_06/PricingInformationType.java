...
import io.dscope.rosettanet.domain.shared.shared.v01_04.ProductPricing;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductPricing" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingInformationType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.04", type = ProductPricing.class)
