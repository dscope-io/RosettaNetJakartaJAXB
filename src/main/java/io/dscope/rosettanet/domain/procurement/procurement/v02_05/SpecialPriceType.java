 ...
 *         &lt;element name="EligiblePeriod" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}DatePeriodAndDurationType" minOccurs="0"/&gt;
 *         &lt;element name="EligibleUnits" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.04}ProductQuantityType" minOccurs="0"/&gt;
