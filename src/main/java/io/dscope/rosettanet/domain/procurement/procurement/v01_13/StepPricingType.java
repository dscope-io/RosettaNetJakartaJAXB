 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}MonetaryAmount"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}ProductQuantityRange"/&gt;
 *       &lt;/sequence&gt;
...
public class StepPricingType {
    ...
    @XmlElementRef(name = "MonetaryAmount", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = MonetaryAmount.class)
    ...
    @XmlElementRef(name = "ProductQuantityRange", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = ProductQuantityRange.class)
