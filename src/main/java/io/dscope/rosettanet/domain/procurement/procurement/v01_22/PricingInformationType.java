 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22}ProductPricing" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PricingInformationType {
    ...
    @XmlElementRef(name = "ProductPricing", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22", type = ProductPricing.class)
