 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}IsCallFactory" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}LeadTimeQuantity" minOccurs="0"/&gt;
...
public class ProductLeadTimeType {
    ...
    @XmlElementRef(name = "IsCallFactory", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = IsCallFactory.class, required = false)
    ...
    @XmlElementRef(name = "LeadTimeQuantity", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = LeadTimeQuantity.class, required = false)
