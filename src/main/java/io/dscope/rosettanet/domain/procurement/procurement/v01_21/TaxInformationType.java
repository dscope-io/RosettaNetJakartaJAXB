...
import io.dscope.rosettanet.universal.monetaryexpression.v01_01.TaxJurisdiction;
 ...
 *         &lt;element name="Rate" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.02}PercentAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01}TaxJurisdiction" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxInformationType {
    ...
    @XmlElementRef(name = "TaxJurisdiction", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01", type = TaxJurisdiction.class, required = false)
