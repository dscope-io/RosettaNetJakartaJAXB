 ...
 * generated in the io.dscope.rosettanet.domain.procurement.codelist.productavailabilitycode.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.procurement.codelist.productavailabilitycode.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:ProductAvailabilityCode:xsd:codelist:1.0", name = "ProductAvailabilityCodeA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Procurement:ProductAvailabilityCode:xsd:codelist:1.0", name = "ProductAvailabilityCode", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Procurement:ProductAvailabilityCode:xsd:codelist:1.0", substitutionHeadName = "ProductAvailabilityCodeA")
