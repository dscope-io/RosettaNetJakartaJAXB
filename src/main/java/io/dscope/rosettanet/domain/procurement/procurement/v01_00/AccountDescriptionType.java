...
import io.dscope.rosettanet.domain.procurement.codelist.accountclassification.v01_00.AccountClassification;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:AccountClassification:xsd:codelist:1.0}AccountClassification" minOccurs="0"/&gt;
 *         &lt;element name="AccountName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="AccountNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}CreditCard" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0}PartnerDescription" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class AccountDescriptionType {
    ...
    @XmlElementRef(name = "AccountClassification", namespace = "urn:rosettanet:specification:domain:Procurement:AccountClassification:xsd:codelist:1.0", type = AccountClassification.class, required = false)
    protected AccountClassification accountClassification;
    @XmlElement(name = "AccountName")
    protected String accountName;
    @XmlElement(name = "AccountNumber")
    protected String accountNumber;
    @XmlElementRef(name = "CreditCard", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0", type = CreditCard.class, required = false)
    protected CreditCard creditCard;
    @XmlElementRef(name = "PartnerDescription", namespace = "urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:1.0", type = PartnerDescription.class, required = false)
