 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReference"/&gt;
...
public class RequestingOrderLineItemReferenceType {
    ...
    @XmlElementRef(name = "BusinessDocumentReference", namespace = "urn:rosettanet:specification:universal:Document:xsd:schema:01.02", type = BusinessDocumentReference.class)
