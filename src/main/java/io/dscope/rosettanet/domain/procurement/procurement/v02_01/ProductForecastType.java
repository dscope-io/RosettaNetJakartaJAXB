...
import io.dscope.rosettanet.domain.procurement.codelist.forecastevent.v01_02.ForecastEvent;
import io.dscope.rosettanet.universal.codelist.unitofmeasure.v01_01.UnitOfMeasure;
import io.dscope.rosettanet.universal.dates.v01_02.DatePeriodType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:ForecastEvent:xsd:codelist:01.02}ForecastEvent" minOccurs="0"/&gt;
 *         &lt;element name="FrozenZone" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.02}DatePeriodType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}ProductFamilyReporting"/&gt;
 *         &lt;element name="ProductForecastIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}ForecastIdentifierReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ProductForecastRevision" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.02}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01}ProductReceiptReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TradeOffZone" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:01.02}DatePeriodType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.01}UnitOfMeasure"/&gt;
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01}FinancialAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductForecastType {
    ...
    @XmlElementRef(name = "ForecastEvent", namespace = "urn:rosettanet:specification:domain:Procurement:ForecastEvent:xsd:codelist:01.02", type = ForecastEvent.class, required = false)
    protected ForecastEvent forecastEvent;
    @XmlElement(name = "FrozenZone")
    protected DatePeriodType frozenZone;
    @XmlElementRef(name = "ProductFamilyReporting", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = ProductFamilyReporting.class)
    ...
    @XmlElementRef(name = "ProductReceiptReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.01", type = ProductReceiptReference.class, required = false)
