    ...
    extends JAXBElement<ForecastQuantityTypeType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Procurement:ForecastQuantityType:xsd:codelist:01.04", "ForecastQuantityType");
