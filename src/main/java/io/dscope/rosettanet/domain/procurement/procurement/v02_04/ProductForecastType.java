 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}ProductFamilyReporting"/&gt;
 *         &lt;element name="ProductForecastIdentifier" type="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}ForecastIdentifierReferenceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ProductForecastRevision" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.03}BusinessDocumentReferenceType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04}ProductReceiptReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="UnitPrice" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.02}FinancialAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProductForecastType {
    ...
    @XmlElementRef(name = "ProductFamilyReporting", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04", type = ProductFamilyReporting.class)
    ...
    @XmlElementRef(name = "ProductReceiptReference", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:02.04", type = ProductReceiptReference.class, required = false)
