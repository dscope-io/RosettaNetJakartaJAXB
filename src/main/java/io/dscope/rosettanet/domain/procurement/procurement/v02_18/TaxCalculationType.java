...
import io.dscope.rosettanet.domain.shared.shared.v01_11.MonetaryAmountType;
import io.dscope.rosettanet.universal.monetaryexpression.v01_04.TaxAmount;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.04}TaxAmount" maxOccurs="unbounded"/&gt;
 *         &lt;element name="TotalAmount" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.11}MonetaryAmountType"/&gt;
 *       &lt;/sequence&gt;
...
public class TaxCalculationType {
    ...
    @XmlElementRef(name = "TaxAmount", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.04", type = TaxAmount.class)
