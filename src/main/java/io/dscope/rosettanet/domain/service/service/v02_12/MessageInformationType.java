 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.12}RoutingInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MessageInformationType {
    ...
    @XmlElementRef(name = "RoutingInformation", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.12", type = RoutingInformation.class, required = false)
