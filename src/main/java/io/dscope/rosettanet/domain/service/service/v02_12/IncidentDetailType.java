 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.12}FailureEvent"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.12}RepairEvent"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class IncidentDetailType {
    ...
    @XmlElementRef(name = "FailureEvent", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.12", type = FailureEvent.class, required = false)
    protected FailureEvent failureEvent;
    @XmlElementRef(name = "RepairEvent", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.12", type = RepairEvent.class, required = false)
