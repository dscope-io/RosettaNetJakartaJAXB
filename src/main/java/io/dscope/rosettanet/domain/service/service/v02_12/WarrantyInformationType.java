 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.12}ExpiryDate" minOccurs="0"/&gt;
...
public class WarrantyInformationType {
    ...
    @XmlElementRef(name = "ExpiryDate", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.12", type = ExpiryDate.class, required = false)
