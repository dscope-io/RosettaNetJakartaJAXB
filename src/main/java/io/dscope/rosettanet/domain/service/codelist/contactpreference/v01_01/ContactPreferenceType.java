 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Service:ContactPreference:xsd:codelist:01.01&gt;ContactPreferenceContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="ContactPreference" /&gt;
...
public class ContactPreferenceType {
    ...
    @XmlValue
    protected ContactPreferenceContentType value;
     ...
     * @return
     *     possible object is
     *     {@link ContactPreferenceContentType }
     *     
     */
    public ContactPreferenceContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ContactPreferenceContentType value) {
        this.value = value;
    }
