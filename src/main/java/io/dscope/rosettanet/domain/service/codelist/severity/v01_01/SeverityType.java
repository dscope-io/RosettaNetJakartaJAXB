 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Service:Severity:xsd:codelist:01.01&gt;SeverityContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="Severity" /&gt;
...
public class SeverityType {
    ...
    @XmlValue
    protected SeverityContentType value;
     ...
     * @return
     *     possible object is
     *     {@link SeverityContentType }
     *     
     */
    public SeverityContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(SeverityContentType value) {
        this.value = value;
    }
