...
import io.dscope.rosettanet.domain.shared.shared.v01_10.PaymentInformation;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.10}PaymentInformation"/&gt;
 *       &lt;/sequence&gt;
...
public class ReimbursementInformationType {
    ...
    @XmlElementRef(name = "PaymentInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.10", type = PaymentInformation.class)
