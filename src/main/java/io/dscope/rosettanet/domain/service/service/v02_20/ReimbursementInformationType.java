 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}PaymentInformation"/&gt;
 *       &lt;/sequence&gt;
...
public class ReimbursementInformationType {
    ...
    @XmlElementRef(name = "PaymentInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.17", type = PaymentInformation.class)
