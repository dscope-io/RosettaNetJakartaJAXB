 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.12}ReplacedPart" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class PartType {
    ...
    @XmlElementRef(name = "ReplacedPart", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.12", type = ReplacedPart.class, required = false)
