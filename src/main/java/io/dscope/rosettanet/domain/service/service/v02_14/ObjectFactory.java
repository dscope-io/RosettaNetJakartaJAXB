 ...
 * generated in the io.dscope.rosettanet.domain.service.service.v02_14 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.service.service.v02_14
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "CaseID")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "EffectiveDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ExpiryDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "FailureAnalysis")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "FailureEvent")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "FailureInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "Fault")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "Hardware")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "IncidentDetail")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "MessageInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "Part")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "PurchaseDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ReimbursementInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "RejectCase")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "RepairEvent")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ReplacedPart")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ResponsePeriod")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "RoutingInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ServiceCompletionDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "ServiceStartDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "Software")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "Update")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", name = "WarrantyInformation")
