 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Service:xsd:schema:02.14}FailureAnalysis" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class FailureInformationType {
    ...
    @XmlElementRef(name = "FailureAnalysis", namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.14", type = FailureAnalysis.class, required = false)
