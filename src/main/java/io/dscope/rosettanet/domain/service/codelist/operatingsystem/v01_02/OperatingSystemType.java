 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Service:OperatingSystem:xsd:codelist:01.02&gt;OperatingSystemContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="OperatingSystem" /&gt;
...
public class OperatingSystemType {
    ...
    @XmlValue
    protected OperatingSystemContentType value;
     ...
     * @return
     *     possible object is
     *     {@link OperatingSystemContentType }
     *     
     */
    public OperatingSystemContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(OperatingSystemContentType value) {
        this.value = value;
    }
