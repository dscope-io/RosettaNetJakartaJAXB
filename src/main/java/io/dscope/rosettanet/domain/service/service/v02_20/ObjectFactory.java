 ...
 * generated in the io.dscope.rosettanet.domain.service.service.v02_20 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.service.service.v02_20
     * 
     */
    ...
    /**
     * Create an instance of {@link CRContactType }
     * 
     */
    public CRContactType createCRContactType() {
        return new CRContactType();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "CaseID")
    public CaseID createCaseID(CaseIDType value) {
        return new CaseID(value);
    }

    /**
     * Create an instance of {@link CRContact }
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link CRContact }
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "CRContact")
    public CRContact createCRContact(CRContactType value) {
        return new CRContact(value);
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "EffectiveDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ExpiryDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "FailureAnalysis")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "FailureEvent")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "FailureInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Fault")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Hardware")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "IncidentDetail")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "MessageInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Notes")
    public Notes createNotes(NotesType value) {
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Part")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "PurchaseDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ReimbursementInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "RejectCase")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "RepairEvent")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ReplacedPart")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ResponsePeriod")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "RoutingInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ServiceCompletionDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ServiceInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "ServiceStartDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Software")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "Update")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Service:xsd:schema:02.20", name = "WarrantyInformation")
