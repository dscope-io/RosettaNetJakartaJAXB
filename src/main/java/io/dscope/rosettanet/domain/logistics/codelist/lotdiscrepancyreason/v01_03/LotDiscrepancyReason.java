    ...
    extends JAXBElement<LotDiscrepancyReasonType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Logistics:LotDiscrepancyReason:xsd:codelist:01.03", "LotDiscrepancyReason");
