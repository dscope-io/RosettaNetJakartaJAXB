 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.14}ReturnInstructions" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.14}TrackingReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ReturnLabelType {
    ...
    @XmlElementRef(name = "ReturnInstructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.14", type = ReturnInstructions.class, required = false)
    ...
    @XmlElementRef(name = "TrackingReference", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.14", type = TrackingReference.class, required = false)
