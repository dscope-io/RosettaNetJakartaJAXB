 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15}PortIdentification" maxOccurs="unbounded"/&gt;
...
public class PortInformationType {
    ...
    @XmlElementRef(name = "PortIdentification", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15", type = PortIdentification.class)
