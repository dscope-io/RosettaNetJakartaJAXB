    ...
    extends JAXBElement<NationalExportControlClassificationType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Logistics:NationalExportControlClassification:xsd:codelist:01.02", "NationalExportControlClassification");
