 ...
 *         &lt;element name="PackingQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}ProductQuantityType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.21}ProductPackaging" minOccurs="0"/&gt;
 *         &lt;element name="SmallestPackingQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}ProductQuantityType"/&gt;
...
public class ProductAttributeType {
    ...
    @XmlElementRef(name = "ProductPackaging", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.21", type = ProductPackaging.class, required = false)
