 ...
 * generated in the io.dscope.rosettanet.domain.logistics.codelist.shippingorderrejectreason.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.logistics.codelist.shippingorderrejectreason.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Logistics:ShippingOrderRejectReason:xsd:codelist:01.00", name = "ShippingOrderRejectReasonA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Logistics:ShippingOrderRejectReason:xsd:codelist:01.00", name = "ShippingOrderRejectReason", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Logistics:ShippingOrderRejectReason:xsd:codelist:01.00", substitutionHeadName = "ShippingOrderRejectReasonA")
