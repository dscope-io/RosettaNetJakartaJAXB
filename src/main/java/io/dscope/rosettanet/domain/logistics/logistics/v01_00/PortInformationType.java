...
import io.dscope.rosettanet.domain.logistics.codelist.porttype.v01_00.PortType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:1.0}PortIdentification" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:PortType:xsd:codelist:1.0}PortType"/&gt;
...
public class PortInformationType {
    ...
    @XmlElementRef(name = "PortIdentification", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:1.0", type = PortIdentification.class)
    protected List<PortIdentification> portIdentification;
    @XmlElementRef(name = "PortType", namespace = "urn:rosettanet:specification:domain:Logistics:PortType:xsd:codelist:1.0", type = PortType.class)
