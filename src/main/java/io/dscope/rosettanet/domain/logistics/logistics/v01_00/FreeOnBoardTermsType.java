 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:1.0}FreeOnBoard"/&gt;
...
public class FreeOnBoardTermsType {
    ...
    @XmlElementRef(name = "FreeOnBoard", namespace = "urn:rosettanet:specification:domain:Procurement:FreeOnBoard:xsd:codelist:1.0", type = FreeOnBoard.class)
