 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BarcodeInstruction" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15}LabelInstructionType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Description" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15}LabelServiceContent" minOccurs="0"/&gt;
 *         &lt;element name="RoutingInstruction" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15}LabelInstructionType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ShippingLabelType {
    ...
    @XmlElementRef(name = "LabelServiceContent", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.15", type = LabelServiceContent.class, required = false)
