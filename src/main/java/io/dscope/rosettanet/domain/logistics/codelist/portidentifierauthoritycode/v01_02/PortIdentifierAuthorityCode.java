    ...
    extends JAXBElement<PortIdentifierAuthorityCodeType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Logistics:PortIdentifierAuthorityCode:xsd:codelist:01.02", "PortIdentifierAuthorityCode");
