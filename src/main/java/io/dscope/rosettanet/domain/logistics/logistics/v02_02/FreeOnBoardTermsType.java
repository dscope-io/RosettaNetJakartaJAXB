 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:FreeOnBoard:xsd:codelist:01.00}FreeOnBoard"/&gt;
...
public class FreeOnBoardTermsType {
    ...
    @XmlElementRef(name = "FreeOnBoard", namespace = "urn:rosettanet:specification:domain:Shared:FreeOnBoard:xsd:codelist:01.00", type = FreeOnBoard.class)
