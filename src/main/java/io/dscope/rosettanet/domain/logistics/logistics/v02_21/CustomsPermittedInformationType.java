...
import io.dscope.rosettanet.domain.shared.shared.v01_16.QuantityInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}QuantityInformation"/&gt;
...
public class CustomsPermittedInformationType {
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", type = QuantityInformation.class)
