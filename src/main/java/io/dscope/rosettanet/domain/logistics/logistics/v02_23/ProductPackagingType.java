...
import io.dscope.rosettanet.domain.shared.shared.v01_19.DatePeriodAndDuration;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}DatePeriodAndDuration" minOccurs="0"/&gt;
...
public class ProductPackagingType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.19", type = DatePeriodAndDuration.class, required = false)
