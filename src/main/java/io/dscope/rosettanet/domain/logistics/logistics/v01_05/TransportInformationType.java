...
import io.dscope.rosettanet.domain.logistics.codelist.shipmentmode.v01_02.ShipmentMode;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:ShipmentMode:xsd:codelist:01.02}ShipmentMode"/&gt;
 *       &lt;/sequence&gt;
...
public class TransportInformationType {
    ...
    @XmlElementRef(name = "ShipmentMode", namespace = "urn:rosettanet:specification:domain:Logistics:ShipmentMode:xsd:codelist:01.02", type = ShipmentMode.class)
