...
import io.dscope.rosettanet.domain.logistics.codelist.shipmentmode.v01_04.ShipmentMode;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:ShipmentMode:xsd:codelist:01.04}ShipmentMode"/&gt;
 *       &lt;/sequence&gt;
...
public class TransportInformationType {
    ...
    @XmlElementRef(name = "ShipmentMode", namespace = "urn:rosettanet:specification:domain:Logistics:ShipmentMode:xsd:codelist:01.04", type = ShipmentMode.class)
