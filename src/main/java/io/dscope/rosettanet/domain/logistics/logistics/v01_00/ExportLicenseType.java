...
import io.dscope.rosettanet.domain.logistics.codelist.nationalexportcontrolclassification.v01_00.NationalExportControlClassification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:NationalExportControlClassification:xsd:codelist:1.0}NationalExportControlClassification" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ExportLicenseType {
    ...
    @XmlElementRef(name = "NationalExportControlClassification", namespace = "urn:rosettanet:specification:domain:Logistics:NationalExportControlClassification:xsd:codelist:1.0", type = NationalExportControlClassification.class, required = false)
