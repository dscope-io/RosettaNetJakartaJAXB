...
import io.dscope.rosettanet.domain.shared.codelist.packagetypecode.v01_00.PackageTypeCode;
import io.dscope.rosettanet.domain.shared.shared.v01_01.DatePeriodAndDuration;
import io.dscope.rosettanet.universal.codelist.unitofmeasure.v01_01.UnitOfMeasure;
import io.dscope.rosettanet.universal.physicaldimension.v01_02.Linear;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.01}DatePeriodAndDuration" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.02}Linear" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02}MassPhysicalDimension" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:PackageTypeCode:xsd:codelist:01.00}PackageTypeCode" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductPackagingType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.01", type = DatePeriodAndDuration.class, required = false)
    protected DatePeriodAndDuration datePeriodAndDuration;
    @XmlElementRef(name = "Linear", namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.02", type = Linear.class, required = false)
    protected Linear linear;
    @XmlElementRef(name = "MassPhysicalDimension", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02", type = MassPhysicalDimension.class, required = false)
    protected MassPhysicalDimension massPhysicalDimension;
    @XmlElementRef(name = "PackageTypeCode", namespace = "urn:rosettanet:specification:domain:Shared:PackageTypeCode:xsd:codelist:01.00", type = PackageTypeCode.class, required = false)
