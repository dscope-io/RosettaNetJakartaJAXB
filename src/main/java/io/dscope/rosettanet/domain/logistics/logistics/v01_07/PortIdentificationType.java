...
public class PortIdentificationType {
    ...
    @XmlElementRef(name = "PortIdentifierAuthorityCode", namespace = "urn:rosettanet:specification:domain:Logistics:PortIdentifierAuthorityCode:xsd:codelist:01.02", type = PortIdentifierAuthorityCode.class)
