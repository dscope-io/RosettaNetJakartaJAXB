...
import io.dscope.rosettanet.domain.logistics.codelist.routelocation.v01_02.RouteLocation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:RouteLocation:xsd:codelist:01.02}RouteLocation"/&gt;
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02}PortAddress"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02}PortIdentification"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class ShippingRoutingPointType {
    ...
    @XmlElementRef(name = "RouteLocation", namespace = "urn:rosettanet:specification:domain:Logistics:RouteLocation:xsd:codelist:01.02", type = RouteLocation.class)
    protected RouteLocation routeLocation;
    @XmlElementRef(name = "PortAddress", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02", type = PortAddress.class, required = false)
    protected PortAddress portAddress;
    @XmlElementRef(name = "PortIdentification", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.02", type = PortIdentification.class, required = false)
