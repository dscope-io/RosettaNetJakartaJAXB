...
import io.dscope.rosettanet.domain.logistics.codelist.porttype.v01_02.PortType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.05}PortIdentification" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:PortType:xsd:codelist:01.02}PortType"/&gt;
...
public class PortInformationType {
    ...
    @XmlElementRef(name = "PortIdentification", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.05", type = PortIdentification.class)
    protected List<PortIdentification> portIdentification;
    @XmlElementRef(name = "PortType", namespace = "urn:rosettanet:specification:domain:Logistics:PortType:xsd:codelist:01.02", type = PortType.class)
