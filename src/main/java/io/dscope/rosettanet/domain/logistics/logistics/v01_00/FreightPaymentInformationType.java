...
import io.dscope.rosettanet.domain.logistics.codelist.freightpaymentterms.v01_00.FreightPaymentTerms;
import io.dscope.rosettanet.domain.procurement.procurement.v01_00.SpecialHandlingInstruction;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FreightCharges" type="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:1.0}FinancialAmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:FreightPaymentTerms:xsd:codelist:1.0}FreightPaymentTerms" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:1.0}SpecialHandlingInstruction" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class FreightPaymentInformationType {
    ...
    @XmlElementRef(name = "FreightPaymentTerms", namespace = "urn:rosettanet:specification:domain:Logistics:FreightPaymentTerms:xsd:codelist:1.0", type = FreightPaymentTerms.class, required = false)
