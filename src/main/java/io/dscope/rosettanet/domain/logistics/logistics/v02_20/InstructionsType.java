 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20}ShippingInstructionsCode"/&gt;
 *       &lt;/sequence&gt;
...
public class InstructionsType {
    ...
    @XmlElementRef(name = "ShippingInstructionsCode", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20", type = ShippingInstructionsCode.class)
