...
import io.dscope.rosettanet.domain.shared.shared.v01_11.QuantityInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.11}QuantityInformation"/&gt;
...
public class CustomsPermittedInformationType {
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.11", type = QuantityInformation.class)
