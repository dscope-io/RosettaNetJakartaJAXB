...
import io.dscope.rosettanet.domain.shared.shared.v01_13.QuantityInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.13}QuantityInformation"/&gt;
...
public class CustomsPermittedInformationType {
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", type = QuantityInformation.class)
