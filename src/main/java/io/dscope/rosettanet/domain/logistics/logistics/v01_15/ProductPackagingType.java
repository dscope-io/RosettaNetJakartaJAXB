...
import io.dscope.rosettanet.domain.procurement.codelist.packagetypecode.v01_02.PackageTypeCode;
import io.dscope.rosettanet.domain.procurement.procurement.v01_22.DatePeriodAndDuration;
import io.dscope.rosettanet.universal.codelist.unitofmeasure.v01_03.UnitOfMeasure;
import io.dscope.rosettanet.universal.physicaldimension.v01_05.Linear;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22}DatePeriodAndDuration" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.05}Linear" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15}MassPhysicalDimension" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:PackageTypeCode:xsd:codelist:01.02}PackageTypeCode" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ProductPackagingType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.22", type = DatePeriodAndDuration.class, required = false)
    protected DatePeriodAndDuration datePeriodAndDuration;
    @XmlElementRef(name = "Linear", namespace = "urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.05", type = Linear.class, required = false)
    protected Linear linear;
    @XmlElementRef(name = "MassPhysicalDimension", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15", type = MassPhysicalDimension.class, required = false)
    protected MassPhysicalDimension massPhysicalDimension;
    @XmlElementRef(name = "PackageTypeCode", namespace = "urn:rosettanet:specification:domain:Procurement:PackageTypeCode:xsd:codelist:01.02", type = PackageTypeCode.class, required = false)
