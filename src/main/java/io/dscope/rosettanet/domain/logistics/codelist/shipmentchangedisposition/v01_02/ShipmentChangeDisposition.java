    ...
    extends JAXBElement<ShipmentChangeDispositionType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Logistics:ShipmentChangeDisposition:xsd:codelist:01.02", "ShipmentChangeDisposition");
