...
import io.dscope.rosettanet.domain.logistics.codelist.lotdiscrepancyreason.v01_00.LotDiscrepancyReason;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:LotDiscrepancyReason:xsd:codelist:1.0}LotDiscrepancyReason" minOccurs="0"/&gt;
...
public class LotReferenceType {
    ...
    @XmlElementRef(name = "LotDiscrepancyReason", namespace = "urn:rosettanet:specification:domain:Logistics:LotDiscrepancyReason:xsd:codelist:1.0", type = LotDiscrepancyReason.class, required = false)
