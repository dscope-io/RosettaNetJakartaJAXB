 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:1.0}ShippingInstructionsCode"/&gt;
 *       &lt;/sequence&gt;
...
public class InstructionsType {
    ...
    @XmlElementRef(name = "ShippingInstructionsCode", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:1.0", type = ShippingInstructionsCode.class)
