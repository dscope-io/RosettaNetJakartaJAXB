...
import io.dscope.rosettanet.domain.shared.shared.v01_19.QuantityInformation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.19}QuantityInformation"/&gt;
...
public class CustomsPermittedInformationType {
    ...
    @XmlElementRef(name = "QuantityInformation", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.19", type = QuantityInformation.class)
