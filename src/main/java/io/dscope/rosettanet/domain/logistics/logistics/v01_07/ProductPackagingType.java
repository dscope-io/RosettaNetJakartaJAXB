...
import io.dscope.rosettanet.domain.procurement.procurement.v01_13.DatePeriodAndDuration;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13}DatePeriodAndDuration" minOccurs="0"/&gt;
...
public class ProductPackagingType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Procurement:xsd:schema:01.13", type = DatePeriodAndDuration.class, required = false)
