 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15}PortAddress"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15}PortIdentification"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class ShippingRoutingPointType {
    ...
    @XmlElementRef(name = "PortAddress", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15", type = PortAddress.class, required = false)
    protected PortAddress portAddress;
    @XmlElementRef(name = "PortIdentification", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:01.15", type = PortIdentification.class, required = false)
