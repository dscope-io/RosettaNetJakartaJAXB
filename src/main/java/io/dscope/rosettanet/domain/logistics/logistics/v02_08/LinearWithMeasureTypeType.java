 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Height" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08}MeasureWithTypeType" minOccurs="0"/&gt;
 *         &lt;element name="Length" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08}MeasureWithTypeType" minOccurs="0"/&gt;
 *         &lt;element name="Width" type="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.08}MeasureWithTypeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
