 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:TrackingReferenceType:xsd:codelist:1.0}TrackingReferenceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TrackingReferenceType {
    ...
    @XmlElementRef(name = "TrackingReferenceType", namespace = "urn:rosettanet:specification:domain:Logistics:TrackingReferenceType:xsd:codelist:1.0", type = io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_00.TrackingReferenceType.class, required = false)
    protected io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_00.TrackingReferenceType trackingReferenceType;
     ...
     * @return
     *     possible object is
     *     {@link io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_00.TrackingReferenceType }
     *     
     */
    public io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_00.TrackingReferenceType getTrackingReferenceType() {
     ...
     *     
     */
    public void setTrackingReferenceType(io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_00.TrackingReferenceType value) {
