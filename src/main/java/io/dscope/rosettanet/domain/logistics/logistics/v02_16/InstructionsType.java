 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16}ShippingInstructionsCode"/&gt;
 *       &lt;/sequence&gt;
...
public class InstructionsType {
    ...
    @XmlElementRef(name = "ShippingInstructionsCode", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16", type = ShippingInstructionsCode.class)
