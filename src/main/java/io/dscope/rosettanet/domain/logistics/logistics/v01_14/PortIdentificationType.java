...
import io.dscope.rosettanet.domain.logistics.codelist.portidentifierauthoritycode.v01_02.PortIdentifierAuthorityCode;
 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{urn:rosettanet:specification:universal:Locations:xsd:schema:01.02}AlternativeIdentifier"/&gt;
 *           &lt;element ref="{urn:rosettanet:specification:domain:Logistics:PortIdentifierAuthorityCode:xsd:codelist:01.02}PortIdentifierAuthorityCode"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class PortIdentificationType {
    ...
    @XmlElementRef(name = "PortIdentifierAuthorityCode", namespace = "urn:rosettanet:specification:domain:Logistics:PortIdentifierAuthorityCode:xsd:codelist:01.02", type = PortIdentifierAuthorityCode.class, required = false)
