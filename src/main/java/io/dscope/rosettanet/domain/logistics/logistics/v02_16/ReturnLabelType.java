 ...
 *         &lt;element name="ReturnBy" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.13}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16}ReturnInstructions" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:ReturnLabelCode:xsd:codelist:01.03}ReturnLabelCode"/&gt;
 *         &lt;element name="ReturnTo" type="{urn:rosettanet:specification:universal:PartnerIdentification:xsd:schema:01.13}SpecifiedPartnerDescriptionType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16}TrackingReference" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ReturnLabelType {
    ...
    @XmlElementRef(name = "ReturnInstructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16", type = ReturnInstructions.class, required = false)
    ...
    @XmlElementRef(name = "TrackingReference", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.16", type = TrackingReference.class, required = false)
