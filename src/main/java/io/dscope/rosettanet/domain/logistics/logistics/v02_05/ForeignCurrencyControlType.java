...
import io.dscope.rosettanet.domain.shared.codelist.paymentmethod.v01_01.PaymentMethodType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ApprovalReference" type="{urn:rosettanet:specification:universal:Document:xsd:schema:01.03}BusinessDocumentReferenceType"/&gt;
 *         &lt;element name="PaymentMethod" type="{urn:rosettanet:specification:domain:Shared:PaymentMethod:xsd:codelist:01.01}PaymentMethodType"/&gt;
 *       &lt;/sequence&gt;
