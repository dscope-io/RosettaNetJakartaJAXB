...
import io.dscope.rosettanet.domain.shared.shared.v01_12.DatePeriodAndDuration;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.12}DatePeriodAndDuration" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.05}Linear" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17}MassPhysicalDimension" minOccurs="0"/&gt;
...
public class ProductPackagingType {
    ...
    @XmlElementRef(name = "DatePeriodAndDuration", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.12", type = DatePeriodAndDuration.class, required = false)
    ...
    @XmlElementRef(name = "MassPhysicalDimension", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.17", type = MassPhysicalDimension.class, required = false)
