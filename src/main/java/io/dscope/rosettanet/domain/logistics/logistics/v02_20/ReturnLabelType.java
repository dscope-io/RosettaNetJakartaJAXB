 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20}ReturnInstructions" minOccurs="0"/&gt;
...
public class ReturnLabelType {
    ...
    @XmlElementRef(name = "ReturnInstructions", namespace = "urn:rosettanet:specification:domain:Logistics:xsd:schema:02.20", type = ReturnInstructions.class, required = false)
