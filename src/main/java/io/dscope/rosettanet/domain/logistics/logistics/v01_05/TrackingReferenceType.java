 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:TrackingReferenceType:xsd:codelist:01.03}TrackingReferenceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TrackingReferenceType {
    ...
    @XmlElementRef(name = "TrackingReferenceType", namespace = "urn:rosettanet:specification:domain:Logistics:TrackingReferenceType:xsd:codelist:01.03", type = io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_03.TrackingReferenceType.class, required = false)
    protected io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_03.TrackingReferenceType trackingReferenceType;
     ...
     * @return
     *     possible object is
     *     {@link io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_03.TrackingReferenceType }
     *     
     */
    public io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_03.TrackingReferenceType getTrackingReferenceType() {
     ...
     *     
     */
    public void setTrackingReferenceType(io.dscope.rosettanet.domain.logistics.codelist.trackingreferencetype.v01_03.TrackingReferenceType value) {
