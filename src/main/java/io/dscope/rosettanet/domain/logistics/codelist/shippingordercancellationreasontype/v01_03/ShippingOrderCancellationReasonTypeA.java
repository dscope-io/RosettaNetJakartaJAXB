    ...
    extends JAXBElement<Object>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Logistics:ShippingOrderCancellationReasonType:xsd:codelist:01.03", "ShippingOrderCancellationReasonTypeA");
