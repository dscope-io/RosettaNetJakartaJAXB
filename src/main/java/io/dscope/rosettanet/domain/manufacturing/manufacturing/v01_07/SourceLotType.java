 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07}WaferInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07}WaferLotQuantity"/&gt;
 *       &lt;/sequence&gt;
...
public class SourceLotType {
    ...
    @XmlElementRef(name = "WaferInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07", type = WaferInformation.class, required = false)
    protected List<WaferInformation> waferInformation;
    @XmlElementRef(name = "WaferLotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07", type = WaferLotQuantity.class)
