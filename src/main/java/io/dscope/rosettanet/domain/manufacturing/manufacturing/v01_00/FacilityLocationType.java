...
import io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_00.BALocationType;
import io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_00.FabLocationType;
import io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_00.FinalTestLocationType;
import io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_00.OtherLocationType;
import io.dscope.rosettanet.interchange.semiconductortestdatanotification.v01_00.WaferSortLocationType;
import io.dscope.rosettanet.universal.locations.v01_00.Location;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:universal:Locations:xsd:schema:1.0}Location" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Locations:xsd:schema:1.0}PhysicalAddress" minOccurs="0"/&gt;
...
public class FacilityLocationType {
    ...
    @XmlElementRef(name = "Location", namespace = "urn:rosettanet:specification:universal:Locations:xsd:schema:1.0", type = Location.class, required = false)
    protected Location location;
    @XmlElementRef(name = "PhysicalAddress", namespace = "urn:rosettanet:specification:universal:Locations:xsd:schema:1.0", type = PhysicalAddress.class, required = false)
