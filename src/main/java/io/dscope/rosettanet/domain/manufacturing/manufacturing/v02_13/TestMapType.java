 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}MeasurementUnit" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}WaferCoordinate" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestMapType {
    ...
    @XmlElementRef(name = "WaferCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = WaferCoordinate.class, required = false)
