 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}MeasurementUnit" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}WaferCoordinate" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestMapType {
    ...
    @XmlElementRef(name = "WaferCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = WaferCoordinate.class, required = false)
