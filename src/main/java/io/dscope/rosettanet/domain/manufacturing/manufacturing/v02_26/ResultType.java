 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26}Attachment" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ResultType {
    ...
    @XmlElementRef(name = "Attachment", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26", type = Attachment.class, required = false)
