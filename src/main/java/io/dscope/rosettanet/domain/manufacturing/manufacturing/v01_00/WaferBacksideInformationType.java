...
import io.dscope.rosettanet.domain.manufacturing.codelist.waferbacksidefinish.v01_00.WaferBackSideFinish;
import io.dscope.rosettanet.domain.manufacturing.codelist.waferpassivation.v01_00.WaferPassivation;
import io.dscope.rosettanet.universal.codelist.unitofmeasure.v01_00.UnitOfMeasureType;
 ...
 *         &lt;element name="WaferBackGrindFinalThicknessUOM" type="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:1.0}UnitOfMeasureType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:1.0}WaferBackSideFinish" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:1.0}WaferPassivation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class WaferBacksideInformationType {
    ...
    @XmlElementRef(name = "WaferBackSideFinish", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:1.0", type = WaferBackSideFinish.class, required = false)
    protected WaferBackSideFinish waferBackSideFinish;
    @XmlElementRef(name = "WaferPassivation", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:1.0", type = WaferPassivation.class, required = false)
