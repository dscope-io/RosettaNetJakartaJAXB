...
import io.dscope.rosettanet.domain.logistics.codelist.packagetype.v01_04.PackageType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AdditionalDescription" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}AttachmentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:PackageType:xsd:codelist:01.04}PackageType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class EngineeringInformationType {
    ...
    @XmlElementRef(name = "PackageType", namespace = "urn:rosettanet:specification:domain:Logistics:PackageType:xsd:codelist:01.04", type = PackageType.class, required = false)
