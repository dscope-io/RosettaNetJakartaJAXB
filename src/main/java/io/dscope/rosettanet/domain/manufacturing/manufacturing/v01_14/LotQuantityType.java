...
import io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_02.LotQuantityClassification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.02}LotQuantityClassification"/&gt;
...
public class LotQuantityType {
    ...
    @XmlElementRef(name = "LotQuantityClassification", namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.02", type = LotQuantityClassification.class)
