 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04}WorkInProcessStage"/&gt;
 *       &lt;/sequence&gt;
...
public class ProcessRoutingType {
    ...
    @XmlElementRef(name = "WorkInProcessStage", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04", type = WorkInProcessStage.class)
