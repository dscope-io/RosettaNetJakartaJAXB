    ...
    extends JAXBElement<AttachmentDescriptionType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:01.02", "AttachmentDescription");
