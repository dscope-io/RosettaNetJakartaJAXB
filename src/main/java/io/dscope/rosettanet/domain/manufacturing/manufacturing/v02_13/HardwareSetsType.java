 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}TesterAttachment" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}TesterFEH" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class HardwareSetsType {
    ...
    @XmlElementRef(name = "TesterAttachment", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = TesterAttachment.class, required = false)
    protected List<TesterAttachment> testerAttachment;
    @XmlElementRef(name = "TesterFEH", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = TesterFEH.class, required = false)
