...
import io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_00.LotQuantityClassification;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:1.0}LotQuantityClassification"/&gt;
...
public class LotQuantityType {
    ...
    @XmlElementRef(name = "LotQuantityClassification", namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:1.0", type = LotQuantityClassification.class)
