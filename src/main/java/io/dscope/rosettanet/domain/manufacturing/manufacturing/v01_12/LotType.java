 ...
 *         &lt;element name="ContractorLotNumber" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}LotIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomerLotNumber" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}LotIdentifierType"/&gt;
 ...
 *         &lt;element name="SubLot" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}LotIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
