 ...
 * generated in the io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_00 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_00
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:1.0", name = "LotQuantityClassificationA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:1.0", name = "LotQuantityClassification", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:1.0", substitutionHeadName = "LotQuantityClassificationA")
