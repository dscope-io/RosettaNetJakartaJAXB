 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Manufacturing:TestResult:xsd:codelist:01.04&gt;TestResultContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="TestResult" /&gt;
...
public class TestResultType {
    ...
    @XmlValue
    protected TestResultContentType value;
     ...
     * @return
     *     possible object is
     *     {@link TestResultContentType }
     *     
     */
    public TestResultContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(TestResultContentType value) {
        this.value = value;
    }
