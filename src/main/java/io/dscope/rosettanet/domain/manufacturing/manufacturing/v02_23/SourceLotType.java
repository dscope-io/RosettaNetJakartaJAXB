 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BondingPadSize" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.06}LinearType" minOccurs="0"/&gt;
 *         &lt;element name="DieSize" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.06}LinearType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}WaferInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23}WaferLotQuantity"/&gt;
 *       &lt;/sequence&gt;
...
public class SourceLotType {
    ...
    @XmlElementRef(name = "WaferInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = WaferInformation.class, required = false)
    protected List<WaferInformation> waferInformation;
    @XmlElementRef(name = "WaferLotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.23", type = WaferLotQuantity.class)
