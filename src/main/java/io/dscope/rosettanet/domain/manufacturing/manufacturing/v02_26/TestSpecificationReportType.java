 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26}TestParameter" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestSpecificationReportType {
    ...
    @XmlElementRef(name = "TestParameter", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.26", type = TestParameter.class, required = false)
