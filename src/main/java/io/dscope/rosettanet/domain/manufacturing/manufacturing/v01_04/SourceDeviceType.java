 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04}SourceLot" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04}WaferBacksideInformation" minOccurs="0"/&gt;
...
public class SourceDeviceType {
    ...
    @XmlElementRef(name = "SourceLot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04", type = SourceLot.class)
    protected List<SourceLot> sourceLot;
    @XmlElementRef(name = "WaferBacksideInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04", type = WaferBacksideInformation.class, required = false)
