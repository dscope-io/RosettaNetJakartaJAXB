...
import io.dscope.rosettanet.domain.logistics.codelist.packagetype.v01_00.PackageType;
import io.dscope.rosettanet.domain.manufacturing.codelist.devicepackagetype.v01_00.DevicePackageType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AdditionalDescription" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}AttachmentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:DevicePackageType:xsd:codelist:1.0}DevicePackageType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PackageDimension" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}LinearType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Logistics:PackageType:xsd:codelist:1.0}PackageType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class EngineeringInformationType {
    ...
    @XmlElementRef(name = "DevicePackageType", namespace = "urn:rosettanet:specification:domain:Manufacturing:DevicePackageType:xsd:codelist:1.0", type = DevicePackageType.class, required = false)
    ...
    @XmlElementRef(name = "PackageType", namespace = "urn:rosettanet:specification:domain:Logistics:PackageType:xsd:codelist:1.0", type = PackageType.class, required = false)
