    ...
    extends JAXBElement<WaferBackSideFinishType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:01.02", "WaferBackSideFinish");
