 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.08}WaferInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.08}WaferLotQuantity"/&gt;
 *       &lt;/sequence&gt;
...
public class SourceLotType {
    ...
    @XmlElementRef(name = "WaferInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.08", type = WaferInformation.class, required = false)
    protected List<WaferInformation> waferInformation;
    @XmlElementRef(name = "WaferLotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.08", type = WaferLotQuantity.class)
