 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}TestTemperature" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestSetupType {
    ...
    @XmlElementRef(name = "TestTemperature", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = TestTemperature.class, required = false)
