 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27}MeasurementUnit" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27}WaferCoordinate" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestMapType {
    ...
    @XmlElementRef(name = "MeasurementUnit", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27", type = MeasurementUnit.class, required = false)
    ...
    @XmlElementRef(name = "WaferCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27", type = WaferCoordinate.class, required = false)
