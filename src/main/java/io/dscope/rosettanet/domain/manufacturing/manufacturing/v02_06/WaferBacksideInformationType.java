...
import io.dscope.rosettanet.domain.manufacturing.codelist.waferbacksidefinish.v01_03.WaferBackSideFinish;
import io.dscope.rosettanet.domain.manufacturing.codelist.waferpassivation.v01_03.WaferPassivation;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:01.03}WaferBackSideFinish" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:01.03}WaferPassivation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class WaferBacksideInformationType {
    ...
    @XmlElementRef(name = "WaferBackSideFinish", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:01.03", type = WaferBackSideFinish.class, required = false)
    protected WaferBackSideFinish waferBackSideFinish;
    @XmlElementRef(name = "WaferPassivation", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:01.03", type = WaferPassivation.class, required = false)
