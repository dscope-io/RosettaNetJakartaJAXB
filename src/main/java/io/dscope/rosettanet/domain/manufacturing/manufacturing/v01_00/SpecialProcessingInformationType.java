...
import io.dscope.rosettanet.domain.manufacturing.codelist.specialinstructioncategory.v01_00.SpecialInstructionCategory;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:ProcessType:xsd:codelist:1.0}ProcessType" minOccurs="0"/&gt;
 *         &lt;element name="SequenceNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:SpecialInstructionCategory:xsd:codelist:1.0}SpecialInstructionCategory"/&gt;
...
public class SpecialProcessingInformationType {
    ...
    @XmlElementRef(name = "ProcessType", namespace = "urn:rosettanet:specification:domain:Manufacturing:ProcessType:xsd:codelist:1.0", type = ProcessType.class, required = false)
    protected ProcessType processType;
    @XmlElement(name = "SequenceNumber")
    protected String sequenceNumber;
    @XmlElementRef(name = "SpecialInstructionCategory", namespace = "urn:rosettanet:specification:domain:Manufacturing:SpecialInstructionCategory:xsd:codelist:1.0", type = SpecialInstructionCategory.class)
