    ...
    extends JAXBElement<LotQuantityClassificationType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.04", "LotQuantityClassification");
