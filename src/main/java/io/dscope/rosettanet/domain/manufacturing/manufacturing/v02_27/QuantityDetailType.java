 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27}OperationGate" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class QuantityDetailType {
    ...
    @XmlElementRef(name = "OperationGate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27", type = OperationGate.class, required = false)
