...
import io.dscope.rosettanet.domain.manufacturing.codelist.attachmentdescription.v01_02.AttachmentDescription;
import io.dscope.rosettanet.universal.codelist.mimetypequalifier.v01_01.MimeTypeQualifier;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:01.02}AttachmentDescription" minOccurs="0"/&gt;
 *         &lt;element name="Description" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:01.01}MimeTypeQualifier"/&gt;
...
public class AttachmentType {
    ...
    @XmlElementRef(name = "AttachmentDescription", namespace = "urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:01.02", type = AttachmentDescription.class, required = false)
    protected AttachmentDescription attachmentDescription;
    @XmlElement(name = "Description")
    protected String description;
    @XmlElementRef(name = "MimeTypeQualifier", namespace = "urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:01.01", type = MimeTypeQualifier.class)
