...
import io.dscope.rosettanet.domain.manufacturing.codelist.equipmenttype.v01_00.EquipmentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:EquipmentType:xsd:codelist:1.0}EquipmentType" minOccurs="0"/&gt;
 *         &lt;element name="InverseYield" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:1.0}PercentAmountType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Yield" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:1.0}PercentAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class WorkInProcessStepType {
    ...
    @XmlElementRef(name = "EquipmentType", namespace = "urn:rosettanet:specification:domain:Manufacturing:EquipmentType:xsd:codelist:1.0", type = EquipmentType.class, required = false)
