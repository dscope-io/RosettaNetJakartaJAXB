 ...
 * generated in the io.dscope.rosettanet.domain.manufacturing.codelist.attachmentdescription.v01_03 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.manufacturing.codelist.attachmentdescription.v01_03
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:01.03", name = "AttachmentDescriptionA")
