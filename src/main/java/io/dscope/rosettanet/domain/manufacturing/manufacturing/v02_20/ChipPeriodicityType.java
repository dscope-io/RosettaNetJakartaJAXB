 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.20}FloatCoordinate"/&gt;
 *       &lt;/sequence&gt;
...
public class ChipPeriodicityType {
    ...
    @XmlElementRef(name = "FloatCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.20", type = FloatCoordinate.class)
