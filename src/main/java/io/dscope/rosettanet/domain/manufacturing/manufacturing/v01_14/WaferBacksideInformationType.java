...
import io.dscope.rosettanet.domain.manufacturing.codelist.waferbacksidefinish.v01_02.WaferBackSideFinish;
import io.dscope.rosettanet.domain.manufacturing.codelist.waferpassivation.v01_02.WaferPassivation;
 ...
 *         &lt;element name="WaferBackGrindFinalThicknessUOM" type="{urn:rosettanet:specification:universal:UnitOfMeasure:xsd:codelist:01.03}UnitOfMeasureType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:01.02}WaferBackSideFinish" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:01.02}WaferPassivation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class WaferBacksideInformationType {
    ...
    @XmlElementRef(name = "WaferBackSideFinish", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferBackSideFinish:xsd:codelist:01.02", type = WaferBackSideFinish.class, required = false)
    protected WaferBackSideFinish waferBackSideFinish;
    @XmlElementRef(name = "WaferPassivation", namespace = "urn:rosettanet:specification:domain:Manufacturing:WaferPassivation:xsd:codelist:01.02", type = WaferPassivation.class, required = false)
