 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07}MeasurementUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class TestParameterType {
    ...
    @XmlElementRef(name = "MeasurementUnit", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.07", type = MeasurementUnit.class, required = false)
