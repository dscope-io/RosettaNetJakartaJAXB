 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06}MarkingContents" maxOccurs="unbounded"/&gt;
...
public class MarkInformationType {
    ...
    @XmlElementRef(name = "MarkingContents", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06", type = MarkingContents.class)
