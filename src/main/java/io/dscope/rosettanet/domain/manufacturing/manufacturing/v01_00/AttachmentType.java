...
import io.dscope.rosettanet.domain.manufacturing.codelist.attachmentdescription.v01_00.AttachmentDescription;
import io.dscope.rosettanet.universal.codelist.mimetypequalifier.v01_00.MimeTypeQualifier;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:1.0}AttachmentDescription" minOccurs="0"/&gt;
 *         &lt;element name="Description" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:1.0}MimeTypeQualifier"/&gt;
...
public class AttachmentType {
    ...
    @XmlElementRef(name = "AttachmentDescription", namespace = "urn:rosettanet:specification:domain:Manufacturing:AttachmentDescription:xsd:codelist:1.0", type = AttachmentDescription.class, required = false)
    protected AttachmentDescription attachmentDescription;
    @XmlElement(name = "Description")
    protected String description;
    @XmlElementRef(name = "MimeTypeQualifier", namespace = "urn:rosettanet:specification:universal:MimeTypeQualifier:xsd:codelist:1.0", type = MimeTypeQualifier.class)
