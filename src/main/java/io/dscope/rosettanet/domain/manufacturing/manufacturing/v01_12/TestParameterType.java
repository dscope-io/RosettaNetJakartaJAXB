...
import io.dscope.rosettanet.domain.manufacturing.codelist.pcmparmtype.v01_03.PCMParmType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}MeasurementUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:PCMParmType:xsd:codelist:01.03}PCMParmType" minOccurs="0"/&gt;
...
public class TestParameterType {
    ...
    @XmlElementRef(name = "MeasurementUnit", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = MeasurementUnit.class, required = false)
    protected List<MeasurementUnit> measurementUnit;
    @XmlElementRef(name = "PCMParmType", namespace = "urn:rosettanet:specification:domain:Manufacturing:PCMParmType:xsd:codelist:01.03", type = PCMParmType.class, required = false)
