 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}HardwareSets" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TesterType {
    ...
    @XmlElementRef(name = "HardwareSets", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = HardwareSets.class, required = false)
