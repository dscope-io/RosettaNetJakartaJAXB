...
import io.dscope.rosettanet.domain.manufacturing.codelist.pcmparmtype.v01_02.PCMParmType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04}MeasurementUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:PCMParmType:xsd:codelist:01.02}PCMParmType" minOccurs="0"/&gt;
...
public class TestParameterType {
    ...
    @XmlElementRef(name = "MeasurementUnit", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04", type = MeasurementUnit.class, required = false)
    protected List<MeasurementUnit> measurementUnit;
    @XmlElementRef(name = "PCMParmType", namespace = "urn:rosettanet:specification:domain:Manufacturing:PCMParmType:xsd:codelist:01.02", type = PCMParmType.class, required = false)
