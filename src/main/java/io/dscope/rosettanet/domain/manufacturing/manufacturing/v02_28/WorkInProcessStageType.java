 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.28}WorkInProcessStep" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class WorkInProcessStageType {
    ...
    @XmlElementRef(name = "WorkInProcessStep", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.28", type = WorkInProcessStep.class)
