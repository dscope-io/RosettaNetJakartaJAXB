    ...
    extends JAXBElement<SpecialInstructionCategoryType>
{
    ...
    protected final static QName NAME = new QName("urn:rosettanet:specification:domain:Manufacturing:SpecialInstructionCategory:xsd:codelist:01.03", "SpecialInstructionCategory");
