 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}TestParameter" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TestSpecificationReportType {
    ...
    @XmlElementRef(name = "TestParameter", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = TestParameter.class, required = false)
