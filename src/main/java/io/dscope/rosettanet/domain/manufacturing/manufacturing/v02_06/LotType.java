 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AlternativePN" type="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03}ProductIdentificationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ContractorLotNumber" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06}LotIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomerLotNumber" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06}LotIdentifierType"/&gt;
 *         &lt;element name="CustomerPN" type="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.03}ProductIdentificationType"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:LotType:xsd:codelist:01.03}LotType"/&gt;
 *         &lt;element name="NominalSize" type="{http://www.w3.org/2001/XMLSchema}float"/&gt;
 *         &lt;element name="ProductName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="SubLot" type="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06}LotIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class LotType {
    ...
    @XmlElementRef(name = "LotType", namespace = "urn:rosettanet:specification:domain:Manufacturing:LotType:xsd:codelist:01.03", type = io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_03.LotType.class)
    protected io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_03.LotType lotType;
     ...
     * @return
     *     possible object is
     *     {@link io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_03.LotType }
     *     
     */
    public io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_03.LotType getLotType() {
        return lotType;
    }
     ...
     *     
     */
    public void setLotType(io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_03.LotType value) {
        this.lotType = value;
    }
