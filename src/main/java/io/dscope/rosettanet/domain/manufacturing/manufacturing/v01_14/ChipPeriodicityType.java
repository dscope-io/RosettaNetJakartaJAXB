 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14}FloatCoordinate"/&gt;
 *       &lt;/sequence&gt;
...
public class ChipPeriodicityType {
    ...
    @XmlElementRef(name = "FloatCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.14", type = FloatCoordinate.class)
