 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27}WorkInProcessStep" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class WorkInProcessStageType {
    ...
    @XmlElementRef(name = "WorkInProcessStep", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27", type = WorkInProcessStep.class)
