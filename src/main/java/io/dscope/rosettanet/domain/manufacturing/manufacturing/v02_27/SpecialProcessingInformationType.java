...
import io.dscope.rosettanet.domain.manufacturing.codelist.specialinstructioncategory.v01_04.SpecialInstructionCategory;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:SpecialInstructionCategory:xsd:codelist:01.04}SpecialInstructionCategory"/&gt;
...
public class SpecialProcessingInformationType {
    ...
    @XmlElementRef(name = "SpecialInstructionCategory", namespace = "urn:rosettanet:specification:domain:Manufacturing:SpecialInstructionCategory:xsd:codelist:01.04", type = SpecialInstructionCategory.class)
