 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}SourceLot" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13}WaferBacksideInformation" minOccurs="0"/&gt;
...
public class SourceDeviceType {
    ...
    @XmlElementRef(name = "SourceLot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = SourceLot.class)
    protected List<SourceLot> sourceLot;
    @XmlElementRef(name = "WaferBacksideInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.13", type = WaferBacksideInformation.class, required = false)
