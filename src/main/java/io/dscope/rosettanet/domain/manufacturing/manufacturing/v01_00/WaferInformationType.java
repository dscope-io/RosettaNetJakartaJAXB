...
import io.dscope.rosettanet.domain.manufacturing.codelist.rawwafertype.v01_00.RawWaferType;
import io.dscope.rosettanet.domain.manufacturing.codelist.waferqualityrating.v01_00.WaferQualityRatingType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Grade" type="{urn:rosettanet:specification:domain:Manufacturing:WaferQualityRating:xsd:codelist:1.0}WaferQualityRatingType"/&gt;
 *         &lt;element name="MappingFileName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:RawWaferType:xsd:codelist:1.0}RawWaferType" minOccurs="0"/&gt;
 *         &lt;element name="WaferUniqueID" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:1.0}GtinType"/&gt;
 *       &lt;/sequence&gt;
...
public class WaferInformationType {
    ...
    @XmlElementRef(name = "RawWaferType", namespace = "urn:rosettanet:specification:domain:Manufacturing:RawWaferType:xsd:codelist:1.0", type = RawWaferType.class, required = false)
