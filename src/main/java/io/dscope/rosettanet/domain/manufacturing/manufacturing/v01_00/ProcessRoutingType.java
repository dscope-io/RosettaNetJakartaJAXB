...
import io.dscope.rosettanet.universal.dates.v01_00.DateTimePeriodType;
 ...
 *         &lt;element name="OperationLotDate" type="{urn:rosettanet:specification:universal:Dates:xsd:schema:1.0}DateTimePeriodType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}WorkInProcessStage"/&gt;
 *       &lt;/sequence&gt;
...
public class ProcessRoutingType {
    ...
    @XmlElementRef(name = "WorkInProcessStage", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = WorkInProcessStage.class)
