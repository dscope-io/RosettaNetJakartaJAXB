...
import io.dscope.rosettanet.domain.manufacturing.codelist.lottype.v01_00.LotType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BondingPadSize" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}LinearType" minOccurs="0"/&gt;
 *         &lt;element name="DieSize" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:1.0}LinearType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:LotType:xsd:codelist:1.0}LotType" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}WaferInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0}WaferLotQuantity"/&gt;
 *       &lt;/sequence&gt;
...
public class SourceLotType {
    ...
    @XmlElementRef(name = "LotType", namespace = "urn:rosettanet:specification:domain:Manufacturing:LotType:xsd:codelist:1.0", type = LotType.class, required = false)
    ...
    @XmlElementRef(name = "WaferInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = WaferInformation.class, required = false)
    protected List<WaferInformation> waferInformation;
    @XmlElementRef(name = "WaferLotQuantity", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:1.0", type = WaferLotQuantity.class)
