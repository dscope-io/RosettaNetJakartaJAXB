 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.18}FloatCoordinate"/&gt;
 *       &lt;/sequence&gt;
...
public class ChipPeriodicityType {
    ...
    @XmlElementRef(name = "FloatCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.18", type = FloatCoordinate.class)
