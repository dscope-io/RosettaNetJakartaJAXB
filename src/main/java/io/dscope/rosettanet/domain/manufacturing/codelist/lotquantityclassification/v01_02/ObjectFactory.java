 ...
 * generated in the io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.manufacturing.codelist.lotquantityclassification.v01_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.02", name = "LotQuantityClassificationA")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.02", name = "LotQuantityClassification", substitutionHeadNamespace = "urn:rosettanet:specification:domain:Manufacturing:LotQuantityClassification:xsd:codelist:01.02", substitutionHeadName = "LotQuantityClassificationA")
