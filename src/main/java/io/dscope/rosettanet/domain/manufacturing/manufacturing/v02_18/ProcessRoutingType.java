 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.18}WorkInProcessStage"/&gt;
 *       &lt;/sequence&gt;
...
public class ProcessRoutingType {
    ...
    @XmlElementRef(name = "WorkInProcessStage", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.18", type = WorkInProcessStage.class)
