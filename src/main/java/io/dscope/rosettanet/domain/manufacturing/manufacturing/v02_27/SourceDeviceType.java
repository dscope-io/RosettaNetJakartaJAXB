 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27}SourceLot" maxOccurs="unbounded"/&gt;
...
public class SourceDeviceType {
    ...
    @XmlElementRef(name = "SourceLot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.27", type = SourceLot.class)
