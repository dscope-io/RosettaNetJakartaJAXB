 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04}HardwareSets" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class TesterType {
    ...
    @XmlElementRef(name = "HardwareSets", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.04", type = HardwareSets.class, required = false)
