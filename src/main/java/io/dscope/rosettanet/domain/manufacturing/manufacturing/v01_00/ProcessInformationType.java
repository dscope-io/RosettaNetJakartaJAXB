...
import io.dscope.rosettanet.domain.manufacturing.codelist.processtype.v01_00.ProcessType;
import io.dscope.rosettanet.domain.manufacturing.codelist.workinprocesslocation.v01_00.WorkInProcessLocation;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:Dates:xsd:schema:1.0}DatePeriod" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:ProcessType:xsd:codelist:1.0}ProcessType"/&gt;
 *         &lt;element name="SequenceNumber" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:WorkInProcessLocation:xsd:codelist:1.0}WorkInProcessLocation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ProcessInformationType {
    ...
    @XmlElementRef(name = "ProcessType", namespace = "urn:rosettanet:specification:domain:Manufacturing:ProcessType:xsd:codelist:1.0", type = ProcessType.class)
    protected ProcessType processType;
    @XmlElement(name = "SequenceNumber", required = true)
    protected String sequenceNumber;
    @XmlElementRef(name = "WorkInProcessLocation", namespace = "urn:rosettanet:specification:domain:Manufacturing:WorkInProcessLocation:xsd:codelist:1.0", type = WorkInProcessLocation.class, required = false)
