 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AlternateSourceDevice" type="{urn:rosettanet:specification:universal:ProductIdentification:xsd:schema:01.02}ProductIdentificationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}SourceLot" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12}WaferBacksideInformation" minOccurs="0"/&gt;
 *         &lt;element name="WaferSize" type="{urn:rosettanet:specification:universal:PhysicalDimension:xsd:schema:01.01}LinearType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class SourceDeviceType {
    ...
    @XmlElementRef(name = "SourceLot", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = SourceLot.class)
    protected List<SourceLot> sourceLot;
    @XmlElementRef(name = "WaferBacksideInformation", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:01.12", type = WaferBacksideInformation.class, required = false)
