 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06}HexCoordinate"/&gt;
 *         &lt;element name="RawBits" type="{urn:rosettanet:specification:universal:DataType:xsd:schema:01.03}HexadecimalType"/&gt;
 *       &lt;/sequence&gt;
...
public class ECIDReportType {
    ...
    @XmlElementRef(name = "HexCoordinate", namespace = "urn:rosettanet:specification:domain:Manufacturing:xsd:schema:02.06", type = HexCoordinate.class)
