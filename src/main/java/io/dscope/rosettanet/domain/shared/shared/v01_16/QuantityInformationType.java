 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="ShippedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.16}ProductQuantityType"/&gt;
 *       &lt;/sequence&gt;
