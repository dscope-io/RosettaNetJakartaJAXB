 ...
 * generated in the io.dscope.rosettanet.domain.shared.shared.v01_16 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.shared.shared.v01_16
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "CarrierInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "DatePeriodAndDuration")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "Duration")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "ManufacturedDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "MonetaryAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "PaymentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "ProductPricing")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "ProductQuantity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "QuantityInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "Rate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "SCAC")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.16", name = "Warranty")
