...
import io.dscope.rosettanet.domain.shared.codelist.amounttype.v01_00.AmountType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:AmountType:xsd:codelist:01.00}AmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.01}FinancialAmount"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:InvoiceChargeType:xsd:codelist:01.00}InvoiceChargeType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:MonetaryAmountType:xsd:codelist:01.00}MonetaryAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MonetaryAmountType {
    ...
    @XmlElementRef(name = "AmountType", namespace = "urn:rosettanet:specification:domain:Shared:AmountType:xsd:codelist:01.00", type = AmountType.class, required = false)
    ...
    @XmlElementRef(name = "InvoiceChargeType", namespace = "urn:rosettanet:specification:domain:Shared:InvoiceChargeType:xsd:codelist:01.00", type = InvoiceChargeType.class, required = false)
    protected InvoiceChargeType invoiceChargeType;
    @XmlElementRef(name = "MonetaryAmountType", namespace = "urn:rosettanet:specification:domain:Shared:MonetaryAmountType:xsd:codelist:01.00", type = io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountType.class, required = false)
    protected io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountType monetaryAmountType;
     ...
     * @return
     *     possible object is
     *     {@link io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountType }
     *     
     */
    public io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountType getMonetaryAmountType() {
     ...
     *     
     */
    public void setMonetaryAmountType(io.dscope.rosettanet.domain.shared.codelist.monetaryamounttype.v01_00.MonetaryAmountType value) {
