 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RequestedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.15}ProductQuantityType" minOccurs="0"/&gt;
 *         &lt;element name="ShippedQuantity" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.15}ProductQuantityType"/&gt;
 *       &lt;/sequence&gt;
