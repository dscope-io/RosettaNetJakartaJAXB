...
import io.dscope.rosettanet.domain.shared.codelist.paymenttype.v01_00.PaymentType;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:PaymentType:xsd:codelist:01.00}PaymentType"/&gt;
 *       &lt;/sequence&gt;
...
public class PaymentInformationType {
    ...
    @XmlElementRef(name = "PaymentType", namespace = "urn:rosettanet:specification:domain:Shared:PaymentType:xsd:codelist:01.00", type = PaymentType.class)
