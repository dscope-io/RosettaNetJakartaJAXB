...
import io.dscope.rosettanet.domain.shared.codelist.amounttype.v01_02.AmountType;
import io.dscope.rosettanet.domain.shared.codelist.invoicechargetype.v01_02.InvoiceChargeType;
import io.dscope.rosettanet.universal.monetaryexpression.v01_05.FinancialAmount;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:AmountType:xsd:codelist:01.02}AmountType" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05}FinancialAmount"/&gt;
...
public class MonetaryAmountType {
    ...
    @XmlElementRef(name = "AmountType", namespace = "urn:rosettanet:specification:domain:Shared:AmountType:xsd:codelist:01.02", type = AmountType.class, required = false)
    protected AmountType amountType;
    @XmlElementRef(name = "FinancialAmount", namespace = "urn:rosettanet:specification:universal:MonetaryExpression:xsd:schema:01.05", type = FinancialAmount.class)
