 ...
 * generated in the io.dscope.rosettanet.domain.shared.shared.v01_13 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dscope.rosettanet.domain.shared.shared.v01_13
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "CarrierInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "DatePeriodAndDuration")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "Duration")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "ManufacturedDate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "MonetaryAmount")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "PaymentInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "ProductPricing")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "ProductQuantity")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "QuantityInformation")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "Rate")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "SCAC")
     ...
     */
    @XmlElementDecl(namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.13", name = "Warranty")
