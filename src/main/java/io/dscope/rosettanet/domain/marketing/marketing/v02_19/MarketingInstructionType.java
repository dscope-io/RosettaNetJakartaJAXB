...
import io.dscope.rosettanet.domain.shared.shared.v01_17.Warranty;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}ChangeNotification" minOccurs="0"/&gt;
 *         &lt;element name="PartActivityIndicator" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}Warranty" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MarketingInstructionType {
    ...
    @XmlElementRef(name = "ChangeNotification", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19", type = ChangeNotification.class, required = false)
    ...
    @XmlElementRef(name = "Warranty", namespace = "urn:rosettanet:specification:domain:Shared:xsd:schema:01.17", type = Warranty.class, required = false)
