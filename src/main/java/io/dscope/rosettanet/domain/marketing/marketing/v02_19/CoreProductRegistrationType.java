 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}DeviceProductRegistration" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19}RegistrationStatus"/&gt;
 *         &lt;element name="SuggestedResalePrice" type="{urn:rosettanet:specification:domain:Shared:xsd:schema:01.17}ProductPricingType"/&gt;
...
public class CoreProductRegistrationType {
    ...
    @XmlElementRef(name = "RegistrationStatus", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.19", type = RegistrationStatus.class)
