 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}IsRegistrationRenewable"/&gt;
 *         &lt;element ref="{urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12}RegistrationRenewableDate" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class RegistrationRenewableStatusType {
    ...
    @XmlElementRef(name = "IsRegistrationRenewable", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = IsRegistrationRenewable.class)
    protected IsRegistrationRenewable isRegistrationRenewable;
    @XmlElementRef(name = "RegistrationRenewableDate", namespace = "urn:rosettanet:specification:domain:Marketing:xsd:schema:02.12", type = RegistrationRenewableDate.class, required = false)
