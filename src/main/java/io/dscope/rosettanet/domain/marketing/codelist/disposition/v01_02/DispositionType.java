 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:rosettanet:specification:domain:Marketing:Disposition:xsd:codelist:01.02&gt;DispositionContentType"&gt;
 *       &lt;attribute name="identifier" type="{http://www.w3.org/2001/XMLSchema}token" fixed="Disposition" /&gt;
...
public class DispositionType {
    ...
    @XmlValue
    protected DispositionContentType value;
     ...
     * @return
     *     possible object is
     *     {@link DispositionContentType }
     *     
     */
    public DispositionContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(DispositionContentType value) {
        this.value = value;
    }
